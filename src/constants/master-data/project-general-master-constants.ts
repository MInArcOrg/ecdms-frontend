export const projectMasterModels = {
  ...
  roadLengthType: {
    ...
    dbModel: 'roadlengthtype',
    title: 'road-length-types',
  ...
  areaTopography: {
    ...
    dbModel: 'areatopography',
    title: 'area-topographies',
  ...
  abutmentType: {
    model: 'AbutmentType',
    dbModel: 'abutmenttype',
    title: 'abutment-types',
  ...
  endwallTypeOutlet: {
    ...
    dbModel: 'endwalltypeoutlet',
    title: 'endwall-type-outlets',
  ...
  pavedWaterWayType: {
    ...
    dbModel: 'pavedwaterwaytype',
    title: 'paved-water-way-types',
  ...
  guardRailType: {
    model: 'GuardRailType',
    dbModel: 'guardrailtype',
    title: 'guard-rail-types',
  ...
  bridgeStructureType: {
    ...
    dbModel: 'bridgestructuretype',
    title: 'bridge-structure-types',
  ...
  deckSlabType: {
    model: 'DeckSlabType',
    dbModel: 'deckslabtype',
    title: 'deck-slab-types',
  ...
  expansionJointType: {
    ...
    dbModel: 'expansionjointtype',
    title: 'expansion-joint-types',
  ...
  bridgePartDefect: {
    ...
    dbModel: 'bridgepartdefect',
    title: 'bridge-part-defects',
  ...
  hydrologyDefect: {
    ...
    dbModel: 'hydrologydefect',
    title: 'hydrology-defects',
  ...
  groundWaterImpact: {
    ...
    dbModel: 'groundwaterimpact',
    title: 'ground-water-impacts',
  ...
  slopeStability: {
    ...
    dbModel: 'slopestability',
    title: 'slope-stabilities',
  ...
  drainageType: {
    model: 'DrainageType',
    dbModel: 'drainagetype',
    title: 'drainage-types',
  ...
  drainageCondition: {
    ...
    dbModel: 'drainagecondition',
    title: 'drainage-conditions',
  ...
  recommendedActionUrgency: {
    ...
    dbModel: 'recommendedactionurgency',
    title: 'recommended-action-urgencies',
  ...
  incidentTime: {
    model: 'IncidentTime',
    dbModel: 'incidenttime',
    title: 'incident-times',
  ...
  designClassification: {
    ...
    dbModel: 'designclassification',
    title: 'design-classifications',
  ...
  designTrafficFlow: {
    ...
    dbModel: 'designtrafficflow',
    title: 'design-traffic-flows',
  ...
  drivewayAccessPoint: {
    ...
    dbModel: 'drivewayaccesspoint',
    title: 'driveway-access-points',
...
export type ProjectMasterModel = {
  model: string;
  dbModel: string;
  title: string;
  createTitle: string;
...
export type ProjectMasterModels = {
  [K in ProjectMasterModelKey]: ProjectMasterModel;
};
