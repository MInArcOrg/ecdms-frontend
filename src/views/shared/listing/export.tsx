                            ...
                            <Grid container spacing={4}>
                                ...
                                <Grid item xs={12}>
                                    <FormControl fullWidth>
                                        <InputLabel id="export-format-label">
                                            <Translations text="Export Format" />
                                        </InputLabel>
                                        <Select
                                            labelId="export-format-label"
                                            id="format"
                                            name="format"
                                            label={<Translations text="Export Format" />}
                                ...
                                <Grid item xs={12}>
                                    <FormControlLabel
                                        ...
                                        label={<Translations text="Export only current page's records" />}
                                    />
                                </Grid>
                                ...
                                <Grid item xs={12}>
                                    <Typography variant="subtitle1" sx={{ mb: 2 }}>
                                        <Translations text="Select Fields" />
                                    </Typography>
