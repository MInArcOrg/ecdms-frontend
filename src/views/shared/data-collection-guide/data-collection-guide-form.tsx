...
const DataCollectionGuideForm: React.FC<DataCollectionGuideFormProps> = ({ formik, defaultLocaleData }) => {
  ...
  return (
    <>
      ...
      <CustomTextBox
        ...
        placeholder={transl('data-collection-guide.form.data_collection_frequency')}
      ...
      <CustomTextBox
        fullWidth
        label={transl('data-collection-guide.form.responsible_data_collector_body')}
        placeholder={transl('data-collection-guide.form.responsible_data_collector_body')}
