    ...
    >
      ...
      <Box display="flex" flexDirection="column" gap={1} mt={2}>
        <Typography variant="body2" color="text.secondary">
          {t("department.user.contact-person.nationalIdNo")}:{" "}
          {contactPerson.national_id_no || t("common.not-available")}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          {t("department.user.contact-person.email")}:{" "}
          {contactPerson.email || t("common.not-available")}
        </Typography>
        <Typography variant="body2" color="text.secondary">
          {t("department.user.contact-person.phoneNo")}:{" "}
