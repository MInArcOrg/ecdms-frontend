...
import { genderList, gridSpacing, maritalStatusList } from 'src/configs/app-constants';
...
const UserForm: React.FC<UserFormProps> = ({ formik, departmentId, isEdit }) => {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12} md={6}>
        <CustomRadioBox label={transl('department.user.form.marital_status')} name="marital_status" options={maritalStatusList(transl)} />
      </Grid>
