...
const EmployeeEducationDrawer = (
  props: EmployeeEducationDrawerType
) => {
  const { open, toggle, refetch, employeeEducation, stakeholderId } =
    props;
  ...
  const editEmployeeEducation = async (
    body: IApiPayload<EmployeeEducation>
  ) =>
    employeeEducationApiService.update(
        ...
        <FormPageWrapper
          ...
          initialValues={{
            ...(employeeEducation as EmployeeEducation),
              ...
              .find(
                (country) =>
                  country.value === employeeEducation.nationality
              ),
          }}
          createActionFunc={
            isEdit
