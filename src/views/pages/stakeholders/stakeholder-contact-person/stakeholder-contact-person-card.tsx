    ...
    <Card>
      <CardContent>
        <Box display="flex" gap={4} alignItems="center">
          <Avatar
            alt={stakeholderContactPerson?.full_name}
            sx={{ width: 55, height: 55 }}
          />
          <Box>
            <Typography variant="subtitle1">
              {t("stakeholder.stakeholder-contact-person.form.name")} :{" "}
              {stakeholderContactPerson?.full_name}
            </Typography>
            <Typography variant="subtitle2">
              {t("stakeholder.stakeholder-contact-person.form.phone-number")} :{" "}
              {stakeholderContactPerson?.phone_number}
            </Typography>
            <Typography variant="subtitle2">
              {t("stakeholder.stakeholder-contact-person.form.email")} :{" "}
              {stakeholderContactPerson?.email}
            </Typography>
          </Box>
        </Box>
      </CardContent>
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <Box display="flex" alignItems="center" gap={1}>
          <FileDrawer
            ...
            type={uploadableProjectFileTypes.stakeholderContactPerson}
          />
