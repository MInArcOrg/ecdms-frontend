...
const StakeholderStudyFieldForm: React.FC<StakeholderStudyFieldFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
    ...
    <Grid container spacing={3}>
      <Grid item xs={12}>
        <CustomSelect
          ...
          placeholder={transl(
            "stakeholder.other.stakeholder-study-field.details.study-field"
          )}
          options={
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "stakeholder.other.stakeholder-study-field.details.description"
          )}
          name="description"
          size="small"
          multiline
