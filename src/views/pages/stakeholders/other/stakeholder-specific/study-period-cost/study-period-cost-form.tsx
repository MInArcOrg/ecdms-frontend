...
const StudyPeriodCostForm: React.FC<StudyPeriodCostFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
  ...
  const { data: studyFields } = useQuery({
    ...
    queryFn: () => stakeholderOtherApiService<StakeholderStudyField>().getAll("stakeholderstudyfield", {pagination:{page:1,pageSize:100}}),
  });
