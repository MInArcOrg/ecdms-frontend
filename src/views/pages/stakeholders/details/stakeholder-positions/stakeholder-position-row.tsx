...
export const positionColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => {
      const parentDepartment = departments.find(
        (d) => d.id === row.stakeholder_department_id,
      );
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.required_education || t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    renderCell: ({ row }: CellType) =>
      row.required_work_experience || t("common.not-available"),
  },
  {
    flex: 0.1,
    minWidth: 100,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.no_of_professionals || t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
