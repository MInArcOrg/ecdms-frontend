      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.position.parent-department")}:{" "}
            {getParentDepartmentName(position.stakeholder_department_id)}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.position.required-education")}:{" "}
            {position.required_education || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.position.salary")}:{" "}
            {position.salary || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.position.no-of-professionals")}:{" "}
            {position.no_of_professionals || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.position.description")}: {position.description}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.position.reference")}:{" "}
            {position.reference || t("common.not-available")}
          </Typography>
        </Box>
      </CardContent>
