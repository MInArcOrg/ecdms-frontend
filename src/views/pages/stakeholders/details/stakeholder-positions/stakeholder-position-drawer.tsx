...
const PositionDrawer = (props: PositionDrawerType) => {
  ...
  const createPosition = async (body: IApiPayload<StakeholderPosition>) =>
    stakeholderPositionApiService.create(body);
      ...
      {() => (
        ...
        >
          {(formik: FormikProps<StakeholderPosition>) => (
            <PositionForm formik={formik} departments={departments} />
          )}
        </FormPageWrapper>
      )}
    </CustomSideDrawer>
