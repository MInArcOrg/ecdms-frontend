...
function StakeholderCertificateList({
  stakeholderId,
}: {
  type: string;
  ...
  const [selectedRow, setSelectedRow] = useState<StakeholderCertificate | null>(
    null,
  );
  const fetchStakeholderCertificates = (
    params: GetRequestParam,
  ): Promise<IApiResponse<StakeholderCertificate[]>> => {
    return stakeholderCertificateApiService.getAll({
      ...params,
    ...
    <Box>
      ...
      <ItemsListing
        ...
        ItemViewComponent={({ data }) => (
          <StakeholderCertificateCard
            stakeholderCertificate={data}
            onEdit={handleEdit}
            refetch={refetch}
        ...
        tableProps={{
          headers: stakeholderCertificateColumns(
            () => {},
            handleEdit,
            handleDelete,
            transl,
