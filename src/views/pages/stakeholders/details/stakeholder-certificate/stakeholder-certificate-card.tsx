      ...
      actions={
        <>
          <FileDrawer
            ...
            type={uploadableProjectFileTypes.certificate}
          />
    ...
    >
      <Box display="flex" justifyContent="space-between" alignItems="center">
        ...
        {stakeholderCertificate.certification_number && (
          <Chip
            label={stakeholderCertificate.certification_number}
            color="primary"
            variant="outlined"
            size="small"
          />
      ...
      <Box mt={2} display="flex" flexDirection="column" gap={1}>
        <Box display="flex" alignItems="center">
          ...
          {stakeholderCertificate.issue_date && (
            <Typography variant="body2" color="textSecondary" ml={1} mr={3}>
              ...
              {getDynamicDate(
                i18n,
                stakeholderCertificate?.issue_date as string,
              ).toDateString()}
            </Typography>
          )}
          {stakeholderCertificate.expire_date && (
            <Typography variant="body2" color="textSecondary">
              ...
              {getDynamicDate(
                i18n,
                stakeholderCertificate?.expire_date as string,
              ).toDateString()}
            </Typography>
          )}
        </Box>
        {stakeholderCertificate.type && (
          <Typography variant="body2" color="textSecondary">
            {t("stakeholder.stakeholder-certificate.form.type")}:{" "}
            {stakeholderCertificate.type}
          </Typography>
        )}
        {stakeholderCertificate.scope && (
          <Typography variant="body2" color="textSecondary">
            {t("stakeholder.stakeholder-certificate.form.scope")}:{" "}
            {stakeholderCertificate.scope}
          </Typography>
        )}
        {stakeholderCertificate.certifying_body && (
          <Typography variant="body2" color="textSecondary">
            {t("stakeholder.stakeholder-certificate.form.certifying-body")}:{" "}
            {stakeholderCertificate.certifying_body}
          </Typography>
        )}
        {stakeholderCertificate.remark && (
          <Typography variant="body2" color="textSecondary">
            {t("stakeholder.stakeholder-certificate.form.remark")}:{" "}
            {stakeholderCertificate.remark}
          </Typography>
        )}
      </Box>
