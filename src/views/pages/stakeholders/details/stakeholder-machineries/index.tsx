...
const StakeholderMachineryList: React.FC<StakeholderMachineryListProps> = ({
  stakeholderId,
}) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] = useState<StakeholderMachinery | null>(
    null,
  );
  ...
  const mapMachineryToDetailItems = (
    machinery: StakeholderMachinery,
  ): { title: string; value: string }[] => [
    { title: t("stakeholder.machinery.name"), value: machinery?.name || "N/A" },
    {
      title: t("stakeholder.machinery.plate-no"),
      value: machinery?.plate_no || "N/A",
    },
    {
      title: t("stakeholder.machinery.brand-name"),
      value: machinery?.brand_name || "N/A",
    },
    {
      title: t("stakeholder.machinery.model"),
      value: machinery?.model || "N/A",
    },
    {
      title: t("stakeholder.machinery.year"),
      value: machinery?.year?.toString() || "N/A",
    },
    {
      title: t("stakeholder.machinery.chassis-number"),
      value: machinery?.chassis_number || "N/A",
    },
    {
      title: t("stakeholder.machinery.engine-number"),
      value: machinery?.engine_number || "N/A",
    },
    {
      title: t("stakeholder.machinery.capacity"),
      value: machinery?.capacity || "N/A",
    },
    {
      title: t("stakeholder.machinery.purpose"),
      value: machinery?.purpose || "N/A",
    },
    {
      title: t("stakeholder.machinery.quantity"),
      value: machinery?.quantity?.toString() || "N/A",
    },
    {
      title: t("stakeholder.machinery.current-situation"),
    ...
    },
    {
      ...
      value: machinery?.created_at
        ? formatCreatedAt(machinery.created_at)
        : "N/A",
    },
  ];
