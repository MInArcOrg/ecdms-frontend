...
const MachineryDrawer = (props: MachineryDrawerType) => {
  ...
  const createMachinery = async (body: IApiPayload<StakeholderMachinery>) =>
    stakeholderMachineryApiService.create(body);

  const editMachinery = async (body: IApiPayload<StakeholderMachinery>) =>
    stakeholderMachineryApiService.update(machinery?.id || "", body);
