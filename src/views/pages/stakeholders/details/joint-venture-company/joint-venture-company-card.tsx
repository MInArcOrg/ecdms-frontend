...
const JointVentureCompanyCard: React.FC<JointVentureCompanyCardProps> = ({
  jointVentureCompany,
  refetch,
  onEdit,
  onDelete,
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.joint-venture-company.specialization")}:{" "}
            {jointVentureCompany.specialization || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.joint-venture-company.ownershipPercentage")}:{" "}
            {jointVentureCompany.ownership_percentage || "N/A"}%
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.joint-venture-company.description")}:{" "}
            {jointVentureCompany.description}
          </Typography>
        </Box>
      </CardContent>
