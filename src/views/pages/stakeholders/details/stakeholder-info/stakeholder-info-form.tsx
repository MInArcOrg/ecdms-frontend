...
const StakeholderInfoForm: React.FC<StakeholderInfoFormProps> = ({
    ...
    return (
        <>
            ...
            <CustomTextBox
                fullWidth
                label={transl("stakeholderinfo.form.capital")}
                placeholder={transl("stakeholderinfo.form.capital")}
                name="capital"
                size="small"
                sx={{ mb: 2 }}
            />
            ...
            <CustomTextBox
                fullWidth
                label={transl("stakeholderinfo.form.general_manager")}
                placeholder={transl("stakeholderinfo.form.general_manager")}
            ...
            <CustomTextBox
                fullWidth
                label={transl("stakeholderinfo.form.description")}
                placeholder={transl("stakeholderinfo.form.description")}
                name="description"
                size="small"
                multiline
                rows={4}
