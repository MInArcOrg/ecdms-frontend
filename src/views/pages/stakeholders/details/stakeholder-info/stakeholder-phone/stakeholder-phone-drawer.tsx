...
const StakeholderPhoneDrawer = (props: StakeholderPhoneDrawerType) => {
  ...
  const createStakeholderPhone = async (body: IApiPayload<StakeholderPhone>) =>
  ...
  return (
    <CustomSideDrawer
      title={`stakeholder.stakeholder-phone.${
        isEdit ? `edit-stakeholder-phone` : `create-stakeholder-phone`
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit ? editStakeholderPhone : createStakeholderPhone
          }
