...
const StakeholderOperationLocationForm: React.FC<
  StakeholderOperationLocationFormProps
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12}>
        <CustomAutocomplete
          label={transl(
            "stakeholder.stakeholder-operation-location.form.country",
          )}
          placeholder={transl(
            "stakeholder.stakeholder-operation-location.form.country",
          )}
      ...
      <Grid item xs={12}>
        <CustomSwitch
          label={transl(
            "stakeholder.stakeholder-operation-location.form.status",
          )}
          name="status"
