...
const BranchAddressList: React.FC<BranchAddressListProps> = ({ stakeholderId }) => {
  ...
  const mapBranchAddressToDetailItems = (branchAddress: StakeholderBranchAddress): { title: string; value: string }[] => [
    { title: t('stakeholder.stakeholder-branch-address.country'), value: branchAddress.country },
    { title: t('stakeholder.stakeholder-branch-address.region'), value: branchAddress.region },
    { title: t('stakeholder.stakeholder-branch-address.city'), value: branchAddress.city },
    { title: t('stakeholder.stakeholder-branch-address.subcity'), value: branchAddress.subcity },
    { title: t('stakeholder.stakeholder-branch-address.woreda'), value: branchAddress.woreda },
    { title: t('stakeholder.stakeholder-branch-address.street'), value: branchAddress.street || 'N/A' },
    { title: t('stakeholder.stakeholder-branch-address.blockNo'), value: branchAddress.block_no || 'N/A' },
    { title: t('stakeholder.stakeholder-branch-address.website'), value: branchAddress.website || 'N/A' },
    { title: t('stakeholder.stakeholder-branch-address.northing'), value: branchAddress.northing },
    { title: t('stakeholder.stakeholder-branch-address.easting'), value: branchAddress.easting },
    { title: t('stakeholder.stakeholder-branch-address.branch'), value: getBranchName(branchAddress.stakeholder_branch_id) },
    {
