...
export const licenseColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => row.license_category || t('common.not-available')
  },
  {
    flex: 0.16,
    minWidth: 140,
    ...
    renderCell: ({ row }: CellType) => row.license_name || t('common.not-available')
  },
  {
    flex: 0.16,
    minWidth: 140,
    ...
    renderCell: ({ row }: CellType) => row.license_scope || t('common.not-available')
  },
  {
    flex: 0.16,
    minWidth: 140,
    ...
    renderCell: ({ row }: CellType) => row.licensing_body || t('common.not-available')
  },
  {
    flex: 0.14,
    minWidth: 120,
