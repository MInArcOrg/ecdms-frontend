...
const StakeholderLicenseList: React.FC<StakeholderLicenseListProps> = ({
  stakeholderId,
}) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] = useState<StakeholderLicense | null>(
    null,
  );
