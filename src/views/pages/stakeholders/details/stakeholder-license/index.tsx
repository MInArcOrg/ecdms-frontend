...
const StakeholderLicenseList: React.FC<StakeholderLicenseListProps> = ({ stakeholderId }) => {
  ...
  const mapLicenseToDetailItems = (license: StakeholderLicense): { title: string; value: string }[] => [
    { title: t('stakeholder.stakeholder-license.form.license-type'), value: license.license_type || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.licence-category'), value: license.license_category || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.license-name'), value: license.license_name || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.license-scope'), value: license.license_scope || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.licensing-body'), value: license.licensing_body || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.license-number'), value: license.license_number || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.issue-date'), value: formatCreatedAt(license.issue_date) || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.expire-date'), value: formatCreatedAt(license.expire_date) || 'N/A' },
    { title: t('stakeholder.stakeholder-license.form.remark'), value: license.remark || 'N/A' },
    {
