...
const EmployeeDrawer = (props: EmployeeDrawerType) => {
  ...
  const createEmployee = async (body: IApiPayload<StakeholderEmployee>) =>
    stakeholderEmployeeApiService.create(body);

  const editEmployee = async (body: IApiPayload<StakeholderEmployee>) =>
    stakeholderEmployeeApiService.update(employee?.id || "", body);
