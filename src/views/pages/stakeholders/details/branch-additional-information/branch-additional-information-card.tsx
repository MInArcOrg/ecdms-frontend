      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t('stakeholder.branch-additional-information.additionalInformation')}: {additionalInfo.additional_information}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('stakeholder.branch-additional-information.reference')}: {additionalInfo.reference || t('common.not-available')}
          </Typography>
        </Box>
      </CardContent>
