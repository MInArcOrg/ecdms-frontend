...
const BranchContactPersonDrawer = (props: BranchContactPersonDrawerType) => {
  ...
  const editBranchContactPerson = async (
    ...
    return stakeholderBranchContactPersonApiService.update(
      branchContactPerson?.id || "",
      body,
    );
  };
  ...
  const onActionSuccess = async (
    response: IApiResponse<StakeholderBranchContactPerson>,
  ) => {
    refetch();
    handleClose();
  };
  ...
  return (
    <CustomSideDrawer
      title={`stakeholder.stakeholder-branch-contact-person.${
        isEdit ? "edit" : "create"
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit ? editBranchContactPerson : createBranchContactPerson
          }
          onActionSuccess={onActionSuccess}
          onCancel={handleClose}
        >
          {(formik: FormikProps<StakeholderBranchContactPerson>) => (
            <BranchContactPersonForm
              formik={formik}
