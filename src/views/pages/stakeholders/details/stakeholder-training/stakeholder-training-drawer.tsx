...
const StakeholderTrainingDrawer = (props: StakeholderTrainingDrawerType) => {
  ...
  const createStakeholderTraining = async (
    body: IApiPayload<StakeholderTraining>,
  ) => stakeholderTrainingApiService.create(body);

  const editStakeholderTraining = async (
    body: IApiPayload<StakeholderTraining>,
  ) =>
  ...
  const onActionSuccess = async (
    response: IApiResponse<StakeholderTraining>,
    payload: IApiPayload<StakeholderTraining>,
  ) => {
  ...
  return (
    <CustomSideDrawer
      title={`stakeholder.stakeholder-training.${
        isEdit ? `edit-stakeholder-training` : `create-stakeholder-training`
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          initialValues={{
            ...stakeholderTraining,
            provision_date: formatInitialDateDate(
              stakeholderTraining?.provision_date,
            ),
          }}
          createActionFunc={
            isEdit ? editStakeholderTraining : createStakeholderTraining
          }
