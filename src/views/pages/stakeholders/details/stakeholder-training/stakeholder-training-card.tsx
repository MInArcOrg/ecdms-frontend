      ...
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          ...
          {stakeholderTraining.type && (
            <Chip
              label={stakeholderTraining.type}
              color="primary"
              variant="outlined"
              size="small"
            />
        ...
        <Box mt={2}>
          <Typography variant="body2" color="textSecondary">
            {t("stakeholder.stakeholder-training.form.provider")}:{" "}
            {stakeholderTraining.provider}
          </Typography>
          <Box display="flex" alignItems="center" mt={1}>
            ...
            <Typography variant="body2" color="textSecondary" ml={1}>
              ...
              {getDynamicDate(
                i18n,
                stakeholderTraining.provision_date as string,
              ).toDateString()}
            </Typography>
          </Box>
          {stakeholderTraining.quantity && (
            <Typography variant="body2" color="textSecondary" mt={2}>
              {t("stakeholder.stakeholder-training.form.quantity")}:{" "}
              {stakeholderTraining.quantity}
            </Typography>
          )}
          {stakeholderTraining.description && (
            <Typography variant="body2" color="textSecondary" mt={2}>
              {t("stakeholder.stakeholder-training.form.description")}:{" "}
              {stakeholderTraining.description}
            </Typography>
          )}
        </Box>
      ...
      <CardActions>
        <Box display="flex" alignItems="center">
          <FileDrawer
            ...
            type={uploadableProjectFileTypes.training}
          />
        </Box>
