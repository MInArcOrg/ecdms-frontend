...
const SafetyEquipmentForm: React.FC<SafetyEquipmentFormProps> = ({ formik }) => {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={6}>
        <CustomTextBox fullWidth label={t('stakeholder.safety-equipment.year')} name="year" size="small" sx={{ mb: 2 }} type="number" />
      </Grid>
      <Grid item xs={6}>
      ...
      <Grid item xs={6}>
        <CustomTextBox fullWidth label={t('stakeholder.safety-equipment.location')} name="location" size="small" sx={{ mb: 2 }} />
      </Grid>
    </Grid>
  );
};
