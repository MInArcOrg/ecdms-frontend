...
const SafetyEquipmentList: React.FC<SafetyEquipmentListProps> = ({ stakeholderId }) => {
  ...
  const mapSafetyEquipmentToDetailItems = (equipment: SafetyEquipment): { title: string; value: string }[] => [
    { title: t('stakeholder.safety-equipment.name'), value: equipment?.name || 'N/A' },
    { title: t('stakeholder.safety-equipment.serial-no'), value: equipment?.serial_no || 'N/A' },
    { title: t('stakeholder.safety-equipment.brand-name'), value: equipment?.brand_name || 'N/A' },
    { title: t('stakeholder.safety-equipment.model'), value: equipment?.model || 'N/A' },
    { title: t('stakeholder.safety-equipment.year'), value: equipment?.year?.toString() || 'N/A' },
    { title: t('stakeholder.safety-equipment.capacity'), value: equipment?.capacity || 'N/A' },
    { title: t('stakeholder.safety-equipment.purpose'), value: equipment?.purpose || 'N/A' },
    { title: t('stakeholder.safety-equipment.quantity'), value: equipment?.quantity?.toString() || 'N/A' },
    { title: t('stakeholder.safety-equipment.current-situation'), value: equipment?.current_situation || 'N/A' },
    { title: t('stakeholder.safety-equipment.location'), value: equipment?.location || 'N/A' },
    {
