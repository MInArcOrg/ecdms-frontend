      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.safety-equipment.serial-no")}:{" "}
            {equipment.serial_no || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.safety-equipment.brand-name")}:{" "}
            {equipment.brand_name || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.safety-equipment.model")}: {equipment.model}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.safety-equipment.year")}:{" "}
            {equipment.year || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("stakeholder.safety-equipment.quantity")}:{" "}
            {equipment.quantity || t("common.not-available")}
          </Typography>
        </Box>
      </CardContent>
