      ...
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center">
          ...
          {stakeholderRegulation.revision_no && (
            <Chip
              label={`${t("revision")} ${stakeholderRegulation.revision_no}`}
              color="primary"
              variant="outlined"
              size="small"
            />
        ...
        <Box mt={2}>
          <Typography variant="body2" color="textSecondary">
            {t("stakeholder.stakeholder-regulation.form.prepared-by")}:{" "}
            {stakeholderRegulation.prepared_by}
          </Typography>
          <Box display="flex" alignItems="center" mt={1}>
            ...
            <Typography variant="body2" color="textSecondary" ml={1}>
              ...
              {getDynamicDate(
                i18n,
                stakeholderRegulation.effective_start_date as string,
              ).toDateString()}
            </Typography>
          </Box>
          <Box display="flex" alignItems="center" mt={1}>
            ...
            <Typography variant="body2" color="textSecondary" ml={1}>
              ...
              {getDynamicDate(
                i18n,
                stakeholderRegulation.effective_end_date as string,
              ).toDateString()}
            </Typography>
          </Box>
          {stakeholderRegulation.description && (
            <Typography variant="body2" color="textSecondary" mt={2}>
              {t("stakeholder.stakeholder-regulation.form.description")}:{" "}
              {stakeholderRegulation.description}
            </Typography>
          )}
        </Box>
      ...
      <CardActions>
        <Box display="flex" alignItems="center">
          <FileDrawer
            ...
            type={uploadableProjectFileTypes.regulation}
          />
        </Box>
