...
const MaterialList: React.FC<MaterialListProps> = ({ stakeholderId }) => {
  ...
  const [selectedRow, setSelectedRow] = useState<StakeholderMaterial | null>(
    null,
  );
  ...
  const mapMaterialToDetailItems = (
    ...
    },
    {
      ...
      value: material?.created_at
        ? formatCreatedAt(material.created_at)
        : "N/A",
    },
  ];
