...
const MaterialList: React.FC<MaterialListProps> = ({ stakeholderId }) => {
  ...
  const mapMaterialToDetailItems = (material: StakeholderMaterial): { title: string; value: string }[] => [
    ...
    { title: t('stakeholder.material.category'), value: getCategoryName(material?.material_category) },
    { title: t('stakeholder.material.subcategory'), value: material?.material_subcategory || 'N/A' },
    { title: t('stakeholder.material.description'), value: material?.description || 'N/A' },
    { title: t('stakeholder.material.purpose'), value: material?.purpose || 'N/A' },
    { title: t('stakeholder.material.quantity'), value: material?.quantity?.toString() || 'N/A' },
    { title: t('stakeholder.material.unit-price'), value: material?.unit_price?.toString() || 'N/A' },
    { title: t('stakeholder.material.current-situation'), value: material?.current_situation || 'N/A' },
    { title: t('stakeholder.material.location'), value: material?.location || 'N/A' },
    {
