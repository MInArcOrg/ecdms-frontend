...
export const materialColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => {
      const category = materialCategories.find(
        (cat) => cat.id === row.material_category,
      );
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.material_subcategory || t("common.not-available"),
  },
  {
    flex: 0.1,
    minWidth: 80,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.unit_price || t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    renderCell: ({ row }: CellType) =>
      row.location || t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
