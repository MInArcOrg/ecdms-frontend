  ...
  return (
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.material.name")}
          name="name"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.material.purpose")}
          name="purpose"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.material.quantity")}
          name="quantity"
          size="small"
          sx={{ mb: 2 }}
          type="number"
      ...
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.material.unit-price")}
          name="unit_price"
          size="small"
          sx={{ mb: 2 }}
          type="number"
      ...
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.material.current-situation")}
      ...
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.material.location")}
          name="location"
          size="small"
          sx={{ mb: 2 }}
        />
