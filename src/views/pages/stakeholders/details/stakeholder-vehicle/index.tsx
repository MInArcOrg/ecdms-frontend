...
const StakeholderVehicleList: React.FC<StakeholderVehicleListProps> = ({ stakeholderId }) => {
  ...
  const mapVehicleToDetailItems = (vehicle: StakeholderVehicle): { title: string; value: string }[] => [
    { title: t('stakeholder.stakeholder-vehicle.form.vehicle-name'), value: vehicle.vehicle_name || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.plate-number'), value: vehicle.plate_number || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.brand-name'), value: vehicle.brand_name || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.model'), value: vehicle.model || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.year'), value: vehicle.year?.toString() || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.chassis-number'), value: vehicle.chassis_number || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.engine-number'), value: vehicle.engine_number || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.capacity'), value: vehicle.capacity || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.purpose'), value: vehicle.purpose || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.quantity'), value: vehicle.quantity?.toString() || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.current-situation'), value: vehicle.current_situation || 'N/A' },
    { title: t('stakeholder.stakeholder-vehicle.form.location'), value: vehicle.location || 'N/A' },
    {
