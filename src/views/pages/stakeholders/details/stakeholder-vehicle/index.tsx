...
const StakeholderVehicleList: React.FC<StakeholderVehicleListProps> = ({
  stakeholderId,
}) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] = useState<StakeholderVehicle | null>(
    null,
  );
