  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={6}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.stakeholder-vehicle.form.model")}
          name="model"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={6}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.stakeholder-vehicle.form.year")}
          name="year"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={6}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.stakeholder-vehicle.form.capacity")}
          name="capacity"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={6}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.stakeholder-vehicle.form.purpose")}
          name="purpose"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={6}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.stakeholder-vehicle.form.quantity")}
          name="quantity"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={6}>
        <CustomTextBox
          fullWidth
          label={t("stakeholder.stakeholder-vehicle.form.location")}
          name="location"
          size="small"
          sx={{ mb: 2 }}
        />
