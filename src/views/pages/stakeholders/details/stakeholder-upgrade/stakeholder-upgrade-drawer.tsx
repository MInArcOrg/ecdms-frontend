...
const UpgradeDrawer = (props: UpgradeDrawerType) => {
  ...
  const onActionSuccess = async (
    response: IApiResponse<StakeholderUpgrade>,
  ) => {
    refetch();
    handleClose();
  };
  ...
  return (
    ...
    >
      {() => (
        <FormPageWrapper
          edit={isEdit}
          title={`stakeholder.stakeholder-upgrade.${
            isEdit ? "edit" : "create"
          }`}
