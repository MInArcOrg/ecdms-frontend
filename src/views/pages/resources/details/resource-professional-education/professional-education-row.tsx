...
export const educationColumns = (
  ...
  t: any
): GridColDef[] => [
    {
      ...
      renderCell: ({ row }: CellType) => {
        return (
          ...
          >
            {row.studyField ? row.studyField.title : row.study_field_id || t('common.not-available')}
          </Typography>
        );
      }
    },
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => row.programType?.title || row.program_type_id || t('common.not-available')
    },
    {
      flex: 0.1,
      minWidth: 80,
