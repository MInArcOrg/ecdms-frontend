  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.education.school-name")}
          name="school_name"
          size="small"
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={12} sm={6}>
        <CustomDatePicker
          fullWidth
          label={t("resources.professional.education.start-date")}
          name="start_date"
          sx={{ mb: 2 }}
        />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomDatePicker
          fullWidth
          label={t("resources.professional.education.end-date")}
          name="end_date"
          sx={{ mb: 2 }}
        />
      </Grid>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.education.gpa")}
          name="gpa"
          type="number"
          size="small"
          sx={{ mb: 2 }}
