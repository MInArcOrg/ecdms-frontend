...
const ResourceStudyFieldCard: React.FC<ResourceStudyFieldCardProps> = ({
  resourceStudyField,
  onEdit,
  onDelete,
  refetch,
          ...
          <Grid item xs={12}>
            <Box display="flex" alignItems="center">
              <Typography variant="subtitle1">
                <strong>
                  {t("resource.resource-study-field.form.description")}:
                </strong>{" "}
                {resourceStudyField.description}
              </Typography>
            </Box>
          </Grid>
        </Grid>
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <Box>
          <FileDrawer
            ...
            type={uploadableResourceFileTypes.resourceStudyField}
          />
          <Box display="flex" alignItems="end">
            ...
            <RowOptions
              onEdit={onEdit}
              onDelete={() => onDelete(resourceStudyField.id)}
              item={resourceStudyField}
              options={[]}
            />
          </Box>
        </Box>
