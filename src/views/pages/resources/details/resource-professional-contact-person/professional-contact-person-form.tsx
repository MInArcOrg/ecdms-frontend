...
const ProfessionalContactPersonForm: React.FC<
  ProfessionalContactPersonFormProps
> = ({ formik }) => {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.contact-person.firstName")}
          name="first_name"
          size="small"
        />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.contact-person.middleName")}
          name="middle_name"
          size="small"
        />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.contact-person.lastName")}
          name="last_name"
          size="small"
        />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.contact-person.nationalIdNo")}
          name="national_id_no"
          size="small"
        />
      </Grid>
      ...
      <Grid item xs={12}>
        <CustomPhoneInput
          fullWidth
          label={t("resources.professional.contact-person.phoneNo")}
          name="phone_no"
          size="small"
        />
      </Grid>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.contact-person.email")}
          name="email"
          size="small"
        />
      </Grid>
