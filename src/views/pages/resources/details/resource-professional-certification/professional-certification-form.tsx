...
const CertificationForm: React.FC<CertificationFormProps> = ({ formik, file, onFileChange }) => {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12} sm={6}>
        <CustomDatePicker fullWidth label={t('resources.professional.certification.issue-date')} name="issue_date" sx={{ mb: 2 }} />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomDatePicker fullWidth label={t('resources.professional.certification.expire-date')} name="expire_date" sx={{ mb: 2 }} />
      </Grid>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
