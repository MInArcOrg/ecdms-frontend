...
export const membershipColumns = (
  ...
  },
  {
    ...
    headerName: t(
      "resources.professional.association-membership.membership-type",
    ),
    renderCell: ({ row }: CellType) =>
      row.membership_type || t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 160,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.description.substring(0, 50) + "..." || t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
