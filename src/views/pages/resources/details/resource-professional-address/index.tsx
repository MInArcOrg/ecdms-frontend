...
const AddressList: React.FC<AddressListProps> = ({ professionalId }) => {
  ...
  const [selectedRow, setSelectedRow] = useState<ProfessionalAddress | null>(
    null,
  );
  ...
  ): Promise<IApiResponse<ProfessionalAddress[]>> => {
