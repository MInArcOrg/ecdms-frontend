...
const AddressList: React.FC<AddressListProps> = ({ professionalId }) => {
  ...
  const mapAddressToDetailItems = (address: ProfessionalAddress): { title: string; value: string }[] => [
    { title: t('professional.address.country'), value: address?.country || 'N/A' },
    { title: t('professional.address.region'), value: address?.region || 'N/A' },
    { title: t('professional.address.city'), value: address?.city || 'N/A' },
    { title: t('professional.address.sub_city'), value: address?.sub_city || 'N/A' },
    { title: t('professional.address.woreda'), value: address?.woreda || 'N/A' },
    { title: t('professional.address.street'), value: address?.street || 'N/A' },
    { title: t('professional.address.block_no'), value: address?.block_no || 'N/A' },
    { title: t('professional.address.website'), value: address?.website || 'N/A' },
    { title: t('professional.address.northing'), value: address?.northing?.toString() || 'N/A' },
    { title: t('professional.address.easting'), value: address?.easting?.toString() || 'N/A' },
    { title: t('common.table-columns.created-at'), value: address?.created_at ? formatCreatedAt(address.created_at) : 'N/A' }
  ];
