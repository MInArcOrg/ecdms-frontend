  ...
  return (
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12} sm={6}>
        <CustomTextBox fullWidth label={t('resources.professional.firstName')} name="first_name"
          formatAsName={true} size="small" />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox fullWidth label={t('resources.professional.middleName')} name="middle_name"
          formatAsName={true} size="small" />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox fullWidth label={t('resources.professional.lastName')} name="last_name"
          formatAsName={true} size="small" />
      </Grid>
      <Grid item xs={12} sm={6}>
