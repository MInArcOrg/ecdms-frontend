  ...
  return (
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.firstName")}
          name="first_name"
          size="small"
        />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.middleName")}
          name="middle_name"
          size="small"
        />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.lastName")}
          name="last_name"
          size="small"
        />
      </Grid>
      <Grid item xs={12} sm={6}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.nationalIdNo")}
          name="national_id_no"
          size="small"
        />
      </Grid>
      <Grid item xs={12}>
        <CustomDatePicker
          fullWidth
          label={t("resources.professional.dateOfBirth")}
          name="date_of_birth"
          size="small"
        />
      </Grid>
      <Grid item xs={12}>
        <CustomRadioBox
          fullWidth
          label={t("resources.professional.gender")}
          name="gender"
      ...
      <Grid item xs={12}>
        <CustomPhoneInput
          fullWidth
          label={t("resources.professional.phoneNo")}
          name="phone_no"
          size="small"
        />
      </Grid>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={t("resources.professional.email")}
          name="email"
          size="small"
        />
      </Grid>
