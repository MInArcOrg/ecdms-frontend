...
function ReportSummaryViewCard({
  data,
  detailData,
  loading,
}: ReportSummaryViewCardProps) {
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell>
              {data?.physical?.percent !== "NaN" ? data?.physical?.percent : 0}
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell>
              {data?.financial?.percent !== "NaN"
                ? data?.financial?.percent
                : 0}
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell>
              {data?.expense?.percent !== "NaN" ? data?.expense?.percent : 0}
            </TableCell>
          </TableRow>
          <TableRow>
            ...
            <TableCell>
              {data?.loss?.percent !== "NaN" ? data?.loss?.percent : 0}
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
