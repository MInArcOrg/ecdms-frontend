...
function ReportDetail({
  ...
  return (
    <Fragment>
      <CustomSideDrawer
        title={`Q${projectReport.quarter}/${formatDate(
          projectReport.start,
          "yyyy",
        )} ${t("Report")} ${t("Detail")}`}
            ...
            <CardContent>
              <Box>
                ...
                {[
                  ...
                  {
                    label: t("Other Expense"),
                    value: projectReport.other_expense,
                  },
                  {
                    label: t("Subcontractor Expense"),
                    value: projectReport.sub_contractor_cost,
                  },
                  {
                    label: `${t("Subtotal")}`,
                    value: projectReport.sub_total_expense,
                    bold: true,
                  },
                  {
                    label: t("Overhead Cost"),
                    value: projectReport.over_head_cost,
                  },
                  {
                    label: t("Profit - loss"),
                    value: projectReport.profit_or_loss,
                  },
                  {
                    label: `${t("Project")} ${t("Expense")}`,
                    value: projectReport.project_expense,
                    bold: true,
                  },
                  {
                    label: `${t("Financial Performance")}`,
                    value: projectReport.financial_performance,
                  },
                  {
                    label: `${t("Physical Performance")}`,
                    value: projectReport.physical_performance,
                  },
