          ...
          <Grid item xs={12}>
            <Box>
              ...
              <Typography
                ...
                sx={{ marginTop: 0.5 }}
              >
                <span>{t("project.report.form.financial-year")}:</span>{" "}
                <strong>{String(projectReport.year) ?? t("N/A")}</strong>,{" "}
                {t("Quarter")}:{" "}
                <strong>{projectReport.quarter ?? t("N/A")}</strong>
              </Typography>
              <Typography
                variant="body2"
                color="text.secondary"
              ...
              >
                ...
                <strong>
                  {formatCurrency(Number(projectReport.physical_performance))}
                </strong>
              </Typography>
              <Typography
                variant="body2"
              ...
              >
                ...
                <strong>
                  {formatCurrency(Number(projectReport.financial_performance))}
                </strong>
              </Typography>
              <Typography
                variant="body2"
              ...
              >
                ...
                <strong>
                  {formatCurrency(Number(projectReport.project_expense)) ??
                    t("N/A")}
                </strong>
              </Typography>
            </Box>
