      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t('project.project-contact-person.form.position')}: {contactPerson.position || t('common.not-available')}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.project-contact-person.form.department')}: {contactPerson.department || t('common.not-available')}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.project-contact-person.form.stakeholder')}: {getStakeholderName(contactPerson.stakeholder_id)}
          </Typography>
        </Box>
      </CardContent>
