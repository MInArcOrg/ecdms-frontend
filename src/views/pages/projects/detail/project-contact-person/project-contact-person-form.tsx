...
const ProjectContactPersonForm: React.FC<ProjectContactPersonFormProps> = ({ formik, stakeholders }) => {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12}>
        <CustomRadioBox label={t('project.project-contact-person.form.gender')} name="gender" options={genderList(t)} />
      </Grid>
      <Grid item xs={12}>
        <CustomPhoneInput fullWidth label={t('project.project-contact-person.form.phone')} name="phone" size="small" sx={{ mb: 2 }} />
      </Grid>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
