      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.project-manager.position")}:{" "}
            {manager.position || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            {t("project.project-manager.stakeholder")}:{" "}
            {getStakeholderName(manager.stakeholder_id)}
          </Typography>
        </Box>
      </CardContent>
