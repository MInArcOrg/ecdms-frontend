...
const ManagerList: React.FC<ManagerListProps> = ({ projectId }) => {
  ...
  const fetchManagers = (params: GetRequestParam): Promise<IApiResponse<ProjectManager[]>> => {
  ...
  const mapManagerToDetailItems = (manager: ProjectManager): { title: string; value: string }[] => [
    { title: t("project.project-manager.firstName"), value: manager?.first_name || "N/A" },
    { title: t("project.project-manager.middleName"), value: manager?.middle_name || "N/A" },
    { title: t("project.project-manager.lastName"), value: manager?.last_name || "N/A" },
    { title: t("project.project-manager.position"), value: manager?.position || "N/A" },
    { title: t("project.project-manager.nationalIdNo"), value: manager?.national_id_no || "N/A" },
    { title: t("project.project-manager.gender"), value: manager?.gender || "N/A" },
    { title: t("project.project-manager.phone"), value: manager?.phone || "N/A" },
    { title: t("project.project-manager.email"), value: manager?.email || "N/A" },
    { title: t("project.project-manager.stakeholder"), value: getStakeholderName(manager?.stakeholder_id) },
    {
  ...
  return (
    <Box>
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: managerColumns(handleClickDetail, handleEdit, handleDelete, t, stakeholders),
        }}
        isLoading={isLoading}
