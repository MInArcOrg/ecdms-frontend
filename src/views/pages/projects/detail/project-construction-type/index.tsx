...
const ProjectConstructionTypeList: React.FC<ProjectConstructionTypeListProps> = ({ projectId }) => {
  ...
  const mapConstructionTypeToDetailItems = (
    ...
    { title: t("project.construction-type.construction-type"), value: constructionType?.construction_type || "N/A" },
    { title: t("project.construction-type.description"), value: constructionType?.description || "N/A" },
    {
