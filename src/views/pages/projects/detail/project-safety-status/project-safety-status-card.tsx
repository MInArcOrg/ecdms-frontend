  ...
  return (
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.safety-status.fatal-injuries")}:{" "}
            {safetyStatus.no_of_fatal_injuries}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.safety-status.major-injuries")}:{" "}
            {safetyStatus.no_of_major_injuries}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.safety-status.minor-injuries")}:{" "}
            {safetyStatus.no_of_minor_injuries}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.safety-status.measures-taken")}:{" "}
            {safetyStatus.measures_taken}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.safety-status.lesson-learned")}:{" "}
            {safetyStatus.lesson_learned}
          </Typography>
        </Box>
      </CardContent>
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          id={safetyStatus?.id || ""}
          type={uploadableResourceFileTypes.project_safety_status}
        />
        <ModelAction
