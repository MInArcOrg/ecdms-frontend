...
const PortList: React.FC<PortListProps> = ({ model, projectId, typeId }) => {
  ...
  const mapPortToDetailItems = (port: Port): { title: string; value: string }[] => [
    {
      title: t('project.other.port.details.owner'),
      value: port?.owner || 'N/A'
    },
    {
      title: t('project.other.port.details.operator'),
      value: port?.operator || 'N/A'
    },
    {
      title: t('project.other.port.details.port-type'),
      value: port?.port_type || 'N/A'
    },
    {
    ...
    {
      title: t('project.other.port.details.revision-no'),
      value: port?.revision_no?.toString() || 'N/A'
    },
    {
