...
const TelecomInfrastructureAgeCard: React.FC<
  TelecomInfrastructureAgeCardProps
> = ({ telecomInfrastructureAge, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {t("project.other.telecom-infrastructure-age.infrastructure-age")}{" "}
              - {telecomInfrastructureAge?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.telecom-infrastructure-age.details.cables")}:{" "}
              {renderStatusChip(telecomInfrastructureAge?.cables)}
            </Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.telecom-infrastructure-age.details.wires")}:{" "}
              {renderStatusChip(telecomInfrastructureAge?.wires)}
            </Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.telecom-infrastructure-age.details.routers")}:{" "}
              {renderStatusChip(telecomInfrastructureAge?.routers)}
            </Typography>
          </Grid>
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.telecom-infrastructure-age.details.switches")}:{" "}
              {renderStatusChip(telecomInfrastructureAge?.switches)}
            </Typography>
          </Grid>
        </Grid>
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.infrastructureAge}
        />
