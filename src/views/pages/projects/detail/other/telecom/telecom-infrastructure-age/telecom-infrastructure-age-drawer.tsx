...
const TelecomInfrastructureAgeDrawer = (
  props: TelecomInfrastructureAgeDrawerType,
) => {
  const {
    open,
    toggle,
  ...
  const createTelecomInfrastructureAge = async (
    body: IApiPayload<TelecomInfrastructureAge>,
  ) =>
    projectOtherApiSecondService<TelecomInfrastructureAge>().create(
      otherSubMenu?.apiRoute || "",
      body,
    );

  const editTelecomInfrastructureAge = async (
    body: IApiPayload<TelecomInfrastructureAge>,
  ) =>
  ...
  return (
    <CustomSideDrawer
      title={`project.other.telecom-infrastructure-age.${
        isEdit
          ? `edit-telecom-infrastructure-age`
          : `create-telecom-infrastructure-age`
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit
              ? editTelecomInfrastructureAge
              : createTelecomInfrastructureAge
          }
