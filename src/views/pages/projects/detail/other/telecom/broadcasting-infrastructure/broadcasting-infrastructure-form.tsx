...
const BroadcastingInfrastructureForm: React.FC<
  BroadcastingInfrastructureFormProps
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <Typography variant="subtitle1" gutterBottom>
          {transl(
            "project.other.broadcasting-infrastructure.infrastructure-components",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <FormControlLabel
              ...
              label={transl(
                "project.other.broadcasting-infrastructure.details.antennas",
              )}
            />
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2}>
            ...
            <FormControlLabel
              control={
                <Checkbox
                  ...
                  onChange={(e) =>
                    formik.setFieldValue("transmitters", e.target.checked)
                  }
                  name="transmitters"
                />
              }
          ...
          <Grid item xs={6}>
            <FormControlLabel
              ...
              label={transl(
                "project.other.broadcasting-infrastructure.details.towers",
              )}
            />
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <FormControlLabel
              ...
              label={transl(
                "project.other.broadcasting-infrastructure.details.cables",
              )}
            />
          </Grid>
        </Grid>
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.broadcasting-infrastructure.details.others",
          )}
          placeholder={transl(
            "project.other.broadcasting-infrastructure.details.others",
          )}
