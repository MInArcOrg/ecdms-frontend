        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary" display="flex" alignItems="center" gap={1}>
              {t("project.other.broadcasting-infrastructure.details.broadcasting-network")}: {renderStatusChip(broadcastingInfrastructure?.broadcasting_network)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary" display="flex" alignItems="center" gap={1}>
              {t("project.other.broadcasting-infrastructure.details.transmitters")}: {renderStatusChip(broadcastingInfrastructure?.transmitters)}
            </Typography>
          </Grid>
