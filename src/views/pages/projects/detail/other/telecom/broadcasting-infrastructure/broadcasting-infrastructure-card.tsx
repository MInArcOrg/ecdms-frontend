...
const BroadcastingInfrastructureCard: React.FC<
  BroadcastingInfrastructureCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.broadcasting-infrastructure.details.antennas")}:{" "}
              {renderStatusChip(broadcastingInfrastructure?.antennas)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.broadcasting-infrastructure.details.towers")}:{" "}
              {renderStatusChip(broadcastingInfrastructure?.towers)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.broadcasting-infrastructure.details.cables")}:{" "}
              {renderStatusChip(broadcastingInfrastructure?.cables)}
            </Typography>
          </Grid>
        </Grid>
        ...
        {broadcastingInfrastructure?.others && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.broadcasting-infrastructure.details.others")}:{" "}
              {broadcastingInfrastructure.others}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.broadcastingInfrastructure}
        />
