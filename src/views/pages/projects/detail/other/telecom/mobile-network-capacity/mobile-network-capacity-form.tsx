...
interface MobileNetworkCapacityFormProps {
...
const MobileNetworkCapacityForm: React.FC<MobileNetworkCapacityFormProps> = ({ formik, file, onFileChange, mobileNetworks }) => {
...
export default MobileNetworkCapacityForm;
