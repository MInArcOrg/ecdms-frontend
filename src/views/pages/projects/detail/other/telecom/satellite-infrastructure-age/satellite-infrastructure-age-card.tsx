      ...
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          {satelliteInfrastructureAge?.satellite !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.satellite-infrastructure-age.details.satellite")}: {satelliteInfrastructureAge.satellite} {t("common.years")}
              </Typography>
            </Grid>
          )}
          ...
          {satelliteInfrastructureAge?.ground_stations !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.satellite-infrastructure-age.details.ground-stations")}: {satelliteInfrastructureAge.ground_stations} {t("common.years")}
              </Typography>
            </Grid>
          )}
