...
const SatelliteInfrastructureAgeList: React.FC<SatelliteInfrastructureAgeListProps> = ({ 
  otherSubMenu, 
  projectId, 
  typeId 
}) => {
  ...
  const mapSatelliteInfrastructureAgeToDetailItems = (
  ...
  ): { title: string; value: string }[] => [
    {
      ...
      value: satelliteNetworkMap.get(satelliteInfrastructureAge?.satellite_network_id) || 
