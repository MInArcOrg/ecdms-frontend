...
const EnvironmentalControlDrawer = (props: EnvironmentalControlDrawerType) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    temperature: yup.string().nullable().max(100, 'Temperature cannot exceed 100 characters'),
    humidity: yup.string().nullable().max(100, 'Humidity cannot exceed 100 characters'),
    air_quality: yup.string().nullable().max(100, 'Air quality cannot exceed 100 characters'),
