    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            {environmentalControl?.data_center_id || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.environmental-control.details.temperature")}:{" "}
            {environmentalControl?.temperature || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.environmental-control.details.humidity")}:{" "}
            {environmentalControl?.humidity || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.environmental-control.details.air-quality")}:{" "}
            {environmentalControl?.air_quality || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.environmental-control.details.others")}:{" "}
            {environmentalControl?.others || "N/A"}
          </Typography>
        </Box>
      </CardContent>
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.environmentalControl}
        />
        <ModelAction
