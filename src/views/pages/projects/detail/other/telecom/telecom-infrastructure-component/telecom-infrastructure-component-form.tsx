...
const TelecomInfrastructureComponentForm: React.FC<
  TelecomInfrastructureComponentFormProps
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <CustomTextBox
              fullWidth
              label={transl(
                "project.other.telecom-infrastructure-component.details.hubs",
              )}
              placeholder={transl(
                "project.other.telecom-infrastructure-component.details.hubs",
              )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.telecom-infrastructure-component.details.remark",
          )}
          placeholder={transl(
            "project.other.telecom-infrastructure-component.details.remark",
          )}
