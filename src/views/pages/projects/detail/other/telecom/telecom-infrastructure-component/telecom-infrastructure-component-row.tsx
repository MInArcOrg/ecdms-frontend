...
export const telecomInfrastructureComponentColumns = (
  ...
  },
  {
    ...
    field: "cables",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>{row?.cables?.toString() || "0"}</Typography>
    ),
  },
  {
    flex: 0.1,
    ...
    field: "wires",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>{row?.wires?.toString() || "0"}</Typography>
    ),
  },
  {
    flex: 0.1,
    ...
    field: "routers",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>{row?.routers?.toString() || "0"}</Typography>
    ),
  },
  {
    flex: 0.1,
    ...
    field: "antennas",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>{row?.antennas?.toString() || "0"}</Typography>
    ),
  },
  {
    flex: 0.15,
