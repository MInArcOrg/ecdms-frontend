...
const TelecomInfrastructureComponentDrawer = (
  props: TelecomInfrastructureComponentDrawerType,
) => {
  const {
    open,
    toggle,
  ...
  const createTelecomInfrastructureComponent = async (
    body: IApiPayload<TelecomInfrastructureComponent>,
  ) =>
    projectOtherApiSecondService<TelecomInfrastructureComponent>().create(
      otherSubMenu?.apiRoute || "",
      body,
    );

  const editTelecomInfrastructureComponent = async (
    body: IApiPayload<TelecomInfrastructureComponent>,
  ) =>
  ...
  return (
    <CustomSideDrawer
      title={`project.other.telecom-infrastructure-component.${
        isEdit
          ? `edit-telecom-infrastructure-component`
          : `create-telecom-infrastructure-component`
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit
              ? editTelecomInfrastructureComponent
              : createTelecomInfrastructureComponent
          }
        ...
        >
          {(formik: FormikProps<TelecomInfrastructureComponent>) => {
            return (
              <TelecomInfrastructureComponentForm
                file={uploadableFile}
