...
const DataCenterComponentManufacturerCard: React.FC<DataCenterComponentManufacturerCardProps> = ({
  ...
  return (
    <Card sx={{ p: 2 }}>
      ...
      <CardActions sx={{ justifyContent: 'flex-end' }}>
        <FileDrawer id={dataCenterComponentManufacturer.id} type={uploadableProjectFileTypes.other.dataCenterComponentManufacturer} />
        <ModelAction
