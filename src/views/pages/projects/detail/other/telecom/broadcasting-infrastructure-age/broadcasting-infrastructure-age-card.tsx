      ...
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {broadcastingInfrastructureAge?.antennas !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.broadcasting-infrastructure-age.details.antennas')}: {broadcastingInfrastructureAge.antennas}{' '}
                {t('common.years')}
              </Typography>
            </Grid>
          )}
          ...
          {broadcastingInfrastructureAge?.transmitters !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.broadcasting-infrastructure-age.details.transmitters')}: {broadcastingInfrastructureAge.transmitters}{' '}
                {t('common.years')}
              </Typography>
            </Grid>
          )}
          ...
          {broadcastingInfrastructureAge?.towers !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.broadcasting-infrastructure-age.details.towers')}: {broadcastingInfrastructureAge.towers}{' '}
                {t('common.years')}
              </Typography>
            </Grid>
          )}
          ...
          {broadcastingInfrastructureAge?.cables !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.broadcasting-infrastructure-age.details.cables')}: {broadcastingInfrastructureAge.cables}{' '}
                {t('common.years')}
              </Typography>
            </Grid>
          )}
