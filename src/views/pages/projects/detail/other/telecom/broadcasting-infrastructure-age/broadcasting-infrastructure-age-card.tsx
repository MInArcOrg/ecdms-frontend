...
interface BroadcastingInfrastructureAgeCardProps {
  ...
  refetch: () => void
  onEdit: (broadcastingInfrastructureAge: BroadcastingInfrastructureAge) => void
  onDelete: (id: string) => void
  onDetail: (broadcastingInfrastructureAge: BroadcastingInfrastructureAge) => void
  broadcastingInfrastructureMap: Map<string, string>
}

const BroadcastingInfrastructureAgeCard: React.FC<BroadcastingInfrastructureAgeCardProps> = ({
      ...
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {broadcastingInfrastructureAge?.antennas !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.broadcasting-infrastructure-age.details.antennas")}: {broadcastingInfrastructureAge.antennas} {t("common.years")}
              </Typography>
            </Grid>
          )}
          ...
          {broadcastingInfrastructureAge?.transmitters !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.broadcasting-infrastructure-age.details.transmitters")}: {broadcastingInfrastructureAge.transmitters} {t("common.years")}
              </Typography>
            </Grid>
          )}
          ...
          {broadcastingInfrastructureAge?.towers !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.broadcasting-infrastructure-age.details.towers")}: {broadcastingInfrastructureAge.towers} {t("common.years")}
              </Typography>
            </Grid>
          )}
          ...
          {broadcastingInfrastructureAge?.cables !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.broadcasting-infrastructure-age.details.cables")}: {broadcastingInfrastructureAge.cables} {t("common.years")}
              </Typography>
            </Grid>
          )}
        </Grid>
        ...
        {broadcastingInfrastructureAge?.others && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.broadcasting-infrastructure-age.details.others")}: {broadcastingInfrastructureAge.others}
            </Typography>
          </Box>
        )}
        ...
        {broadcastingInfrastructureAge?.created_at && (
          <Typography variant="body2" color="text.secondary" mt={2}>
            {t("common.table-columns.created-at")}: {formatCreatedAt(broadcastingInfrastructureAge.created_at)}
          </Typography>
        )}
      </CardContent>

      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer id={broadcastingInfrastructureAge.id} type={uploadableProjectFileTypes.other.broadcastingInfrastructureAge} />
