    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.telecom-infrastructure.details.name")}:{" "}
            {telecomInfrastructure?.name || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.telecom-infrastructure.details.specifications")}:{" "}
            {telecomInfrastructure?.specifications || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.telecom-infrastructure.details.coverage-area")}:{" "}
            {telecomInfrastructure?.coverage_area
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {telecomInfrastructure?.no_of_families_coverage !== undefined
              ? telecomInfrastructure?.no_of_families_coverage
              : "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            {telecomInfrastructure?.created_at
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.telecomInfrastructure}
        />
        <ModelAction
