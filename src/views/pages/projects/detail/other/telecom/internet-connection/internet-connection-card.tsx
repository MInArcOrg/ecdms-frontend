    ...
    <Card sx={{ p: 2 }}>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              ...
              ) || internetConnection?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.internet-connection.details.routers")}:{" "}
              {renderStatusChip(internetConnection?.routers)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.internet-connection.details.switches")}:{" "}
              {renderStatusChip(internetConnection?.switches)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.internet-connection.details.modems")}:{" "}
              {renderStatusChip(internetConnection?.modems)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.internet-connection.details.cables")}:{" "}
              {renderStatusChip(internetConnection?.cables)}
            </Typography>
          </Grid>
        </Grid>
        ...
        {internetConnection?.others && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.internet-connection.details.others")}:{" "}
              {internetConnection.others}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.internetConnection}
        />
