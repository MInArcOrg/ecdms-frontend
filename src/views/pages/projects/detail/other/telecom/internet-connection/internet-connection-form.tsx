...
const InternetConnectionForm: React.FC<InternetConnectionFormProps> = ({ formik, file, onFileChange }) => {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomSelect
          fullWidth
          label={transl('project.other.internet-connection.details.internet-connection-type')}
          placeholder={transl('project.other.internet-connection.details.internet-connection-type')}
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <FormControlLabel
              ...
              label={transl('project.other.internet-connection.details.routers')}
            />
          </Grid>
          <Grid item xs={6}>
            <FormControlLabel
              ...
              label={transl('project.other.internet-connection.details.switches')}
            />
          </Grid>
        </Grid>
        ...
        <CustomTextBox
          ...
          placeholder={transl('project.other.internet-connection.details.others')}
          name="others"
          size="small"
          multiline
          rows={3}
