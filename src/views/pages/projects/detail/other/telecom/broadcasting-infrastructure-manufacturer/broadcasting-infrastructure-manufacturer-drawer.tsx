...
const BroadcastingInfrastructureManufacturerDrawer = (
  props: BroadcastingInfrastructureManufacturerDrawerType,
) => {
  const {
    open,
    toggle,
  ...
  const createBroadcastingInfrastructureManufacturer = async (
    body: IApiPayload<BroadcastingInfrastructureManufacturer>,
  ) =>
    projectOtherApiSecondService<BroadcastingInfrastructureManufacturer>().create(
      otherSubMenu?.apiRoute || "",
      body,
    );

  const editBroadcastingInfrastructureManufacturer = async (
    body: IApiPayload<BroadcastingInfrastructureManufacturer>,
  ) =>
  ...
  return (
    <CustomSideDrawer
      title={`project.other.broadcasting-infrastructure-manufacturer.${
        isEdit
          ? `edit-broadcasting-infrastructure-manufacturer`
          : `create-broadcasting-infrastructure-manufacturer`
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit
              ? editBroadcastingInfrastructureManufacturer
              : createBroadcastingInfrastructureManufacturer
          }
