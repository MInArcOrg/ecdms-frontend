...
export const broadcastingInfrastructureManufacturerColumns = (
  ...
  },
  {
    ...
    minWidth: 120,
    headerName: t(
      'project.other.broadcasting-infrastructure-manufacturer.details.transmitters"),cturer.details.transmitters',
    ),
    field: "transmitters",
    renderCell: ({ row }: CellType) => (
  ...
  },
  {
    ...
    field: "towers",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>{row?.towers || t("common.not-available")}</Typography>
    ),
  },
  {
    flex: 0.15,
