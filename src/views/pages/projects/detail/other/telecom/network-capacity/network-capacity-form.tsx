...
const NetworkCapacityForm: React.FC<NetworkCapacityFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomSelect
          ...
          placeholder={transl(
            "project.other.network-capacity.details.network-type",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.network-capacity.details.total-bandwidth",
          )}
          placeholder={transl(
            "project.other.network-capacity.details.total-bandwidth",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.network-capacity.details.users-number",
          )}
          name="users_number"
          type="number"
          size="small"
