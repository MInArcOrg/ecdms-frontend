...
const MobileNetworkComponentAgeCard: React.FC<MobileNetworkComponentAgeCardProps> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.mobile-network-component-age.details.towers')}: {mobileNetworkComponentAge?.towers?.toString() || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.mobile-network-component-age.details.switches')}: {mobileNetworkComponentAge?.switches?.toString() || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.mobile-network-component-age.details.others')}: {mobileNetworkComponentAge?.others || 'N/A'}
          </Typography>
        </Box>
      </CardContent>

      <CardActions sx={{ justifyContent: 'flex-end' }}>
        <FileDrawer id={mobileNetworkComponentAge.id} type={uploadableProjectFileTypes.other.mobileNetworkComponentAge} />
        <ModelAction
