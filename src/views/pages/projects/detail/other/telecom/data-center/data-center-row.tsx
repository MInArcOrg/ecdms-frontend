...
export const dataCenterColumns = (
  ...
  },
  {
    ...
    field: 'servers',
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.servers ? t('common.yes') : t('common.no')}</Typography>
    )
  },
  {
    flex: 0.15,
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.storage_devices ? t('common.yes') : t('common.no')}</Typography>
    )
  },
  {
    flex: 0.15,
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.networking_equipment ? t('common.yes') : t('common.no')}</Typography>
    )
  },
  {
    flex: 0.15,
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.cooling_systems ? t('common.yes') : t('common.no')}</Typography>
    )
  },
  {
    flex: 0.15,
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.backup_generators ? t('common.yes') : t('common.no')}</Typography>
    )
  },
  {
    flex: 0.15,
