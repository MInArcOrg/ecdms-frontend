...
const DataCenterFacilityCapacityCard: React.FC<
  DataCenterFacilityCapacityCardProps
> = ({ dataCenterFacilityCapacity, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            : {dataCenterFacilityCapacity?.data_center_id || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            : {dataCenterFacilityCapacity?.power_capacity || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {dataCenterFacilityCapacity?.access_control
              ? t("common.yes")
              : t("common.no")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {dataCenterFacilityCapacity?.surveillance_cameras
              ? t("common.yes")
              : t("common.no")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {dataCenterFacilityCapacity?.fire_suppression_systems
              ? t("common.yes")
              : t("common.no")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {dataCenterFacilityCapacity?.intrusion_detection_systems
              ? t("common.yes")
              : t("common.no")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.data-center-facility-capacity.details.others")}:{" "}
            {dataCenterFacilityCapacity?.others || "N/A"}
          </Typography>
        </Box>
      </CardContent>
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.dataCenterFacilityCapacity}
        />
        <ModelAction
