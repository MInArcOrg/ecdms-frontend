...
const InternetConnectionInfrastructureAgeDrawer = (
  props: InternetConnectionInfrastructureAgeDrawerType,
) => {
  const {
    open,
    toggle,
  ...
  const createInternetConnectionInfrastructureAge = async (
    body: IApiPayload<InternetConnectionInfrastructureAge>,
  ) =>
    projectOtherApiSecondService<InternetConnectionInfrastructureAge>().create(
      otherSubMenu?.apiRoute || "",
      body,
    );

  const editInternetConnectionInfrastructureAge = async (
    body: IApiPayload<InternetConnectionInfrastructureAge>,
  ) =>
  ...
  return (
    <CustomSideDrawer
      title={`project.other.internet-connection-infrastructure-age.${
        isEdit
          ? `edit-internet-connection-infrastructure-age`
          : `create-internet-connection-infrastructure-age`
      }`}
        ...
        <FormPageWrapper
          ...
          initialValues={{
            ...
            internet_connection_id:
              internetConnectionInfrastructureAge?.internet_connection_id || "",
          ...
          createActionFunc={
            isEdit
              ? editInternetConnectionInfrastructureAge
              : createInternetConnectionInfrastructureAge
          }
