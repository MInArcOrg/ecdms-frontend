    ...
    <Card sx={{ p: 2 }}>
        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.satellite-network.details.satellite")}:{" "}
              {renderStatusChip(satelliteNetwork?.satellite)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.satellite-network.details.modems")}:{" "}
              {renderStatusChip(satelliteNetwork?.modems)}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography
              ...
              gap={1}
            >
              {t("project.other.satellite-network.details.routers")}:{" "}
              {renderStatusChip(satelliteNetwork?.routers)}
            </Typography>
          </Grid>
        </Grid>
        ...
        {satelliteNetwork?.others && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.satellite-network.details.others")}:{" "}
              {satelliteNetwork.others}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.satelliteNetwork}
        />
