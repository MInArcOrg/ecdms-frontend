...
const InternetConnectionInfrastructureManufacturerCard: React.FC<
  InternetConnectionInfrastructureManufacturerCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            <Typography
              ...
              component={Button}
              onClick={() =>
                onDetail(internetConnectionInfrastructureManufacturer)
              }
              sx={{
                fontWeight: 500,
                textDecoration: "none",
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        ...
        <RowOptions
          ...
          onDelete={() =>
            onDelete(internetConnectionInfrastructureManufacturer.id)
          }
