...
const NetworkCoverageForm: React.FC<NetworkCoverageFormProps> = ({
  projectId,
  file,
  onFileChange,
}) => {
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          <Grid item xs={12} sm={6}>
            <CustomTextBox
              fullWidth
              label={transl(
                "project.other.network-coverage.details.total-coverage-area",
              )}
              placeholder={transl(
                "project.other.network-coverage.details.total-coverage-area",
              )}
          ...
          <Grid item xs={12} sm={6}>
            <CustomTextBox
              fullWidth
              label={transl(
                "project.other.network-coverage.details.active-users-number",
              )}
              placeholder={transl(
                "project.other.network-coverage.details.active-users-number",
              )}
          ...
          <Grid item xs={12} sm={6}>
            <CustomTextBox
              fullWidth
              label={transl(
                "project.other.network-coverage.details.signal-strength",
              )}
              placeholder={transl(
                "project.other.network-coverage.details.signal-strength",
              )}
