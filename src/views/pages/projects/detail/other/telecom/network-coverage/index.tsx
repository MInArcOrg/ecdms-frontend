...
const NetworkCoverageList: React.FC<NetworkCoverageListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const fetchNetworkCoverages = (
    params: GetRequestParam,
  ): Promise<IApiResponse<NetworkCoverage[]>> => {
    return projectOtherApiSecondService<NetworkCoverage>().getAll(
  ...
  const handleDelete = async (networkCoverageId: string) => {
    await projectOtherApiSecondService<NetworkCoverage>().delete(
      otherSubMenu?.apiRoute || "",
      networkCoverageId,
    );
    refetch();
  ...
  const mapNetworkCoverageToDetailItems = (
    ...
    },
    {
      ...
      value: networkCoverage?.created_at
        ? formatCreatedAt(networkCoverage.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: networkCoverage?.updated_at
        ? formatCreatedAt(networkCoverage.updated_at)
        : "N/A",
    },
  ];
