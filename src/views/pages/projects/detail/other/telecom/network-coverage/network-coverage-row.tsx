...
export const networkCoverageColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.networkinfrastructuretype?.id || t("common.not-available")}
      </Typography>
    ),
  },
  {
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.coverage_population_number?.toString() ||
  ...
  },
  {
    ...
    minWidth: 120,
    headerName: t(
      "project.other.network-coverage.details.average-download-speed",
    ),
    field: "average_download_speed",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.average_download_speed?.toString() || t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    minWidth: 120,
    headerName: t(
      "project.other.network-coverage.details.average-upload-speed",
    ),
    field: "average_upload_speed",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.average_upload_speed?.toString() || t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.signal_strength?.toString() || t("common.not-available")}
      </Typography>
    ),
  },
  {
