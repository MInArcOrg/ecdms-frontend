...
const BridgeSuperStructureDrawer = (props: BridgeSuperStructureDrawerType) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    span_number: yup.number().integer('Span number must be an integer').nullable(),
    ...
    lane_number: yup.number().integer('Lane number must be an integer').nullable(),
    ...
    girder_number: yup.number().integer('Girder number must be an integer').nullable(),
