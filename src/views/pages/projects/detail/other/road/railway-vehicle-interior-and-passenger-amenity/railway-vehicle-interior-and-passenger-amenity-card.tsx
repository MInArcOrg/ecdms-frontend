...
const RailwayVehicleInteriorAndPassengerAmenityCard: React.FC<
  RailwayVehicleInteriorAndPassengerAmenityCardProps
> = ({
    ...
    return (
      <Card sx={{ p: 2 }}>
          ...
          >
            <Typography variant="h6" fontWeight="bold">
              <Typography
                ...
                component={Button}
                onClick={() =>
                  onDetail(railwayVehicleInteriorAndPassengerAmenity)
                }
                sx={{
                  fontWeight: 500,
                  textDecoration: "none",
          ...
          <Box display="flex" flexDirection="column" gap={1} mt={2}>
            <Typography variant="body2" color="text.secondary">
              ...
              {railwayVehicleInteriorAndPassengerAmenity?.railwayVehicleIndentification ?
                railwayVehicleInteriorAndPassengerAmenity?.railwayVehicleIndentification + " - " + railwayVehicleInteriorAndPassengerAmenity?.railwayVehicleIndentification.manufacturer_supplier_name + " - " + railwayVehicleInteriorAndPassengerAmenity?.railwayVehicleIndentification.manufacture_year

                : railwayVehicleInteriorAndPassengerAmenity?.railway_vehicle_identification_id ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleInteriorAndPassengerAmenity.seating_capacity ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleInteriorAndPassengerAmenity.passenger_amenities_availability ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
        ...
        <CardActions sx={{ justifyContent: "flex-end" }}>
          {railwayVehicleInteriorAndPassengerAmenity.id && (
            <FileDrawer
              id={railwayVehicleInteriorAndPassengerAmenity.id}
