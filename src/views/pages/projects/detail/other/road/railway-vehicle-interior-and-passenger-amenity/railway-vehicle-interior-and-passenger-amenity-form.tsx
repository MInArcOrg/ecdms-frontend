...
const RailwayVehicleInteriorAndPassengerAmenityForm: React.FC<
  RailwayVehicleInteriorAndPassengerAmenityFormProps
> = ({ formik, defaultFile, onDefaultFileChange }) => {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12}>
        <CustomFileUpload
          label={t("common.form.interior-amenity-document-upload")}
          file={defaultFile}
