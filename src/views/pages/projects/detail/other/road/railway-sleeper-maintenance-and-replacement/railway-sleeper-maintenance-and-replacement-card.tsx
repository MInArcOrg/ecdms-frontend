...
const RailwaySleeperMaintenanceAndReplacementCard: React.FC<
  RailwaySleeperMaintenanceAndReplacementCardProps
> = ({
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwaySleeperMaintenanceAndReplacement.inspection_reports ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
