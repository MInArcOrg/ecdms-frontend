    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.road-drainage.details.dimensions')}:{roadDrainage?.length ? `L: ${roadDrainage.length}` : ''}
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.road-drainage.details.construction-completion-year')}: {roadDrainage?.construction_completion_year || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
      ...
      <CardActions sx={{ justifyContent: 'flex-end' }}>
        <FileDrawer id={roadDrainage.id} type={uploadableProjectFileTypes.other.roadDrainage} />
        <ModelAction
          model="RoadDrainage"
