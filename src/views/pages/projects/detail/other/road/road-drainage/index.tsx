...
const RoadDrainageList: React.FC<RoadDrainageListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const fetchRoadDrainages = (
    params: GetRequestParam,
  ): Promise<IApiResponse<RoadDrainage[]>> => {
    return projectOtherApiSecondService<RoadDrainage>().getAll(
  ...
  const handleDelete = async (roadDrainageId: string) => {
    await projectOtherApiSecondService<RoadDrainage>().delete(
      otherSubMenu?.apiRoute || "",
      roadDrainageId,
    );
    refetch();
  ...
  const mapRoadDrainageToDetailItems = (
    ...
    },
    {
      ...
      value: roadDrainage?.created_at
        ? formatCreatedAt(roadDrainage.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: roadDrainage?.updated_at
        ? formatCreatedAt(roadDrainage.updated_at)
        : "N/A",
    },
  ];
