...
export const railwaySubBallastConditionAssessmentColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.sub_ballast_condition_rating || 'N/A'}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.cracking_observations || 'N/A'}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.erosion_issues || 'N/A'}</Typography>
  },
  {
    flex: 0.2,
    minWidth: 200,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.unwanted_vegetation_presence || 'N/A'}</Typography>
  },
  {
    flex: 0.1,
    minWidth: 100,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.testing_frequency_per_year ?? 'N/A'}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.sub_ballast_resistance || 'N/A'}</Typography>
  },
  {
    flex: 0.2,
    minWidth: 200,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.sub_ballast_degradation_rate || 'N/A'}</Typography>
  },
  {
    flex: 0.2,
    minWidth: 200,
