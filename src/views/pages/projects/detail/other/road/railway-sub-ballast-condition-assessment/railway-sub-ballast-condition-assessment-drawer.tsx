...
const RailwaySubBallastConditionAssessmentDrawer = ({
  ...
  return (
    <CustomSideDrawer
      title={`project.other.railway-sub-ballast-condition-assessment.${
        isEdit ? "edit" : "create"
      }`}
      ...
      {() => (
        <FormPageWrapper
          ...
          initialValues={{
            ...railwaySubBallastConditionAssessment,
            project_id:
              railwaySubBallastConditionAssessment?.project_id || projectId,
          }}
          createActionFunc={
            isEdit
              ? editRailwaySubBallastConditionAssessment
              : createRailwaySubBallastConditionAssessment
          }
