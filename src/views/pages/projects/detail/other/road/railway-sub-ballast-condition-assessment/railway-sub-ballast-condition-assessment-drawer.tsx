...
const RailwaySubBallastConditionAssessmentDrawer = ({
  ...
  const createRailwaySubBallastConditionAssessment = async (body: IApiPayload<RailwaySubBallastConditionAssessment>) =>
    projectOtherApiSecondService<RailwaySubBallastConditionAssessment>().create(otherSubMenu?.apiRoute || '', body);

  const editRailwaySubBallastConditionAssessment = async (body: IApiPayload<RailwaySubBallastConditionAssessment>) =>
  ...
  const getPayload = (values: RailwaySubBallastConditionAssessment): IApiPayload<RailwaySubBallastConditionAssessment> => ({
    data: {
      ...values,
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={isEdit ? editRailwaySubBallastConditionAssessment : createRailwaySubBallastConditionAssessment}
          onActionSuccess={onActionSuccess}
          onCancel={handleClose}
        >
          {(formik: FormikProps<RailwaySubBallastConditionAssessment>) => <RailwaySubBallastConditionAssessmentForm formik={formik} />}
        </FormPageWrapper>
      )}
    </CustomSideDrawer>
  );
