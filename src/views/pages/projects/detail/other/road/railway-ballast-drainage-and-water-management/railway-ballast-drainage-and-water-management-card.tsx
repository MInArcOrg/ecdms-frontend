...
const RailwayBallastDrainageAndWaterManagementCard: React.FC<RailwayBallastDrainageAndWaterManagementCardProps> = ({
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-drainage-and-water-management.details.railway-line-section-name')}:{' '}
            {railway_line_section_name || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-drainage-and-water-management.details.drainage-condition-assessment')}:{' '}
            {drainage_condition_assessment || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-drainage-and-water-management.details.drainage-infrastructure-type')}:{' '}
            {drainage_infrastructure_type || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-drainage-and-water-management.details.water-management-measures')}:{' '}
            {water_management_measures || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-drainage-and-water-management.details.drainage-infrastructure-length')}:{' '}
            {drainage_infrastructure_length?.toLocaleString() ?? 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-drainage-and-water-management.details.remark')}: {remark ?? 'N/A'}
          </Typography>
