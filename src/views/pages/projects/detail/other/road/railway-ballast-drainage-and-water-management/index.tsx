...
const RailwayBallastDrainageAndWaterManagementList: React.FC<
  RailwayBallastDrainageAndWaterManagementListProps
> = ({
  // Renamed component
  otherSubMenu,
  projectId,
  ...
  const [selectedRow, setSelectedRow] =
    useState<RailwayBallastDrainageAndWaterManagement | null>(null); // Updated type
  const { t } = useTranslation();

  const fetchData = (
    params: GetRequestParam,
  ): Promise<IApiResponse<RailwayBallastDrainageAndWaterManagement[]>> => {
    // Updated type
    return projectOtherApiSecondService<RailwayBallastDrainageAndWaterManagement>().getAll(
  ...
  const { data, isLoading, pagination, handlePageChange, refetch } =
    usePaginatedFetch<RailwayBallastDrainageAndWaterManagement[]>({
      // Updated type
  ...
  const handleDelete = async (id: string) => {
    await projectOtherApiSecondService<RailwayBallastDrainageAndWaterManagement>().delete(
      otherSubMenu?.apiRoute || "",
      id,
    ); // Updated type
    refetch();
    ...
    <Box>
      {showDrawer && (
        <RailwayBallastDrainageAndWaterManagementDrawer // Updated component name
          ...
          railwayBallastDrainageAndWaterManagement={
            selectedRow as RailwayBallastDrainageAndWaterManagement
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          fileType=""
          title={t(
            "project.other.railway-ballast-drainage-and-water-management.detail",
          )} // Updated translation key
        />
      )}
      ...
      <ItemsListing
        title={t(
          "project.other.railway-ballast-drainage-and-water-management.title",
        )} // Updated translation key
        pagination={pagination}
        type={ITEMS_LISTING_TYPE.table.value}
        tableProps={{
          headers: railwayBallastDrainageAndWaterManagementColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
