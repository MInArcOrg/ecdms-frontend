...
const RailwayBallastDrainageAndWaterManagementDrawer = ({ // Renamed component
  open,
  toggle,
  refetch,
  ...
  const createRailwayBallastDrainageAndWaterManagement = async ( // Renamed function
    body: IApiPayload<RailwayBallastDrainageAndWaterManagement>
  ) =>
    projectOtherApiSecondService<RailwayBallastDrainageAndWaterManagement>().create( // Updated type
      otherSubMenu?.apiRoute || '',
      body
    );

  const editRailwayBallastDrainageAndWaterManagement = async ( // Renamed function
    body: IApiPayload<RailwayBallastDrainageAndWaterManagement>
  ) =>
    projectOtherApiSecondService<RailwayBallastDrainageAndWaterManagement>().update( // Updated type
      otherSubMenu?.apiRoute || '',
  ...
  ): IApiPayload<RailwayBallastDrainageAndWaterManagement> => ({ // Updated type
    data: {
      ...values,
