...
const RailwayBallastDrainageAndWaterManagementDrawer = ({
  ...
  const validationSchema = yup.object().shape({
    ...
    drainage_condition_assessment: yup
      .string()
      .required("Drainage condition assessment is required"),
    drainage_infrastructure_type: yup
      .string()
      .required("Drainage infrastructure type is required"),
  ...
  return (
    <CustomSideDrawer
      title={`project.other.railway-ballast-drainage-and-water-management.${
        isEdit ? "edit" : "create"
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit
              ? editRailwayBallastDrainageAndWaterManagement
              : createRailwayBallastDrainageAndWaterManagement // Updated function names
          }
