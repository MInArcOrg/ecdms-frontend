...
const RoadLayerList: React.FC<RoadLayerListProps> = ({
  model,
  projectId,
  typeId,
}) => {
  ...
  const mapRoadLayerToDetailItems = (
    ...
    {
      title: t("project.other.road-layer.details.segment"),
      value: roadLayer?.roadsegment?.name || "N/A",
    },
    {
      title: t("project.other.road-layer.details.specifications"),
      value: roadLayer.specifications || "N/A",
    },
    {
      title: t("project.other.road-layer.details.number"),
      value: roadLayer.number?.toString() || "N/A",
    },
    {
      title: t("project.other.road-layer.details.thickness"),
      value: roadLayer.thickness?.toString() || "N/A",
    },
    {
      title: t("project.other.road-layer.details.material"),
      value: roadLayer.material || "N/A",
    },
    {
      title: t("project.other.road-layer.details.description"),
      value: roadLayer.description || "N/A",
    },
    {
      title: t("common.table-columns.created-at"),
      value: roadLayer.created_at
        ? formatCreatedAt(roadLayer.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: roadLayer.updated_at
        ? formatCreatedAt(roadLayer.updated_at)
        : "N/A",
    },
  ];
