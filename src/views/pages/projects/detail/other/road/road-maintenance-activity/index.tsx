...
const RoadMaintenanceActivityList: React.FC<RoadMaintenanceActivityListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const mapRoadMaintenanceActivityToDetailItems = (
    ...
    },
    {
      ...
      value: roadMaintenanceActivity?.maintenance_frequency_id
        ? maintenanceFrequencyMap.get(roadMaintenanceActivity.maintenance_frequency_id) ||
