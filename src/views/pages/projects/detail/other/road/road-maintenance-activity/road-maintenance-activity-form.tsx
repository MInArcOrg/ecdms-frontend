...
const RoadMaintenanceActivityForm: React.FC<
  RoadMaintenanceActivityFormProps
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.road-maintenance-activity.details.road-segment",
          )}
          placeholder={transl(
            "project.other.road-maintenance-activity.details.road-segment",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.road-maintenance-activity.details.consultant",
          )}
          placeholder={transl(
            "project.other.road-maintenance-activity.details.consultant",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.road-maintenance-activity.details.remark",
          )}
          placeholder={transl(
            "project.other.road-maintenance-activity.details.remark",
          )}
