...
import type { RailwayStationPlatformFacility, RailwayStationPlatformLayout, RailwayVehicleIdentification } from "src/types/project/other";
...
const RailwayStationPlatformFacilityForm: React.FC<
    RailwayStationPlatformFacilityFormProps
