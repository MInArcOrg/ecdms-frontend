...
const CulvertStructuralInformationCard: React.FC<
  CulvertStructuralInformationCardProps
> = ({ culvertStructuralInformation, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t(
              "project.other.culvert-structural-information.details.culvert-type-id",
            )}
