...
const CulvertStructuralInformationList: React.FC<
  CulvertStructuralInformationListProps
> = ({ otherSubMenu, projectId, typeId }) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] =
    useState<CulvertStructuralInformation | null>(null);
  const { t } = useTranslation();

  const fetchCulvertStructuralInformation = (
    params: GetRequestParam,
  ): Promise<IApiResponse<CulvertStructuralInformation[]>> => {
    return projectOtherApiSecondService<CulvertStructuralInformation>().getAll(
  ...
  const mapCulvertStructuralInformationToDetailItems = (
    ...
    },
    {
      ...
      value:
        culvertStructuralInformation?.culvert_barrel_length?.toString() ||
        "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value:
        culvertStructuralInformation?.total_culvert_width?.toString() || "N/A",
    },
    {
      title: t(
      ...
      value:
        culvertStructuralInformation?.distance_between_barrels?.toString() ||
        "N/A",
    },
    {
      title: t(
      ...
      value:
        culvertStructuralInformation?.head_wall_length?.toString() || "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value:
        culvertStructuralInformation?.abutment_average_height?.toString() ||
        "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value:
        culvertStructuralInformation?.wingwall_average_length?.toString() ||
        "N/A",
    },
    {
      title: t(
    ...
    <Box>
      {showDrawer && (
        <CulvertStructuralInformationDrawer
          ...
          culvertStructuralInformation={
            selectedRow as CulvertStructuralInformation
          }
          refetch={refetch}
          projectId={projectId}
        />
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapCulvertStructuralInformationToDetailItems(
            selectedRow as CulvertStructuralInformation,
          )}
          hasReference={false}
          id={selectedRow?.id || ""}
          title={t(
            "project.other.culvert-structural-information.culvert-structural-information-details",
          )}
          fileType=""
        />
      )}
