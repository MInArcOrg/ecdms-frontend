...
const RailwayStationPlatformStructuralElementForm: React.FC<
  RailwayStationPlatformStructuralElementFormProps
> = ({
  formik,
  defaultFile,
  onDefaultFileChange,
    ...
    return (
      <Grid container spacing={gridSpacing}>
        ...
        <Grid item xs={12}>
          ...
          <CustomFileUpload
            label={t(
              "project.other.railway-station-platform-structural-element.details.canopy-or-shelter-detail-upload",
            )}
