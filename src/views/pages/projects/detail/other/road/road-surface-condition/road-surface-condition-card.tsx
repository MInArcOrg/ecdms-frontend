    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.road-surface-condition.details.road-segment")}:{" "}
            {roadSurfaceCondition?.road_segment || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.road-surface-condition.details.cracks")}:{" "}
            {roadSurfaceCondition?.cracks ? t("common.yes") : t("common.no")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.road-surface-condition.details.rutting")}:{" "}
            {roadSurfaceCondition?.rutting ? t("common.yes") : t("common.no")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.road-surface-condition.details.surface-type")}:{" "}
            {roadSurfaceCondition?.surface_type_id || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            {t("project.other.road-surface-condition.details.remark")}:{" "}
            {roadSurfaceCondition?.remark || "N/A"}
          </Typography>
        </Box>
      </CardContent>
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.roadSurfaceCondition}
        />
        <ModelAction
