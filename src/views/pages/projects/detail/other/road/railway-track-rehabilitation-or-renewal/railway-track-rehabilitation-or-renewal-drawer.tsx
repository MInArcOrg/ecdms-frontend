...
const RailwayTrackRehabilitationOrRenewalDrawer = (props: RailwayTrackRehabilitationOrRenewalDrawerType) => {
  ...
  const createRailwayTrackRehabilitationOrRenewal = async (body: IApiPayload<RailwayTrackRehabilitationOrRenewal>) =>
  ...
  return (
    <CustomSideDrawer
      title={`project.other.railway-track-rehabilitation-or-renewal.${isEdit ? `edit` : `create`}`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={isEdit ? editRailwayTrackRehabilitationOrRenewal : createRailwayTrackRehabilitationOrRenewal}
