...
const BridgeStructureInformationCard: React.FC<
  BridgeStructureInformationCardProps
> = ({ bridgeStructureInformation, refetch, onEdit, onDelete, onDetail }) => {
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-structure-information.details.name")}:{" "}
            {bridgeStructureInformation?.name || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
