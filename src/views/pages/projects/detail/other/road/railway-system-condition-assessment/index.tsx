...
const RailwaySystemConditionAssessmentList: React.FC<
  RailwaySystemConditionAssessmentListProps
> = ({ otherSubMenu, projectId }) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] =
    useState<RailwaySystemConditionAssessment | null>(null);
  ...
  const mapRailwaySystemConditionAssessmentToDetailItems = (
    ...
    },
    {
      ...
      value:
        systemConditionAssessment?.system_condition_rating_or_assessment ||
        "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value:
        systemConditionAssessment?.power_supply_systems_and_communication ||
        "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value: systemConditionAssessment?.created_at
        ? formatCreatedAt(systemConditionAssessment.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: systemConditionAssessment?.updated_at
        ? formatCreatedAt(systemConditionAssessment.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      {showDrawer && (
        <RailwaySystemConditionAssessmentDrawer
          ...
          railwaySystemConditionAssessment={
            selectedRow as RailwaySystemConditionAssessment
          }
          refetch={refetch}
          projectId={projectId}
        />
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapRailwaySystemConditionAssessmentToDetailItems(
            selectedRow as RailwaySystemConditionAssessment,
          )}
          hasReference={true}
          id={selectedRow?.id || ""}
      ...
      <ItemsListing
        ...
        ItemViewComponent={({ data }) => (
          <RailwaySystemConditionAssessmentCard
            ...
            railwaySystemConditionAssessment={
              data as RailwaySystemConditionAssessment
            }
            onEdit={handleEdit}
            refetch={refetch}
            otherSubMenu={otherSubMenu}
