      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-system-condition-assessment.details.railway_line_section_name')}:{' '}
            {railwaySystemConditionAssessment.railway_line_section_name || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-system-condition-assessment.details.system_condition_rating_or_assessment')}:{' '}
            {railwaySystemConditionAssessment.system_condition_rating_or_assessment || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-system-condition-assessment.details.defect_presence')}:{' '}
            {railwaySystemConditionAssessment.defect_presence ? 'Yes' : 'No'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-system-condition-assessment.details.system_performance_indicators')}:{' '}
            {railwaySystemConditionAssessment.system_performance_indicators || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-system-condition-assessment.details.power_supply_systems_and_communication')}:{' '}
            {railwaySystemConditionAssessment.power_supply_systems_and_communication || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-system-condition-assessment.details.remark')}: {railwaySystemConditionAssessment.remark || 'N/A'}
          </Typography>
          {railwaySystemConditionAssessment.created_at && (
            <Typography variant="body2" color="text.secondary">
              {t('common.table-columns.created-at')}: {railwaySystemConditionAssessment.created_at}
            </Typography>
          )}
          {railwaySystemConditionAssessment.updated_at && (
            <Typography variant="body2" color="text.secondary">
              {t('common.table-columns.updated-at')}: {railwaySystemConditionAssessment.updated_at}
            </Typography>
          )}
        </Box>
      </CardContent>
      <CardActions sx={{ justifyContent: 'flex-end' }}>
        {railwaySystemConditionAssessment.id && <FileDrawer id={railwaySystemConditionAssessment.id} type={otherSubMenu?.id || ''} />}
