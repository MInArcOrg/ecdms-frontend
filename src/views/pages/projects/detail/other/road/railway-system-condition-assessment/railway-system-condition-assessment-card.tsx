...
const RailwaySystemConditionAssessmentCard: React.FC<
  RailwaySystemConditionAssessmentCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwaySystemConditionAssessment.railway_line_section_name ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwaySystemConditionAssessment.system_condition_rating_or_assessment ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwaySystemConditionAssessment.system_performance_indicators ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwaySystemConditionAssessment.power_supply_systems_and_communication ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        ...
        <RowOptions
          ...
          onDelete={() =>
            onDelete(railwaySystemConditionAssessment.id as string)
          }
