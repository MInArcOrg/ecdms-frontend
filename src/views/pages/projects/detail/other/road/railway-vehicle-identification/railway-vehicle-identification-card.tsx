...
const RailwayVehicleIdentificationCard: React.FC<
  RailwayVehicleIdentificationCardProps
> = ({
    ...
    return (
      <Card sx={{ p: 2 }}>
        <CardContent>
          ...
          >
            <Typography variant="h6" fontWeight="bold">
              <Typography
                ...
                component={Button}
                onClick={() =>
                  onDetail(railwayVehicleIdentification)
                }
                sx={{
                  fontWeight: 500,
                  textDecoration: "none",
          ...
          <Box display="flex" flexDirection="column" gap={1} mt={2}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {railwayVehicleIdentification.vehicle_identification_number ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleIdentification.vehicle_type ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleIdentification.manufacturer_supplier_name ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleIdentification.manufacture_year ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleIdentification.ownership_or_leasing_details ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              : {railwayVehicleIdentification.remark || "N/A"}
            </Typography>
        ...
        <CardActions sx={{ justifyContent: "flex-end" }}>
          {railwayVehicleIdentification.id && (
            <FileDrawer
              id={railwayVehicleIdentification.id}
