...
const RailwayCommunicationSystemMaintenanceAndTestingDrawer = ({
  ...
  ) => projectOtherApiSecondService<RailwayCommunicationSystemMaintenanceAndTesting>().create(otherSubMenu?.apiRoute || '', body);

  const editRailwayCommunicationSystemMaintenanceAndTesting = async (body: IApiPayload<RailwayCommunicationSystemMaintenanceAndTesting>) =>
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit ? editRailwayCommunicationSystemMaintenanceAndTesting : createRailwayCommunicationSystemMaintenanceAndTesting
          }
