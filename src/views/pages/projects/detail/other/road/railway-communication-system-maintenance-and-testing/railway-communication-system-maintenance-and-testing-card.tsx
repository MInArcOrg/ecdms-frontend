...
const RailwayCommunicationSystemMaintenanceAndTestingCard: React.FC<
  RailwayCommunicationSystemMaintenanceAndTestingCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h6" fontWeight="bold">
            <Typography
              ...
              component={Button}
              onClick={() =>
                onDetail(railwayCommunicationSystemMaintenanceAndTesting)
              }
              sx={{
                fontWeight: 500,
                textDecoration: "none",
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayCommunicationSystemMaintenanceAndTesting.railway_line_section_name ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayCommunicationSystemMaintenanceAndTesting.scheduled_maintenance_activities ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayCommunicationSystemMaintenanceAndTesting.inspections
              ? "Yes"
              : "No"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayCommunicationSystemMaintenanceAndTesting.recent_maintenance_records_and_dates ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayCommunicationSystemMaintenanceAndTesting.testing_and_verification_procedures_prepared
              ? "Yes"
              : "No"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayCommunicationSystemMaintenanceAndTesting.maintenance_contracts_or_agreements_made ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            {(
              <FileDrawer
                id={railwayCommunicationSystemMaintenanceAndTesting.id}
