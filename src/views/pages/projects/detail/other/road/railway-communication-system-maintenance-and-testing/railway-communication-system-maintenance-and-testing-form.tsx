    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomSwitch
          ...
          label={t('project.other.railway-communication-system-maintenance-and-testing.details.testing_and_verification_procedures_prepared')}
          sx={{ mb: 2 }}
        />
      ...
      <Grid item xs={12}>
        <CustomFileUpload label={t('common.form.default-file-upload')} file={defaultFile} onFileChange={onDefaultFileChange} />
      </Grid>
      <Grid item xs={12}>
        <CustomFileUpload label={t('project.other.railway-communication-system-maintenance-and-testing.details.maintenance-contracts-file-upload')} file={maintenanceContractsFile} onFileChange={onMaintenanceContractsFileChange} />
      </Grid>
    </Grid>
  );
};
