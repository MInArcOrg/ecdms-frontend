...
const RailwayCommunicationSystemMaintenanceAndTestingForm: React.FC<
  RailwayCommunicationSystemMaintenanceAndTestingFormProps
> = ({
  formik,
  defaultFile,
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12}>
        <CustomFileUpload
          label={t("common.form.default-file-upload")}
          file={defaultFile}
