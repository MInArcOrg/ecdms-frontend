...
const RailwayBallastMaterialDataCard: React.FC<
  RailwayBallastMaterialDataCardProps
> = ({ railwayBallastMaterialData, refetch, onEdit, onDelete, onDetail }) => {
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayBallastMaterialData.particle_size_distribution_grading ??
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            : {railwayBallastMaterialData.ballast_source_id}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            {t("project.other.railway-ballast-material-data.details.remark")}:{" "}
            {railwayBallastMaterialData.remark ?? "N/A"}
          </Typography>
