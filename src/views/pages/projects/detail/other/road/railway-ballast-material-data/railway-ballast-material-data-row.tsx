...
export const railwayBallastMaterialDataColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.particle_size_distribution_grading || "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.ballast_used_quantity !== undefined &&
        row?.ballast_used_quantity !== null
          ? row.ballast_used_quantity.toLocaleString(undefined, {
  ...
  },
  {
    ...
    headerName: t(
      "project.other.railway-ballast-material-data.details.ballast-source",
    ),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.ballast_source_id || "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.ballast_material_size !== undefined &&
        row?.ballast_material_size !== null
          ? row.ballast_material_size.toLocaleString(undefined, {
              minimumFractionDigits: 2,
            })
          : "N/A"}
      </Typography>
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.ballast_layer_thickness !== undefined &&
        row?.ballast_layer_thickness !== null
          ? row.ballast_layer_thickness.toLocaleString(undefined, {
              minimumFractionDigits: 2,
            })
          : "N/A"}
      </Typography>
  ...
  },
  {
    ...
    headerName: t(
      "project.other.railway-ballast-material-data.details.compaction-method",
    ),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.compaction_method_id || "N/A"}
      </Typography>
    ),
  },
  {
