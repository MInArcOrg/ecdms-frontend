...
export const railwaySignalingSystemColumns = (
  ...
  otherSubMenu?: DetailSubMenuItemChild
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.signaling_system_manufacturer_or_supplier_name || 'N/A'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.signaling_system_manufacturer_or_supplier_phone || 'N/A'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.signaling_system_components || 'N/A'}
        </Typography>
      )
    },
    {
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <>
          {row.id && (
            <FileDrawer id={row.id} type={otherSubMenu?.id || ''} />
          )}
        </>
      )
    },
