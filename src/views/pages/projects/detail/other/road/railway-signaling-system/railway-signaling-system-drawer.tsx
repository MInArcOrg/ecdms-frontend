...
const RailwaySignalingSystemDrawer = ({
  ...
  const onActionSuccess = async (
    response: IApiResponse<RailwaySignalingSystem>,
  ) => {
    try {
  ...
  return (
    <CustomSideDrawer
      title={`project.other.railway-signaling-system.${
        isEdit ? "edit" : "create"
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit ? editRailwaySignalingSystem : createRailwaySignalingSystem
          }
