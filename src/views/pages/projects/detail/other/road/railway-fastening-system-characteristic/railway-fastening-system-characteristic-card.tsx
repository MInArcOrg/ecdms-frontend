...
const RailwayFasteningSystemCharacteristicCard: React.FC<
  RailwayFasteningSystemCharacteristicCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayFasteningSystemCharacteristic.railway_line_section_name ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemCharacteristic.used_fastening_system_type ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemCharacteristic.fastening_system_manufacturer_supplier ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemCharacteristic.fastening_system_specifications ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemCharacteristic.rail_clips_or_clamps_details ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemCharacteristic.bolts_and_nuts_specifications ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemCharacteristic.other_fastening_system ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        ...
        {railwayFasteningSystemCharacteristic.id && otherSubMenu?.fileType && (
          <FileDrawer
            id={railwayFasteningSystemCharacteristic.id}
        ...
        <RowOptions
          ...
          onDelete={() =>
            onDelete(railwayFasteningSystemCharacteristic.id as string)
          }
