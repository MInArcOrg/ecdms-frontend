...
const SafetyAndHealthForm: React.FC<SafetyAndHealthFormProps> = ({ formik, file, onFileChange }) => {
  ...
  const { data: ppeTypes } = useQuery({
    ...
    queryFn: () =>
      projectGeneralMasterDataApiService.getAll({
        filter: { model: projectMasterModels.personalProtectiveEquipmentType.model }
      })
  });
  ...
  const { data: ppeConditions } = useQuery({
    ...
    queryFn: () =>
      projectGeneralMasterDataApiService.getAll({
        filter: { model: projectMasterModels.personalProtectiveEquipmentCondition.model }
      })
  });
  ...
  const { data: weatherConditionDuringIncidents } = useQuery({
    ...
    queryFn: () =>
      projectGeneralMasterDataApiService.getAll({
        filter: { model: projectMasterModels.weatherConditionDuringIncident.model }
      })
  });
