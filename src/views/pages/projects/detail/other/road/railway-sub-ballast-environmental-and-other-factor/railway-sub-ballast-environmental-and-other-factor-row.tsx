...
export const railwaySubBallastEnvironmentalAndOtherFactorColumns = (
  ...
  refetch: () => void
    ...
    },
    {
      ...
      headerName: t('project.other.railway-sub-ballast-environmental-and-other-factor.details.railway_line_section_name'),
    ...
    },
    {
      ...
      headerName: t('project.other.railway-sub-ballast-environmental-and-other-factor.details.environmental_compliance_measures'),
    ...
    },
    {
      ...
      headerName: t('project.other.railway-sub-ballast-environmental-and-other-factor.details.environmental_impact_assessment'),
    ...
    },
    {
      ...
      minWidth: 200,
      field: 'remark',
      headerName: t('project.other.railway-sub-ballast-environmental-and-other-factor.details.remark'),
