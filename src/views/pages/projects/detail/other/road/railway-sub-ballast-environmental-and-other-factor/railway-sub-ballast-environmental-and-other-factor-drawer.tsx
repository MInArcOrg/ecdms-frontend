...
const RailwaySubBallastEnvironmentalAndOtherFactorDrawer = ({
  ...
  const isEdit = Boolean(railwaySubBallastEnvironmentalAndOtherFactor?.project_id);
  ...
  const createRailwaySubBallastEnvironmentalAndOtherFactor = async (body: IApiPayload<RailwaySubBallastEnvironmentalAndOtherFactor>) =>
    projectOtherApiSecondService<RailwaySubBallastEnvironmentalAndOtherFactor>().create(otherSubMenu?.apiRoute || '', body);
  ...
  const getPayload = (values: RailwaySubBallastEnvironmentalAndOtherFactor): IApiPayload<RailwaySubBallastEnvironmentalAndOtherFactor> => ({
    data: {
      ...values,
  ...
  const onActionSuccess = async (response: IApiResponse<RailwaySubBallastEnvironmentalAndOtherFactor>, payload: IApiPayload<RailwaySubBallastEnvironmentalAndOtherFactor>) => {
    refetch();
    handleClose();
  };
  ...
  return (
    <CustomSideDrawer
      title={`project.other.railway-sub-ballast-environmental-and-other-factor.${isEdit ? 'edit' : 'create'}`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={isEdit ? editRailwaySubBallastEnvironmentalAndOtherFactor : createRailwaySubBallastEnvironmentalAndOtherFactor}
          onActionSuccess={onActionSuccess}
          onCancel={handleClose}
        >
          {(formik: FormikProps<RailwaySubBallastEnvironmentalAndOtherFactor>) => <RailwaySubBallastEnvironmentalAndOtherFactorForm formik={formik} />}
        </FormPageWrapper>
      )}
    </CustomSideDrawer>
  );
