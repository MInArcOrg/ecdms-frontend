...
const RailwaySubBallastEnvironmentalAndOtherFactorCard: React.FC<
  RailwaySubBallastEnvironmentalAndOtherFactorCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
        ...
        >
          <Typography variant="h6" fontWeight="bold">
            <Typography
              ...
              component={Button}
              onClick={() =>
                onDetail(railwaySubBallastEnvironmentalAndOtherFactor)
              }
              sx={{
                fontWeight: 500,
                textDecoration: "none",
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        ...
        <RowOptions
          ...
          onDelete={() =>
            onDelete(railwaySubBallastEnvironmentalAndOtherFactor.id)
          }
