...
const IntersectionDrivewayForm: React.FC<IntersectionDrivewayFormProps> = ({
  formik,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.intersection-driveway.details.name",
          )}
          name="name"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomSwitch
          label={transl(
            "project.other.intersection-driveway.details.similar-for-all",
          )}
