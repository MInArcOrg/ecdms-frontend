...
const IntersectionDrivewayList: React.FC<IntersectionDrivewayListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const [selectedRow, setSelectedRow] =
    useState<IntersectionAndDriveway | null>(null);
  const { t } = useTranslation();

  const fetchIntersectionDriveways = (
    params: GetRequestParam,
  ): Promise<IApiResponse<IntersectionAndDriveway[]>> => {
    return projectOtherApiSecondService<IntersectionAndDriveway>().getAll(
  ...
  const mapIntersectionDrivewayToDetailItems = (
    ...
    },
    {
      ...
      value: intersectionDriveway?.similar_for_all
        ? t("common.yes")
        : t("common.no"),
    },
    {
      title: t("common.table-columns.created-at"),
      value: intersectionDriveway?.created_at
        ? formatCreatedAt(intersectionDriveway.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: intersectionDriveway?.updated_at
        ? formatCreatedAt(intersectionDriveway.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapIntersectionDrivewayToDetailItems(
            selectedRow as IntersectionAndDriveway,
          )}
          hasReference={false}
          id={selectedRow?.id || ""}
          fileType=""
          title={t(
            "project.other.intersection-driveway.intersection-driveway-details",
          )}
        />
      )}
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: intersectionDrivewayColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
