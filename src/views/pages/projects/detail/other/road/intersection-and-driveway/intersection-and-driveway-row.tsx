...
export const intersectionDrivewayColumns = (
  ...
  refetch: () => void
...

    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.roadSegment?.name ?? row?.name ?? t('common.not-available')}
        </Typography>
      )
    },
    {
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.intersectionType?.title ?? row?.intersection_type_id ?? t('common.not-available')}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.drivewayAccessPoint?.title ?? row?.driveway_access_point_id ?? t('common.not-available')}
        </Typography>
      )
    },
    {
