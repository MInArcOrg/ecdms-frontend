...
const RailwayVehicleSpecificationDrawer = ({
  ...
  const createVehicleSpecification = async (
    body: IApiPayload<RailwayVehicleSpecification>,
  ) =>
    projectOtherApiSecondService<RailwayVehicleSpecification>().create(
      otherSubMenu?.apiRoute || "",
      body,
    );

  const editVehicleSpecification = async (
    body: IApiPayload<RailwayVehicleSpecification>,
  ) =>
  ...
  const getPayload = (
    values: RailwayVehicleSpecification,
  ): IApiPayload<RailwayVehicleSpecification> => {
    return {
      data: {
        ...values,
  ...
  const onActionSuccess = async (
    response: IApiResponse<RailwayVehicleSpecification>,
  ) => {
    try {
      ...
      {() => (
        ...
        >
          {(
            ...
            <RailwayVehicleSpecificationForm
              formik={formik}
