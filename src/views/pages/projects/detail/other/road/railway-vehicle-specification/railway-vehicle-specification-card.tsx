...
const RailwayVehicleSpecificationCard: React.FC<
  RailwayVehicleSpecificationCardProps
> = ({
    ...
    return (
      <Card sx={{ p: 2 }}>
          ...
          >
            <Typography variant="h6" fontWeight="bold">
              <Typography
                ...
                component={Button}
                onClick={() =>
                  onDetail(railwayVehicleSpecification)
                }
                sx={{
                  fontWeight: 500,
                  textDecoration: "none",
          ...
          <Box display="flex" flexDirection="column" gap={1} mt={2}>
            <Typography variant="body2" color="text.secondary">
              ...
              {railwayVehicleSpecification?.railwayVehicleIndentification ?
                railwayVehicleSpecification?.railwayVehicleIndentification + " - " + railwayVehicleSpecification?.railwayVehicleIndentification.manufacturer_supplier_name + " - " + railwayVehicleSpecification?.railwayVehicleIndentification.manufacture_year
            ...
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {railwayVehicleSpecification.vehicle_weight_and_load_capacity ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleSpecification.maximum_speed ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayVehicleSpecification.braking_system_type ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              : {railwayVehicleSpecification.remark || "N/A"}
            </Typography>
        ...
        <CardActions sx={{ justifyContent: "flex-end" }}>
          {railwayVehicleSpecification.id && (
            <FileDrawer
              id={railwayVehicleSpecification.id}
