...
export const railwayVehicleSpecificationColumns = (
  ...
  },
  {
    ...
    headerName: t('project.other.railway-vehicle-specification.details.vehicle_dimensions'),
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row?.vehicle_dimensions || 'N/A'}</Typography>
  },
  {
    flex: 0.2,
    minWidth: 180,
    field: 'vehicle_weight_and_load_capacity',
    headerName: t('project.other.railway-vehicle-specification.details.vehicle_weight_and_load_capacity'),
    renderCell: ({ row }: CellType) => (
  ...
  },
  {
    ...
    minWidth: 100,
    field: 'maximum_speed',
    headerName: t('project.other.railway-vehicle-specification.details.maximum_speed'),
    renderCell: ({ row }: CellType) => (
  ...
  },
  {
    ...
    headerName: t('project.other.railway-vehicle-specification.details.braking_system_type'),
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row?.braking_system_type || 'N/A'}</Typography>
  },
  {
    flex: 0.1,
    minWidth: 120,
