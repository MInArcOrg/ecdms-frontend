    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t("project.other.traffic-volume.details.count-type-id")}: {trafficVolume?.count_type_id || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.traffic-volume.details.count-time")}: {trafficVolume?.count_time ? formatCreatedAt(trafficVolume.count_time) : "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.traffic-volume.details.vehicle-number-per-hour")}: {trafficVolume?.vehicle_number_per_hour || "N/A"}
          </Typography>
        </Box>
      </CardContent>
