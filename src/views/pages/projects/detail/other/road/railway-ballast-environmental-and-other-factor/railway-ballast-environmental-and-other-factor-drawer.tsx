...
const RailwayBallastEnvironmentalAndOtherFactorDrawer = ({
  ...
  const createRailwayBallastEnvironmentalAndOtherFactor = async (body: IApiPayload<RailwayBallastEnvironmentalAndOtherFactor>) =>
    projectOtherApiSecondService<RailwayBallastEnvironmentalAndOtherFactor>().create(otherSubMenu?.apiRoute || '', body);

  const editRailwayBallastEnvironmentalAndOtherFactor = async (body: IApiPayload<RailwayBallastEnvironmentalAndOtherFactor>) =>
  ...
  const getPayload = (values: RailwayBallastEnvironmentalAndOtherFactor): IApiPayload<RailwayBallastEnvironmentalAndOtherFactor> => ({
    data: {
      ...values,
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={isEdit ? editRailwayBallastEnvironmentalAndOtherFactor : createRailwayBallastEnvironmentalAndOtherFactor}
