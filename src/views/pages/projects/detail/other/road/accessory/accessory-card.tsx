      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.accessory.details.name")}:{" "}
            {accessory?.name || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.accessory.details.under-passes")}:{" "}
            {accessory?.under_passes || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.accessory.details.ramps")}:{" "}
            {accessory?.ramps || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.accessory.details.bridge")}:{" "}
            {accessory?.bridge ? t("common.yes") : t("common.no")}
          </Typography>
        </Box>
      </CardContent>
