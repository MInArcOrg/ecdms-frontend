    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.accessory.details.traffic-signals",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.accessory.details.repair-stations",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.accessory.details.bicycle-signals",
          )}
        ...
        />
        <CustomSwitch
          label={transl("project.other.accessory.details.culvert")}
          name="culvert"
          sx={{ mb: 2 }}
        />
        <CustomSwitch
          label={transl("project.other.accessory.details.bridge")}
          name="bridge"
          sx={{ mb: 2 }}
        />
      </Grid>
