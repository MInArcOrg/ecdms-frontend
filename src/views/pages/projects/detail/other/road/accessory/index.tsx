...
const AccessoryList: React.FC<AccessoryListProps> = ({
  ...
  ): Promise<IApiResponse<Accessory[]>> => {
    return projectOtherApiSecondService<Accessory>().getAll(
  ...
  const handleDelete = async (accessoryId: string) => {
    await projectOtherApiSecondService<Accessory>().delete(
      otherSubMenu?.apiRoute || "",
      accessoryId,
    );
    refetch();
  ...
  const mapAccessoryToDetailItems = (
    accessory: Accessory,
    ...
    },
    {
      ...
      value: accessory?.created_at
        ? formatCreatedAt(accessory.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: accessory?.updated_at
        ? formatCreatedAt(accessory.updated_at)
        : "N/A",
    },
  ];
