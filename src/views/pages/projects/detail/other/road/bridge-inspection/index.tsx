...
const BridgeInspectionList: React.FC<BridgeInspectionListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const fetchBridgeInspections = (
    params: GetRequestParam,
  ): Promise<IApiResponse<BridgeInspection[]>> => {
    return projectOtherApiSecondService<BridgeInspection>().getAll(
  ...
  const handleDelete = async (bridgeInspectionId: string) => {
    await projectOtherApiSecondService<BridgeInspection>().delete(
      otherSubMenu?.apiRoute || "",
      bridgeInspectionId,
    );
    refetch();
  ...
  const mapBridgeInspectionToDetailItems = (
    ...
    },
    {
      ...
      value: bridgeInspection?.created_at
        ? formatCreatedAt(bridgeInspection.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: bridgeInspection?.updated_at
        ? formatCreatedAt(bridgeInspection.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapBridgeInspectionToDetailItems(
            selectedRow as BridgeInspection,
          )}
          hasReference={true}
          id={selectedRow?.id || ""}
