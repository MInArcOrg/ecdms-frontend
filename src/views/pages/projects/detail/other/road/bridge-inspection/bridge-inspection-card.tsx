    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-inspection.details.bridge-name")}:{" "}
            {bridgeInspection?.name || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-inspection.details.bridge-part-defect-id")}
            : {bridgeInspection?.bridge_part_defect_id || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-inspection.details.damage-type-id")}:{" "}
            {bridgeInspection?.damage_type_id || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-inspection.details.damage-condition-id")}:{" "}
            {bridgeInspection?.damage_condition_id || "N/A"}
          </Typography>
        </Box>
      </CardContent>
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.bridgeInspection}
        />
        <ModelAction
