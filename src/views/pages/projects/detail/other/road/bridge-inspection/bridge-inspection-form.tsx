...
const BridgeInspectionForm: React.FC<BridgeInspectionFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.bridge-inspection.details.bridge-name",
          )}
          name="bridge_name"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.bridge-inspection.details.bridge-part-defect-id",
          )}
          placeholder={transl(
            "project.other.bridge-inspection.details.bridge-part-defect-id",
          )}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.bridge-inspection.details.damage-type-id",
          )}
          placeholder={transl(
            "project.other.bridge-inspection.details.damage-type-id",
          )}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.bridge-inspection.details.damage-condition-id",
          )}
          placeholder={transl(
            "project.other.bridge-inspection.details.damage-condition-id",
          )}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.bridge-inspection.details.hydrology-defect-id",
          )}
          placeholder={transl(
            "project.other.bridge-inspection.details.hydrology-defect-id",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-inspection.details.maintenance-action",
          )}
          placeholder={transl(
            "project.other.bridge-inspection.details.maintenance-action",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-inspection.details.bridge-history",
          )}
          placeholder={transl(
            "project.other.bridge-inspection.details.bridge-history",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-inspection.details.inspector-remark",
          )}
          placeholder={transl(
            "project.other.bridge-inspection.details.inspector-remark",
          )}
