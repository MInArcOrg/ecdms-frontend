...
const CulvertBasicDataForm: React.FC<CulvertBasicDataFormProps> = ({
  formik,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.culvert-name",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.culvert-name",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.culvert-number",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.culvert-number",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.culvert-coordinate-x",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.culvert-coordinate-x",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.culvert-coordinate-y",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.culvert-coordinate-y",
          )}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.area-topography-id",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.area-topography-id",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.highest-water-level",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.highest-water-level",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.lowest-water-level",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.lowest-water-level",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.construction-year",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.construction-year",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.culvert-basic-data.details.contractor",
          )}
          name="contractor"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.culvert-basic-data.details.designer",
          )}
          name="designer"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.culvert-cost",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.culvert-cost",
          )}
        ...
        <FormControlLabel
          ...
          label={transl(
            "project.other.culvert-basic-data.details.detour-possibility",
          )}
          sx={{ mb: 2 }}
        />
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.culvert-basic-data.details.road-alignment",
          )}
          placeholder={transl(
            "project.other.culvert-basic-data.details.road-alignment",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.culvert-basic-data.details.altitude",
          )}
          name="altitude"
          type="number"
          size="small"
