...
const CulvertBasicDataList: React.FC<CulvertBasicDataListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const fetchCulvertBasicData = (
    params: GetRequestParam,
  ): Promise<IApiResponse<CulvertBasicData[]>> => {
    return projectOtherApiSecondService<CulvertBasicData>().getAll(
  ...
  const handleDelete = async (culvertBasicDataId: string) => {
    await projectOtherApiSecondService<CulvertBasicData>().delete(
      otherSubMenu?.apiRoute || "",
      culvertBasicDataId,
    );
    refetch();
  ...
  const mapCulvertBasicDataToDetailItems = (
    ...
    },
    {
      ...
      value: culvertBasicData?.detour_possibility
        ? t("common.yes")
        : t("common.no"),
    },
    {
    ...
    },
    {
      ...
      value: culvertBasicData?.created_at
        ? formatCreatedAt(culvertBasicData.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: culvertBasicData?.updated_at
        ? formatCreatedAt(culvertBasicData.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapCulvertBasicDataToDetailItems(
            selectedRow as CulvertBasicData,
          )}
          hasReference={false}
          id={selectedRow?.id || ""}
          title={t(
            "project.other.culvert-basic-data.culvert-basic-data-details",
          )}
          fileType=""
        />
      )}
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: culvertBasicDataColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
