...
const RoadMaintenanceDataList: React.FC<RoadMaintenanceDataListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const [selectedRow, setSelectedRow] = useState<RoadMaintenanceData | null>(
    null,
  );
  const { t } = useTranslation();

  const fetchRoadMaintenanceData = (
    params: GetRequestParam,
  ): Promise<IApiResponse<RoadMaintenanceData[]>> => {
    return projectOtherApiSecondService<RoadMaintenanceData>().getAll(
  ...
  const mapRoadMaintenanceDataToDetailItems = (
    ...
    {
      title: t(
        "project.other.road-maintenance-data.details.maintenance-start-date",
      ),
    ...
    {
      title: t(
        "project.other.road-maintenance-data.details.maintenance-end-date",
      ),
      value: roadMaintenanceData?.maintenance_end_date
        ? formatDate(roadMaintenanceData.maintenance_end_date)
        : "N/A",
    },
    {
    ...
    {
      title: t(
        "project.other.road-maintenance-data.details.pavement-condition",
      ),
    ...
    },
    {
      ...
      value: roadMaintenanceData?.created_at
        ? formatCreatedAt(roadMaintenanceData.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: roadMaintenanceData?.updated_at
        ? formatCreatedAt(roadMaintenanceData.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapRoadMaintenanceDataToDetailItems(
            selectedRow as RoadMaintenanceData,
          )}
          hasReference={false}
          id={selectedRow?.id || ""}
          fileType=""
          title={t(
            "project.other.road-maintenance-data.road-maintenance-data-details",
          )}
        />
      )}
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: roadMaintenanceDataColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
