...
const RoadMaintenanceDataForm: React.FC<RoadMaintenanceDataFormProps> = ({
  formik,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.road-maintenance-data.details.road-segment",
          )}
          placeholder={transl(
            "project.other.road-maintenance-data.details.road-segment",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.road-maintenance-data.details.weather-condition",
          )}
          placeholder={transl(
            "project.other.road-maintenance-data.details.weather-condition",
          )}
        ...
        <CustomTextArea
          ...
          placeholder={transl(
            "project.other.road-maintenance-data.details.remark",
          )}
          name="remark"
          size="small"
          sx={{ mb: 2 }}
