...
interface RailwaySubBallastMaintenanceAndRenewalCardProps { // Renamed interface
...
const RailwaySubBallastMaintenanceAndRenewalCard: React.FC<RailwaySubBallastMaintenanceAndRenewalCardProps> = ({ // Renamed component
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-sub-ballast-maintenance-and-renewal.details.project_id', 'Project ID')}:{' '}
            {project_id || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-sub-ballast-maintenance-and-renewal.details.scheduled_maintenance_activities', 'Scheduled Maintenance Activities')}:{' '}
            {scheduled_maintenance_activities || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-sub-ballast-maintenance-and-renewal.details.sub_ballast_renewal_history', 'Sub-Ballast Renewal History')}:{' '}
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-sub-ballast-maintenance-and-renewal.details.inspection_reports_findings', 'Inspection Reports Findings')}:{' '}
