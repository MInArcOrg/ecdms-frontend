...
const RailwayBallastMaterialSpecificationDrawer = ({
  ...
  const validationSchema = yup.object().shape({
    railway_line_section_name: yup
      .string()
      .required(
        "project.other.railway-ballast-material-specification.validation.railway_line_section_name",
      ),
    ballast_material_type_id: yup
      .string()
      .required(
        "project.other.railway-ballast-material-specification.validation.ballast_material_type_id",
      ),
    specific_gravity: yup
      .number()
      .nullable()
      .typeError(
        "project.other.railway-ballast-material-specification.validation.specific_gravity",
      ),
    porosity: yup
      .number()
      .nullable()
      .typeError(
        "project.other.railway-ballast-material-specification.validation.porosity",
      ),
    water_absorption: yup
      .number()
      .nullable()
      .typeError(
        "project.other.railway-ballast-material-specification.validation.water_absorption",
      ),
    ...
    average_particle_length: yup
      ...
      .nullable()
      .typeError(
        "project.other.railway-ballast-material-specification.validation.average_particle_length",
      ),
  ...
  return (
    <CustomSideDrawer
      title={`project.other.railway-ballast-material-specification.${
        isEdit ? "edit" : "create"
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit
              ? editRailwayBallastMaterialSpecification
              : createRailwayBallastMaterialSpecification
          }
