...
export const railwayBallastMaterialSpecificationColumns = (
  ...
  },
  {
    ...
    headerName: t('project.other.railway-ballast-material-specification.railway-line-section-name'),
    renderCell: ({ row }: CellType) => (
  ...
  },
  {
    ...
    headerName: t('project.other.railway-ballast-material-specification.ballast-material-type'),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
  ...
  },
  {
    ...
    headerName: t('project.other.railway-ballast-material-specification.specific-gravity'),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
  ...
  },
  {
    ...
    minWidth: 160,
    field: 'porosity',
    headerName: t('project.other.railway-ballast-material-specification.porosity'),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row.porosity != null
  ...
  },
  {
    ...
    headerName: t('project.other.railway-ballast-material-specification.water-absorption'),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
  ...
  },
  {
    ...
    minWidth: 160,
    field: 'shape',
    headerName: t('project.other.railway-ballast-material-specification.shape'),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row.shape || 'N/A'}
      </Typography>
  ...
  },
  {
    ...
    headerName: t('project.other.railway-ballast-material-specification.average-particle-length'),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
  ...
  },
  {
    ...
    minWidth: 200,
    field: 'remark',
    headerName: t('project.other.railway-ballast-material-specification.remark'),
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row.remark || 'N/A'}
      </Typography>
