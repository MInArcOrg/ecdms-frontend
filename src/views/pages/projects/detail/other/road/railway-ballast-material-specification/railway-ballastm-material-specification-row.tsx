    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.specific_gravity != null ? row.specific_gravity.toLocaleString(undefined, { minimumFractionDigits: 2 }) : 'N/A'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.porosity != null ? row.porosity.toLocaleString(undefined, { minimumFractionDigits: 2 }) : 'N/A'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.water_absorption != null ? row.water_absorption.toLocaleString(undefined, { minimumFractionDigits: 2 }) : 'N/A'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.shape || 'N/A'}</Typography>
    },
    {
      flex: 0.15,
      minWidth: 180,
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.average_particle_length != null ? row.average_particle_length.toLocaleString(undefined, { minimumFractionDigits: 2 }) : 'N/A'}
        </Typography>
      )
    },
    {
