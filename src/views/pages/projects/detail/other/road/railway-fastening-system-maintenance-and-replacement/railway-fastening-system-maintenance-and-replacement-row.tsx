...
export const railwayFasteningSystemMaintenanceAndReplacementColumns = (
  ...
  },
  {
    ...
    headerName: t('project.other.railway-fastening-system-maintenance-and-replacement.details.railway_line_section_name'),
  ...
  },
  {
    ...
    headerName: t('project.other.railway-fastening-system-maintenance-and-replacement.details.scheduled_maintenance_activities'),
    renderCell: ({ row }: CellType) => (
  ...
  // New column for Inspection Reports and Findings
  {
    ...
    sortable: false,
    filterable: false,
    renderCell: ({ row }: CellType) => <>{row.id && <FileDrawer id={row.id} type={'INSPECTION_REPORTS_AND_FINDINGS'} />}</>
  },
  // New column for Fastening System Replacement History
  {
    ...
    sortable: false,
    filterable: false,
    renderCell: ({ row }: CellType) => <>{row.id && <FileDrawer id={row.id} type={'FASTENING_SYSTEM_REPLACEMENT_HISTORY'} />}</>
  },
  {
    field: 'actions',
