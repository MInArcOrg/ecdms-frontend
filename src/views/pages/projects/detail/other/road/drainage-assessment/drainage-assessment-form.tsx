...
const DrainageAssessmentForm: React.FC<DrainageAssessmentFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.drainage-assessment.details.road-segment",
          )}
          placeholder={transl(
            "project.other.drainage-assessment.details.road-segment",
          )}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.drainage-assessment.details.drainage-type",
          )}
          placeholder={transl(
            "project.other.drainage-assessment.details.drainage-type",
          )}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.drainage-assessment.details.drainage-condition",
          )}
          placeholder={transl(
            "project.other.drainage-assessment.details.drainage-condition",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.drainage-assessment.details.remark",
          )}
          name="remark"
          size="small"
          multiline
