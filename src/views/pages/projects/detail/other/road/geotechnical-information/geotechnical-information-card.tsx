...
const GeotechnicalInformationCard: React.FC<
  GeotechnicalInformationCardProps
> = ({ geotechnicalInformation, refetch, onEdit, onDelete, onDetail }) => {
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {geotechnicalInformation?.name ||
                geotechnicalInformation?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          {geotechnicalInformation?.remark && (
            <Typography variant="body2" color="text.secondary">
              {t("project.other.geotechnical-information.details.remark")}:{" "}
              {geotechnicalInformation.remark}
            </Typography>
          )}
          <Typography variant="body2" color="text.secondary">
            {t("common.table-columns.created-at")}:{" "}
            {geotechnicalInformation?.created_at
