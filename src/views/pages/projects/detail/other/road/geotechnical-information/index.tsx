...
const GeotechnicalInformationList: React.FC<
  GeotechnicalInformationListProps
> = ({ otherSubMenu, projectId, typeId }) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] =
    useState<GeotechnicalInformation | null>(null);
  const { t } = useTranslation();

  const fetchGeotechnicalInformation = (
    params: GetRequestParam,
  ): Promise<IApiResponse<GeotechnicalInformation[]>> => {
    return projectOtherApiSecondService<GeotechnicalInformation>().getAll(
  ...
  const handleDelete = async (geotechnicalInformationId: string) => {
    await projectOtherApiSecondService<GeotechnicalInformation>().delete(
      otherSubMenu?.apiRoute || "",
      geotechnicalInformationId,
    );
    refetch();
  };
  ...
  const mapGeotechnicalInformationToDetailItems = (
    ...
    },
    {
      ...
      value:
        geotechnicalInformation?.soil_bearing_capacity?.toString() || "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value: geotechnicalInformation?.created_at
        ? formatCreatedAt(geotechnicalInformation.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: geotechnicalInformation?.updated_at
        ? formatCreatedAt(geotechnicalInformation.updated_at)
        : "N/A",
    },
    {
      title: t(
      ...
      value: (
        <FileDrawer
          id={selectedRow?.id || ""}
          type={uploadableProjectFileTypes.other.seismicDesign}
        />
      ),
    },
    {
      ...
      value: (
        <FileDrawer
          id={selectedRow?.id || ""}
          type={uploadableProjectFileTypes.other.geotechnicalReport}
        />
      ),
    },
    {
      ...
      value: (
        <FileDrawer
          id={selectedRow?.id || ""}
          type={uploadableProjectFileTypes.other.foundationDesign}
        />
      ),
    },
  ];
    ...
    <Box>
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapGeotechnicalInformationToDetailItems(
            selectedRow as GeotechnicalInformation,
          )}
          hasReference={true}
          id={selectedRow?.id || ""}
          fileType={uploadableProjectFileTypes.other.geotechnicalInformation}
          title={t(
            "project.other.geotechnical-information.geotechnical-information-details",
          )}
        />
      )}
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: geotechnicalInformationColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
