...
interface RailwaySubBallastMaterialFormProps { // Updated interface name
  formik: FormikProps<RailwaySubBallastMaterial>; // Updated type
}

const RailwaySubBallastMaterialForm: React.FC<RailwaySubBallastMaterialFormProps> = ({ formik }) => { // Updated component name
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomSelectBox
          ...
          size="small"
          options={subBallastMaterialTypeOptions?.payload.map(item => ({ value: item.id, label: item.title })) || []} // Pass your options here
          sx={{ mb: 2 }}
        />
