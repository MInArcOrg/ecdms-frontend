...
const RailwaySubBallastMaterialDrawer = ({ // Updated component name
  open,
  toggle,
  refetch,
  ...
  const createRailwaySubBallastMaterial = async ( // Updated function name
    body: IApiPayload<RailwaySubBallastMaterial>
  ) =>
    projectOtherApiSecondService<RailwaySubBallastMaterial>().create( // Updated type
      otherSubMenu?.apiRoute || '',
      body
    );

  const editRailwaySubBallastMaterial = async ( // Updated function name
    body: IApiPayload<RailwaySubBallastMaterial>
  ) =>
    projectOtherApiSecondService<RailwaySubBallastMaterial>().update( // Updated type
      otherSubMenu?.apiRoute || '',
  ...
  ): IApiPayload<RailwaySubBallastMaterial> => ({ // Updated type
    data: {
      ...values,
