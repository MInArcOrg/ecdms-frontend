...
const RailwaySubBallastMaterialList: React.FC<RailwaySubBallastMaterialListProps> = ({ otherSubMenu, projectId, typeId }) => {
  ...
  const { data, isLoading, pagination, handlePageChange, refetch } = usePaginatedFetch<RailwaySubBallastMaterial[]>({
