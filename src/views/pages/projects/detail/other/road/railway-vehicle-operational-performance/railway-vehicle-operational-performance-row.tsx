...
export const railwayVehicleOperationalPerformanceColumns = (
  ...
  otherSubMenu?: DetailSubMenuItemChild
    ...
    },
    {
      ...
      headerName: t('project.other.railway-vehicle-operational-performance.details.railway_vehicle_identification_id'),
      renderCell: ({ row }: CellType) => (
    ...
    },
    {
      ...
      headerName: t('project.other.railway-vehicle-operational-performance.details.fuel_or_energy_consumption'),
      renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row?.fuel_or_energy_consumption || 'N/A'}</Typography>
    },
    {
      flex: 0.15,
      minWidth: 150,
      field: 'mileage_or_operating_hours',
      headerName: t('project.other.railway-vehicle-operational-performance.details.mileage_or_operating_hours'),
      renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row?.mileage_or_operating_hours || 'N/A'}</Typography>
    },
    {
      flex: 0.15,
      minWidth: 150,
      field: 'reliability_and_availability',
      headerName: t('project.other.railway-vehicle-operational-performance.details.reliability_and_availability'),
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>{row?.reliability_and_availability || 'N/A'}</Typography>
      )
    },
    {
      flex: 0.1,
