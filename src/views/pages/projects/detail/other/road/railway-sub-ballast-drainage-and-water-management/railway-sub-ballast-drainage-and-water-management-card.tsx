...
interface RailwaySubBallastDrainageAndWaterManagementCardProps {
  // Renamed interface
...
const RailwaySubBallastDrainageAndWaterManagementCard: React.FC<
  RailwaySubBallastDrainageAndWaterManagementCardProps
> = ({
  // Renamed component
      ...
      <CardContent>
        ...
        >
          <Typography variant="h6" fontWeight="bold">
            <Button
              onClick={() =>
                onDetail(railwaySubBallastDrainageAndWaterManagement)
              } // Using updated prop name
              sx={{
                fontWeight: 500,
                textTransform: "none",
                textDecoration: "none",
            ...
            >
              {id ? `${id.slice(0, 8)}...` : "N/A"}{" "}
              {/* Displaying ID and slicing for brevity */}
            </Button>
          </Typography>
        </Box>
        <Divider sx={{ my: 1 }} />
