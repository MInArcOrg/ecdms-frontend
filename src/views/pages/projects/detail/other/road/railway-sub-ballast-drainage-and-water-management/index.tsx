...
interface RailwaySubBallastDrainageAndWaterManagementListProps {
  // Renamed interface
...
const RailwaySubBallastDrainageAndWaterManagementList: React.FC<
  RailwaySubBallastDrainageAndWaterManagementListProps
> = ({
  // Renamed component
  otherSubMenu,
  projectId,
  ...
  const [selectedRow, setSelectedRow] =
    useState<RailwaySubBallastDrainageAndWaterManagement | null>(null); // Updated state type
  const { t } = useTranslation();
  console.log("otherSubMenu?.apiRoute", otherSubMenu?.apiRoute);
  const fetchData = (
    params: GetRequestParam,
  ): Promise<IApiResponse<RailwaySubBallastDrainageAndWaterManagement[]>> => {
    // Updated generic type
    return projectOtherApiSecondService<RailwaySubBallastDrainageAndWaterManagement>().getAll(
  ...
  const { data, isLoading, pagination, handlePageChange, refetch } =
    usePaginatedFetch<RailwaySubBallastDrainageAndWaterManagement[]>({
      // Updated generic type
  ...
  const handleEdit = (row: RailwaySubBallastDrainageAndWaterManagement) => {
    // Updated type
    setSelectedRow(row);
    setShowDrawer(true);
  };
  ...
  const handleDelete = async (id: string) => {
    await projectOtherApiSecondService<RailwaySubBallastDrainageAndWaterManagement>().delete(
      otherSubMenu?.apiRoute || "",
      id,
    ); // Updated generic type
    refetch();
  ...
  const handleClickDetail = (
    row: RailwaySubBallastDrainageAndWaterManagement,
  ) => {
    // Updated type
    setSelectedRow(row);
  ...
  const mapToDetailItems = (
    ...
    {
      title: t(
        "project.other.railway-sub-ballast-drainage-and-water-management.details.project_id",
        "Project ID",
      ),
    ...
    {
      title: t(
        "project.other.railway-sub-ballast-drainage-and-water-management.details.railway_line_section_name",
    ...
    {
      title: t(
        "project.other.railway-sub-ballast-drainage-and-water-management.details.drainage_condition_assessment",
    ...
    {
      title: t(
        "project.other.railway-sub-ballast-drainage-and-water-management.details.drainage_infrastructure_type",
        "Drainage Infrastructure Type",
      ),
      value: row?.drainage_infrastructure_type || "N/A",
    },
    {
      title: t(
        "project.other.railway-sub-ballast-drainage-and-water-management.details.water_management_measures",
    ...
    {
      title: t(
        "project.other.railway-sub-ballast-drainage-and-water-management.details.drainage_infrastructure_length",
        "Drainage Infrastructure Length",
      ),
      value: row?.drainage_infrastructure_length?.toLocaleString() ?? "N/A",
    },
    {
      title: t(
        "project.other.railway-sub-ballast-drainage-and-water-management.details.remark",
        "Remark",
      ),
    ...
    <Box>
      {showDrawer && (
        <RailwaySubBallastDrainageAndWaterManagementDrawer // Renamed Drawer component
          ...
          railwaySubBallastDrainageAndWaterManagement={
            selectedRow as RailwaySubBallastDrainageAndWaterManagement
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          fileType=""
          title={t(
            "project.other.railway-sub-ballast-drainage-and-water-management.detail",
            "Sub Ballast Drainage And Water Management Details",
          )} // Updated translation key and default
        />
      )}

      <ItemsListing
        title={t(
          "project.other.railway-sub-ballast-drainage-and-water-management.title",
          "Sub Ballast Drainage And Water Management Records",
        )} // Updated translation key and default
        pagination={pagination}
        type={ITEMS_LISTING_TYPE.table.value}
        tableProps={{
          headers: railwaySubBallastDrainageAndWaterManagementColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
            refetch,
          ), // Updated columns function import and call
        }}
        isLoading={isLoading}
        ItemViewComponent={(
          ...
          <RailwaySubBallastDrainageAndWaterManagementCard // Renamed Card component
            ...
            railwaySubBallastDrainageAndWaterManagement={
              itemData as RailwaySubBallastDrainageAndWaterManagement
            } // Updated prop name and type
            onEdit={handleEdit}
            refetch={refetch}
