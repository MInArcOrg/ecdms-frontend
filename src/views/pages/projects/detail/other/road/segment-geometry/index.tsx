...
const SegmentGeometryList: React.FC<SegmentGeometryListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const fetchSegmentGeometries = (
    params: GetRequestParam,
  ): Promise<IApiResponse<SegmentGeometry[]>> => {
    return projectOtherApiSecondService<SegmentGeometry>().getAll(
  ...
  const handleDelete = async (segmentGeometryId: string) => {
    await projectOtherApiSecondService<SegmentGeometry>().delete(
      otherSubMenu?.apiRoute || "",
      segmentGeometryId,
    );
    refetch();
  ...
  const mapSegmentGeometryToDetailItems = (
    ...
    },
    {
      ...
      value: segmentGeometry?.property_access_control
        ? t("common.yes")
        : t("common.no"),
    },
    {
      title: t("project.other.segment-geometry.details.similar-for-all-lane"),
      value: segmentGeometry?.similar_for_all_lane
        ? t("common.yes")
        : t("common.no"),
    },
    {
      title: t("common.table-columns.created-at"),
      value: segmentGeometry?.created_at
        ? formatCreatedAt(segmentGeometry.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: segmentGeometry?.updated_at
        ? formatCreatedAt(segmentGeometry.updated_at)
        : "N/A",
    },
  ];
  ...
  return (
    <Box>
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: segmentGeometryColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
