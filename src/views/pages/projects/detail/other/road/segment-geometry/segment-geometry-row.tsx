...
export const segmentGeometryColumns = (
  ...
  return [
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) =>
        row.carriage_way_width !== undefined ? `${row.carriage_way_width} m` : t("common.not-available"),
    },
    {
      flex: 0.15,
      minWidth: 120,
      ...
      field: "lane_width",
      renderCell: ({ row }: CellType) =>
        row.lane_width !== undefined ? `${row.lane_width} m` : t("common.not-available"),
    },
    {
      flex: 0.15,
      minWidth: 120,
      ...
      renderCell: ({ row }: CellType) =>
        row.shoulder_width !== undefined ? `${row.shoulder_width} m` : t("common.not-available"),
    },
    {
      flex: 0.15,
      minWidth: 120,
