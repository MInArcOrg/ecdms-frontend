    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-sleeper-characteristic.details.sleeper_type')}:{' '}
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-sleeper-characteristic.details.sleeper_shape')}:{' '}
      ...
      <CardActions sx={{ justifyContent: 'flex-end' }}>
        <ModelAction
          ...
          model_id={railwaySleeperCharacteristic.project_id}
        ...
        <RowOptions
          ...
          onDelete={() => onDelete(railwaySleeperCharacteristic.project_id)}
