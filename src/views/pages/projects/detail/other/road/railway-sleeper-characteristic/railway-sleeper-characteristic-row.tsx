...
export const railwaySleeperCharacteristicColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.sleeper_size_and_dimensions != null
          ? row.sleeper_size_and_dimensions.toLocaleString()
          : "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.sleeper_distance_between_pairs || "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.sleeper_material_specification || "N/A"}
      </Typography>
    ),
  },
  {
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.spacing_between != null
          ? row.spacing_between.toLocaleString()
          : "N/A"}
      </Typography>
    ),
  },
