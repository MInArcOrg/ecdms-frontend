...
const RailwaySleeperCharacteristicList: React.FC<RailwaySleeperCharacteristicListProps> = ({
  otherSubMenu,
  projectId
}) => {
  ...
  const mapRailwaySleeperCharacteristicToDetailItems = (
    railwaySleeperCharacteristic: RailwaySleeperCharacteristic
      ...
      },
      {
        ...
        value: railwaySleeperCharacteristic?.sleeper_size_and_dimensions !== undefined && railwaySleeperCharacteristic?.sleeper_size_and_dimensions !== null
      ...
      },
      {
        ...
        value: railwaySleeperCharacteristic?.spacing_between !== undefined && railwaySleeperCharacteristic?.spacing_between !== null
