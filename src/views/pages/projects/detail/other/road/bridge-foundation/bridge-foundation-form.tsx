...
const BridgeFoundationForm: React.FC<BridgeFoundationFormProps> = ({
  formik,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.bridge-foundation.details.bridge-name",
          )}
          name="bridge_name"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomSelect
          fullWidth
          label={transl(
            "project.other.bridge-foundation.details.abutment-type-id",
          )}
          placeholder={transl(
            "project.other.bridge-foundation.details.abutment-type-id",
          )}
        ...
        <CustomSelect
          ...
          placeholder={transl(
            "project.other.bridge-foundation.details.pier-type-id",
          )}
          name="pier_type_id"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-foundation.details.abutment-foundation-size",
          )}
          placeholder={transl(
            "project.other.bridge-foundation.details.abutment-foundation-size",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-foundation.details.pier-foundation-size",
          )}
          placeholder={transl(
            "project.other.bridge-foundation.details.pier-foundation-size",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-foundation.details.abutment-pile-number",
          )}
          placeholder={transl(
            "project.other.bridge-foundation.details.abutment-pile-number",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-foundation.details.pier-pile-number",
          )}
          placeholder={transl(
            "project.other.bridge-foundation.details.pier-pile-number",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-foundation.details.abutment-pile-depth",
          )}
          placeholder={transl(
            "project.other.bridge-foundation.details.abutment-pile-depth",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.bridge-foundation.details.pier-pile-depth",
          )}
          placeholder={transl(
            "project.other.bridge-foundation.details.pier-pile-depth",
          )}
        ...
        <CustomSelect
          ...
          placeholder={transl(
            "project.other.bridge-foundation.details.soil-type-id",
          )}
          name="soil_type_id"
          size="small"
          sx={{ mb: 2 }}
