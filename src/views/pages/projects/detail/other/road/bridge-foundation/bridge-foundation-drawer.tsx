...
const BridgeFoundationDrawer = (props: BridgeFoundationDrawerType) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    abutment_pile_number: yup.number().integer('Abutment pile number must be an integer').nullable(),
    pier_pile_number: yup.number().integer('Pier pile number must be an integer').nullable(),
