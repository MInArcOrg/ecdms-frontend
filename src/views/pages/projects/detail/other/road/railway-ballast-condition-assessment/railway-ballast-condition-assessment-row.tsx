...
export const railwayBallastConditionAssessmentColumns = ( // Renamed function
  ...
  refetch: () => void
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.inspection_dates ? formatCreatedAt(row.inspection_dates) : 'N/A'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.ballast_condition_rating || 'N/A'}
        </Typography>
      )
    },
    {
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.ballast_degradation_indicators || 'N/A'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.ballast_quality_testing_method || 'N/A'}
        </Typography>
      )
    },
    {
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row.ballast_degradation_rate || 'N/A'}
        </Typography>
      )
    },
    {
