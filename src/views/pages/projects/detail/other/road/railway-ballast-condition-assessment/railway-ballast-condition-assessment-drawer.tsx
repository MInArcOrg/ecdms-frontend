...
const RailwayBallastConditionAssessmentDrawer = ({
  ...
  const validationSchema = yup.object().shape({
    ...
    ballast_condition_rating: yup.string().required('Ballast condition rating is required'),
  ...
  return (
    <CustomSideDrawer
      title={`project.other.railway-ballast-condition-assessment.${isEdit ? 'edit' : 'create'}`}
