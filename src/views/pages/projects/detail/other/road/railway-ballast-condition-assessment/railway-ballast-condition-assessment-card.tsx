...
const RailwayBallastConditionAssessmentCard: React.FC<RailwayBallastConditionAssessmentCardProps> = ({
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          {testing_frequency !== undefined && (
            <Typography variant="body2" color="text.secondary">
              {t('project.other.railway-ballast-condition-assessment.details.testing-frequency')}: {testing_frequency.toLocaleString()}
            </Typography>
          )}
          {ballast_resistance && (
            <Typography variant="body2" color="text.secondary">
              {t('project.other.railway-ballast-condition-assessment.details.ballast-resistance')}: {ballast_resistance}
            </Typography>
          )}
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-condition-assessment.details.ballast-degradation-rate')}: {ballast_degradation_rate || 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-ballast-condition-assessment.details.drainage-performance')}: {drainage_performance || 'N/A'}
          </Typography>
          {remark && (
            <Typography variant="body2" color="text.secondary">
              {t('project.other.railway-ballast-condition-assessment.details.remark')}: {remark}
            </Typography>
          )}
        </Box>
      </CardContent>
