...
export const bridgeBasicDataColumns = (
  ...
  refetch: () => void
    ...
    },
    {
      ...
      field: 'bridge_number',
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>{row?.bridge_number || t('common.not-available')}</Typography>
      )
    },
    {
      flex: 0.15,
      ...
      field: 'bridge_length',
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>{row?.bridge_length || t('common.not-available')}</Typography>
      )
    },
    {
      flex: 0.15,
