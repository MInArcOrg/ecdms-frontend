      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-basic-data.details.name")}:{" "}
            {bridgeBasicData?.name || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-basic-data.details.bridge-name")}:{" "}
            {bridgeBasicData?.bridge_name || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-basic-data.details.bridge-number")}:{" "}
            {bridgeBasicData?.bridge_number || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.bridge-basic-data.details.bridge-length")}:{" "}
            {bridgeBasicData?.bridge_length || "N/A"}
          </Typography>
        </Box>
      </CardContent>
