...
export const railwayCommunicationSystemSafetyAndComplianceColumns = (
  ...
  otherSubMenu?: DetailSubMenuItemChild
    ...
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.safety_measures_and_protocols_done ? 'Yes' : 'No'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.compliance_with_signaling_and_communication_standards ? 'Yes' : 'No'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.incident_or_accident_records ? 'Yes' : 'No'}
        </Typography>
      )
    },
    {
      ...
      renderCell: ({ row }: CellType) => (
        <Typography sx={{ color: 'text.secondary' }}>
          {row?.incident_date ? formatDate(row.incident_date) : 'N/A'}
        </Typography>
      )
    },
    {
