...
const RailwayVehicleSafetyAndComplianceForm: React.FC<RailwayVehicleSafetyAndComplianceFormProps> = ({
  formik,
  defaultFile,
  onDefaultFileChange
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <CustomSelectBox
          fullWidth
          required
          label={t('project.other.railway-vehicle-safety-and-compliance.details.railway_vehicle_identification_id')}
        ...
        <CustomTextBox
          fullWidth
          label={t('project.other.railway-vehicle-safety-and-compliance.details.safety_features_and_systems')}
        ...
        <CustomSwitch
          label={t('project.other.railway-vehicle-safety-and-compliance.details.comply_with_regulatory_standards_and_certifications')}
        ...
        <CustomTextBox
          fullWidth
          label={t('project.other.railway-vehicle-safety-and-compliance.details.incident_records_number')}
        ...
        <CustomTextBox
          fullWidth
          label={t('project.other.railway-vehicle-safety-and-compliance.details.action_taken_to_accidents')}
        ...
        <CustomTextBox
          fullWidth
          label={t('project.other.railway-vehicle-safety-and-compliance.details.remark')}
