    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomSelect
          ...
          placeholder={transl(
            "project.other.pavement.details.road-length-type-id",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.pavement.details.road-pavement-thickness",
          )}
          placeholder={transl(
            "project.other.pavement.details.road-pavement-thickness",
          )}
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.pavement.details.paved-road-surface-width",
          )}
          placeholder={transl(
            "project.other.pavement.details.paved-road-surface-width",
          )}
