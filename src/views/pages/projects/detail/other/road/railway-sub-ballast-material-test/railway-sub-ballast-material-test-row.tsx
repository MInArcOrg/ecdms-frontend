...
export const railwaySubBallastMaterialTestColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.testing_method_used || 'N/A'}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.sampling_method || 'N/A'}</Typography>
  },
  {
    flex: 0.1,
    minWidth: 100,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.sample_size ?? 'N/A'}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.material_source || 'N/A'}</Typography>
  },
  {
    flex: 0.2,
    minWidth: 200,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.sieve_analysis_results || 'N/A'}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.supplier || 'N/A'}</Typography>
  },
  {
    flex: 0.2,
    minWidth: 200,
      ...
      <>
        ...
        <RowOptions
          deletePermissionRule={{
            action: 'delete',
            subject: 'railwaysubballastmaterialtest'
          }}
          editPermissionRule={{
            action: 'update',
            subject: 'railwaysubballastmaterialtest'
