...
const RailwaySubBallastMaterialTestList: React.FC<RailwaySubBallastMaterialTestListProps> = ({
  // Renamed component
  otherSubMenu,
  projectId
  ...
  const [selectedRailwaySubBallastMaterialTest, setSelectedRailwaySubBallastMaterialTest] = useState<RailwaySubBallastMaterialTest | null>(
    null
  ); // Renamed state
  ...
  const mapToDetailItems = (testData: RailwaySubBallastMaterialTest): { title: string; value: string }[] => [
    // Renamed parameter
    {
