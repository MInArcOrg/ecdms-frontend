...
interface CellType {
  row: RailwayStationPlatformSignageAndWayFinding;
}

export const railwayStationPlatformSignageAndWayFindingColumns = (
  onDetail: (row: RailwayStationPlatformSignageAndWayFinding) => void,
  onEdit: (row: RailwayStationPlatformSignageAndWayFinding) => void,
