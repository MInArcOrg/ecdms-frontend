...
const RailwayStationPlatformLayoutCard: React.FC<
  RailwayStationPlatformLayoutCardProps
> = ({
      ...
      <Card sx={{ p: 2 }}>
        <CardContent>
          ...
          >
            <Typography variant="h6" fontWeight="bold">
              <Typography
                ...
                component={Button}
                onClick={() =>
                  onDetail(railwayStationPlatformLayout)
                }
                sx={{
                  fontWeight: 500,
                  textDecoration: "none",
          ...
          <Box display="flex" flexDirection="column" gap={1} mt={2}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {railwayStationPlatformLayout.platforms_number ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              :{" "}
              {railwayStationPlatformLayout.platform_configuration ||
                "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              {t(
              ...
              {railwayStationPlatformLayout.platform_length
                ? `${railwayStationPlatformLayout.platform_length} ${t(
                  "common.units.meters",
                )}`
                : "N/A"}
            </Typography>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {railwayStationPlatformLayout.accessibility_features ||
                "N/A"}
            </Typography>
        ...
        <CardActions sx={{ justifyContent: "flex-end" }}>
          {railwayStationPlatformLayout.id && (
            <FileDrawer
              id={railwayStationPlatformLayout.id}
          ...
          <RowOptions
            ...
            onDelete={() =>
              onDelete(railwayStationPlatformLayout.id as string)
            }
