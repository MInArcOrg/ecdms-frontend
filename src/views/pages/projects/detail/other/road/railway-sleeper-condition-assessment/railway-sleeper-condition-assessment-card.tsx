      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            {railwaySleeperConditionAssessment.inspection_dates ? formatDynamicDate(railwaySleeperConditionAssessment.inspection_dates) : 'N/A'}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-sleeper-condition-assessment.details.remark')}:{' '}
