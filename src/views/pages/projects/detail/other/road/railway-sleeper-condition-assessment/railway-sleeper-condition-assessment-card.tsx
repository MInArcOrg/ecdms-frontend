...
const RailwaySleeperConditionAssessmentCard: React.FC<
  RailwaySleeperConditionAssessmentCardProps
> = ({
      ...
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwaySleeperConditionAssessment.railway_line_section_name ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwaySleeperConditionAssessment.sleeper_condition_rating ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            : {railwaySleeperConditionAssessment.remark || "N/A"}
          </Typography>
