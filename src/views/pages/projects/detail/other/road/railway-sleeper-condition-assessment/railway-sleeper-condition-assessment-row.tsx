...
export const railwaySleeperConditionAssessmentColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.sleeper_condition_rating || "N/A"}
      </Typography>
    ),
  },
  {
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.sleeper_stability_and_alignment || "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.sleepers_required_number != null
          ? row.sleepers_required_number.toLocaleString()
          : "N/A"}
      </Typography>
    ),
  },
