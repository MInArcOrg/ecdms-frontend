...
const RailwaySleeperFasteningSystemCard: React.FC<
  RailwaySleeperFasteningSystemCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwaySleeperFasteningSystem.fastener_condition_assessment ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <ModelAction
          ...
          model_id={railwaySleeperFasteningSystem.id}
        ...
        <RowOptions
          ...
          onDelete={() => onDelete(railwaySleeperFasteningSystem.id)}
