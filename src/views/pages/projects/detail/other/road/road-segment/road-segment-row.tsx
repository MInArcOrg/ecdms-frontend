...
export const roadSegmentColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      row.specifications ? row.specifications : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    field: 'no_of_layers',
    renderCell: ({ row }: CellType) => (
      row.no_of_layers !== undefined ? row.no_of_layers : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    field: 'length',
    renderCell: ({ row }: CellType) => (
      row.length !== undefined ? `${row.length} m` : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    field: 'width',
    renderCell: ({ row }: CellType) => (
      row.width !== undefined ? `${row.width} m` : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    field: 'remark',
    renderCell: ({ row }: CellType) => (
      row.remark ? row.remark : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    renderCell: ({ row }: CellType) => (
      row.start_northing !== undefined ? `${row.start_northing} m` : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    field: 'start_easting',
    renderCell: ({ row }: CellType) => (
      row.start_easting !== undefined ? `${row.start_easting} m` : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    field: 'end_northing',
    renderCell: ({ row }: CellType) => (
      row.end_northing !== undefined ? `${row.end_northing} m` : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
    ...
    field: 'end_easting',
    renderCell: ({ row }: CellType) => (
      row.end_easting !== undefined ? `${row.end_easting} m` : t('common.not-available')
    ),
  },
  {
    flex: 0.15,
