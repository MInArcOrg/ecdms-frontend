...
const RailwaySleeperEnvironmentalAndOtherFactorCard: React.FC<
  RailwaySleeperEnvironmentalAndOtherFactorCardProps
> = ({
  ...
  return (
    <Card sx={{ p: 2 }}>
        ...
        >
          <Typography variant="h6" fontWeight="bold">
            <Typography
              ...
              component={Button}
              onClick={() =>
                onDetail(railwaySleeperEnvironmentalAndOtherFactor)
              }
              sx={{
                fontWeight: 500,
                textDecoration: "none",
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          id={railwaySleeperEnvironmentalAndOtherFactor?.id || ""}
        ...
        <RowOptions
          ...
          onDelete={() =>
            onDelete(railwaySleeperEnvironmentalAndOtherFactor.id)
          }
