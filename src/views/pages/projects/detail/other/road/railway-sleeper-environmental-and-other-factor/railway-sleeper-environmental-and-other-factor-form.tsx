...
const RailwaySleeperEnvironmentalAndOtherFactorForm: React.FC<
  RailwaySleeperEnvironmentalAndOtherFactorFormProps
> = ({
  formik,
  file,
  onFileChange,
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12}>
        <CustomFileUpload
          label={t(
            "project.other.railway-sleeper-environmental-and-other-factor.details.sleeper_condition_photo",
          )}
