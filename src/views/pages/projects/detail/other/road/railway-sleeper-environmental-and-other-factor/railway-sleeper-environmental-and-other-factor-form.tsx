...
const RailwaySleeperEnvironmentalAndOtherFactorForm: React.FC<RailwaySleeperEnvironmentalAndOtherFactorFormProps> = ({
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid item xs={12}>
        <CustomFileUpload label={t('project.other.railway-sleeper-environmental-and-other-factor.details.sleeper_condition_photo')} file={sleeperConditionPhotoFile} onFileChange={onSleeperConditionPhotoFileChange} />
      </Grid>
    </Grid>
  );
};
