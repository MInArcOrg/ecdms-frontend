...
const RailwaySleeperEnvironmentalAndOtherFactorDrawer = ({
  ...
  const onActionSuccess = async (response: IApiResponse<RailwaySleeperEnvironmentalAndOtherFactor>, payload: IApiPayload<RailwaySleeperEnvironmentalAndOtherFactor>) => {
    try {
