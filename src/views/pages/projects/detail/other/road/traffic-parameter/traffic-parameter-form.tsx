...
const TrafficParameterForm: React.FC<TrafficParameterFormProps> = ({
  formik,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.traffic-parameter.details.parking",
          )}
          name="parking"
          size="small"
          type="number"
        ...
        <CustomTextBox
          fullWidth
          label={transl(
            "project.other.traffic-parameter.details.design-traffic-flow",
          )}
          placeholder={transl(
            "project.other.traffic-parameter.details.design-traffic-flow",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={transl(
            "project.other.traffic-parameter.details.design-speed",
          )}
          name="design_speed"
          size="small"
          type="number"
        ...
        <CustomSwitch
          label={transl(
            "project.other.traffic-parameter.details.similar-for-all",
          )}
