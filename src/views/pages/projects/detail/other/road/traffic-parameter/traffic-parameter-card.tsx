...
const TrafficParameterCard: React.FC<TrafficParameterCardProps> = ({ trafficParameter, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.traffic-parameter.details.design-traffic-flow')}: {trafficParameter?.design_traffic_flow || 'N/A'}
          </Typography>
        </Box>
      </CardContent>
