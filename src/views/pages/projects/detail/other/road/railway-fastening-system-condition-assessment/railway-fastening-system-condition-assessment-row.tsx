...
export const railwayFasteningSystemConditionAssessmentColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row.inspection_date ? formatDynamicDate(row.inspection_date) : "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.fastening_system_condition_rating || "N/A"}
      </Typography>
    ),
  },
  {
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.fastening_system_stability_and_alignment || "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.rail_fastening_model_number || "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.rail_fastening_needed_quantity?.toString() || "N/A"}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.rail_fastening_expected_lifespan?.toString() || "N/A"}
      </Typography>
    ),
  },
  {
