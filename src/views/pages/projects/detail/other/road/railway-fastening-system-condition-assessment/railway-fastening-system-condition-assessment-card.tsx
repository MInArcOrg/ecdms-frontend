      ...
      <CardContent>
        ...
        >
          <Typography variant="h6" fontWeight="bold">
            <Typography
              ...
              component={Button}
              onClick={() =>
                onDetail(railwayFasteningSystemConditionAssessment)
              }
              sx={{
                fontWeight: 500,
                textDecoration: "none",
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayFasteningSystemConditionAssessment.railway_line_section_name ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayFasteningSystemConditionAssessment.fastening_system_condition_rating ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayFasteningSystemConditionAssessment.fastening_system_stability_and_alignment ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemConditionAssessment.rail_fastening_model_number ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemConditionAssessment.rail_fastening_needed_quantity?.toString() ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {railwayFasteningSystemConditionAssessment.rail_fastening_expected_lifespan?.toString() ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {typeof railwayFasteningSystemConditionAssessment.rail_fastening_availability ===
            "boolean"
              ? railwayFasteningSystemConditionAssessment.rail_fastening_availability
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        {railwayFasteningSystemConditionAssessment.id &&
          otherSubMenu?.fileType && (
            <FileDrawer
              id={railwayFasteningSystemConditionAssessment.id}
        ...
        <RowOptions
          ...
          onDelete={() =>
            onDelete(railwayFasteningSystemConditionAssessment.id as string)
          }
