...
const RailwayFasteningSystemConditionAssessmentCard: React.FC<RailwayFasteningSystemConditionAssessmentCardProps> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-fastening-system-condition-assessment.details.fastening_system_condition_rating')}:{' '}
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-fastening-system-condition-assessment.details.fastening_system_stability_and_alignment')}:{' '}
          ...
          <Typography variant="body2" color="text.secondary">
            {t('project.other.railway-fastening-system-condition-assessment.details.rail_fastening_expected_lifespan')}:{' '}
