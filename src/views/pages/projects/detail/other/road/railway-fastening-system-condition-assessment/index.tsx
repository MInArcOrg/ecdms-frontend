...
const RailwayFasteningSystemConditionAssessmentList: React.FC<RailwayFasteningSystemConditionAssessmentListProps> = ({
  otherSubMenu,
  projectId
}) => {
  ...
  const fetchRailwayFasteningSystemConditionAssessment = (
    ...
    return projectOtherApiSecondService<RailwayFasteningSystemConditionAssessment>().getAll(otherSubMenu?.apiRoute || '', {
      ...params,
  ...
  const handleDelete = async (id: string) => {
    await projectOtherApiSecondService<RailwayFasteningSystemConditionAssessment>().delete(otherSubMenu?.apiRoute || '', id);
    refetch();
  };
  ...
  const mapRailwayFasteningSystemConditionAssessmentToDetailItems = (
    ...
    },
    {
      ...
      value: characteristic?.inspection_date ? formatDynamicDate(characteristic.inspection_date) : 'N/A'
    },
    {
      title: t('project.other.railway-fastening-system-condition-assessment.details.fastening_system_condition_rating'),
    ...
    {
      title: t('project.other.railway-fastening-system-condition-assessment.details.fastening_system_stability_and_alignment'),
    ...
    {
      title: t('project.other.railway-fastening-system-condition-assessment.details.rail_fastening_expected_lifespan'),
  ...
  return (
    <Box>
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: railwayFasteningSystemConditionAssessmentColumns(handleClickDetail, handleEdit, handleDelete, t, refetch, otherSubMenu)
        }}
        isLoading={isLoading}
