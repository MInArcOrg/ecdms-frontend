...
const SpillwayInfoList: React.FC<SpillwayInfoListProps> = ({
  model,
  projectId,
  typeId,
}) => {
  ...
  const fetchSpillwayInfos = (
    params: GetRequestParam,
  ): Promise<IApiResponse<SpillwayInfo[]>> => {
  ...
  const mapSpillwayInfoToDetailItems = (
    spillwayInfo: SpillwayInfo,
  ): { title: string; value: string }[] => [
    {
      title: t("project.other.spillway-info.details.name"),
      value: spillwayInfo.name || "N/A",
    },
    {
      title: t("project.other.spillway-info.details.type"),
      value: spillwayInfo.type || "N/A",
    },
    {
      title: t("project.other.spillway-info.details.quantity"),
      value: spillwayInfo.quantity?.toString() || "N/A",
    },
    {
      title: t("project.other.spillway-info.details.specifications"),
      value: spillwayInfo.specifications || "N/A",
    },
    {
      title: t("project.other.spillway-info.details.capacity"),
      value: spillwayInfo.capacity?.toString() || "N/A",
    },
    {
      title: t("common.table-columns.created-at"),
      value: spillwayInfo.created_at
        ? formatCreatedAt(spillwayInfo.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: spillwayInfo.updated_at
        ? formatCreatedAt(spillwayInfo.updated_at)
        : "N/A",
    },
  ];
