...
export const waterIrrigationDamColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row.dam_volume !== undefined
          ? row.dam_volume.toString()
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row.total_capacity !== undefined
          ? row.total_capacity.toString()
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row.active_capacity !== undefined
          ? row.active_capacity.toString()
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row.inactive_capacity !== undefined
          ? row.inactive_capacity.toString()
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row.catchment_area !== undefined
          ? row.catchment_area.toString()
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row.surface_area !== undefined
          ? row.surface_area.toString()
          : t("common.not-available")}
      </Typography>
    ),
  },
