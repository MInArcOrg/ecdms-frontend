    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.projectId")}:{" "}
            {waterIrrigationDam.project_id || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.damVolume")}:{" "}
            {waterIrrigationDam.dam_volume !== undefined
              ? waterIrrigationDam.dam_volume
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.totalCapacity")}:{" "}
            {waterIrrigationDam.total_capacity !== undefined
              ? waterIrrigationDam.total_capacity
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.activeCapacity")}:{" "}
            {waterIrrigationDam.active_capacity !== undefined
              ? waterIrrigationDam.active_capacity
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.inactiveCapacity")}:{" "}
            {waterIrrigationDam.inactive_capacity !== undefined
              ? waterIrrigationDam.inactive_capacity
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.catchmentArea")}:{" "}
            {waterIrrigationDam.catchment_area !== undefined
              ? waterIrrigationDam.catchment_area
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.surfaceArea")}:{" "}
            {waterIrrigationDam.surface_area !== undefined
              ? waterIrrigationDam.surface_area
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.water-irrigation-dam.details.revision-no")}:{" "}
            {waterIrrigationDam.revision_no !== undefined
              ? waterIrrigationDam.revision_no
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("common.table-columns.created-at")}:{" "}
            {waterIrrigationDam.created_at
              ? formatCreatedAt(waterIrrigationDam.created_at)
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("common.table-columns.updated-at")}:{" "}
            {waterIrrigationDam.updated_at
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.waterIrrigationDam}
        />
        <ModelAction
