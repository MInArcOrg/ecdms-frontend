    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.irrigation-capacity.details.projectId")}:{" "}
            {irrigationCapacity.project_id || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            {irrigationCapacity.revision_no !== undefined
              ? irrigationCapacity.revision_no
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("common.table-columns.created-at")}:{" "}
            {irrigationCapacity.created_at
              ? formatCreatedAt(irrigationCapacity.created_at)
              : t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("common.table-columns.updated-at")}:{" "}
            {irrigationCapacity.updated_at
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.irrigationCapacity}
        />
        <ModelAction
