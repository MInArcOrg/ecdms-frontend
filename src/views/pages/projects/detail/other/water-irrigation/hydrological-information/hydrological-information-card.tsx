...
const HydrologicalInformationCard: React.FC<
  HydrologicalInformationCardProps
> = ({ hydrologicalInformation, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.hydrological-information.details.water-source")}:{" "}
            {hydrologicalInformation?.water_source || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            {t("project.other.hydrological-information.details.head")}:{" "}
            {hydrologicalInformation?.head?.toString() || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.hydrological-information.details.total-inflow")}:{" "}
            {hydrologicalInformation?.total_inflow?.toString() || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t(
            ...
            :{" "}
            {hydrologicalInformation?.active_storage_volume?.toString() ||
              "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.hydrological-information.details.water-stored")}:{" "}
            {hydrologicalInformation?.water_stored?.toString() || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.hydrological-information.details.remark")}:{" "}
            {hydrologicalInformation?.remark || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("common.table-columns.created-at")}:{" "}
            {hydrologicalInformation?.created_at
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.hydrologicalInformation}
        />
        <ModelAction
