...
const BuildingDimensionDetailList: React.FC<BuildingDimensionDetailListProps> = ({ model, projectId, typeId }) => {
  ...
  const mapBuildingDimensionDetailToDetailItems = (
    ...
    { title: t('project.other.building-dimension-detail.details.site-area'), value: buildingDimensionDetail?.site_area ? `${buildingDimensionDetail?.site_area} sqm` : "N/A" },
    { title: t('project.other.building-dimension-detail.details.site-above-sea-level'), value: buildingDimensionDetail?.site_above_sea_level?.toString() || "N/A" },
    { title: t('project.other.building-dimension-detail.details.ground-floor-area'), value: buildingDimensionDetail?.ground_floor_area ? `${buildingDimensionDetail?.ground_floor_area} sqm` : "N/A" },
    { title: t('project.other.building-dimension-detail.details.total-floor-area'), value: buildingDimensionDetail?.total_floor_area ? `${buildingDimensionDetail?.total_floor_area} sqm` : "N/A" },
    { title: t('project.other.building-dimension-detail.details.basement-stories-no'), value: buildingDimensionDetail?.basement_stories_no?.toString() || "N/A" },
    { title: t('project.other.building-dimension-detail.details.above-ground-floor-stories-no'), value: buildingDimensionDetail?.above_ground_floor_stories_no?.toString() || "N/A" },
    { title: t('project.other.building-dimension-detail.details.height-above-natural-ground'), value: buildingDimensionDetail?.height_above_natural_ground ? `${buildingDimensionDetail?.height_above_natural_ground} m` : "N/A" },
    { title: t('project.other.building-dimension-detail.details.depth-below-natural-ground'), value: buildingDimensionDetail?.depth_below_natural_ground ? `${buildingDimensionDetail?.depth_below_natural_ground} m` : "N/A" },
    { title: t('project.other.building-dimension-detail.details.remark'), value: buildingDimensionDetail?.remark || "N/A" },
    { title: t('common.table-columns.created-at'), value: buildingDimensionDetail?.created_at ? formatCreatedAt(buildingDimensionDetail?.created_at) : "N/A" },
    { title: t('common.table-columns.updated-at'), value: buildingDimensionDetail?.updated_at ? formatCreatedAt(buildingDimensionDetail?.updated_at) : "N/A" },
  ];
