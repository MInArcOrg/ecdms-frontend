...
const BuildingEnvelopMaterialList: React.FC<
  BuildingEnvelopMaterialListProps
> = ({ model, projectId, typeId }) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] =
    useState<BuildingEnvelopMaterial | null>(null);
  ...
  const handleDelete = async (materialId: string) => {
    await projectOtherApiService<BuildingEnvelopMaterial>().delete(
      model,
      materialId,
    );
    refetch();
  ...
  const mapBuildingEnvelopMaterialToDetailItems = (
    ...
    {
      title: t(
        "project.other.building-envelop-material.details.exterior-walls",
      ),
      value: buildingEnvelopMaterial.exterior_walls || "N/A",
    },
    {
      title: t("project.other.building-envelop-material.details.roof-assembly"),
      value: buildingEnvelopMaterial.roof_assembly || "N/A",
    },
    {
      title: t(
        "project.other.building-envelop-material.details.exterior-windows",
      ),
      value: buildingEnvelopMaterial.exterior_windows || "N/A",
    },
    {
      title: t(
        "project.other.building-envelop-material.details.exterior-doors",
      ),
      value: buildingEnvelopMaterial.exterior_doors || "N/A",
    },
    {
      title: t(
        "project.other.building-envelop-material.details.shading-components",
      ),
      value: buildingEnvelopMaterial.shading_components || "N/A",
    },
    {
      title: t("project.other.building-envelop-material.details.remark"),
      value: buildingEnvelopMaterial.remark || "N/A",
    },
    {
      title: t("common.table-columns.created-at"),
      value: buildingEnvelopMaterial.created_at
        ? formatCreatedAt(buildingEnvelopMaterial.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: buildingEnvelopMaterial.updated_at
        ? formatCreatedAt(buildingEnvelopMaterial.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapBuildingEnvelopMaterialToDetailItems(
            selectedRow as BuildingEnvelopMaterial,
          )}
          hasReference={true}
          id={selectedRow?.id || ""}
          fileType={uploadableProjectFileTypes.other.buildingEnvelopMaterial}
          title={t(
            "project.other.building-envelop-material.building-envelop-material-details",
          )}
        />
      )}
