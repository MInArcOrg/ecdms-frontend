...
const SubstationTransformerAndSwitchgearDataCard: React.FC<
  SubstationTransformerAndSwitchgearDataCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {substationTransformerAndSwitchgearData?.name ||
                substationTransformerAndSwitchgearData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
