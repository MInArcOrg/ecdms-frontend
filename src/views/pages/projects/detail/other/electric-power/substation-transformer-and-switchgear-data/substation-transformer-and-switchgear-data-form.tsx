...
const SubstationTransformerAndSwitchgearDataForm: React.FC<
  SubstationTransformerAndSwitchgearDataFormProps
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <Typography variant="subtitle1" gutterBottom>
          {transl(
            "project.other.substation-transformer-and-switchgear-data.general-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.substation-transformer-and-switchgear-data.transformer-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.substation-transformer-and-switchgear-data.switchgear-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.substation-transformer-and-switchgear-data.additional-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
