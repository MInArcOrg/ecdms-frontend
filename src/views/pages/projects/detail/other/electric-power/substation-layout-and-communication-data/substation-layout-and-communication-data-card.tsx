...
const SubstationLayoutAndCommunicationDataCard: React.FC<
  SubstationLayoutAndCommunicationDataCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {substationLayoutAndCommunicationData?.name ||
                substationLayoutAndCommunicationData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
