    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        {substationLayoutAndCommunicationData?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t('project.other.substation-layout-and-communication-data.details.remark')}: {substationLayoutAndCommunicationData.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: 'space-between' }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.substation_layout_and_communication_data}
        />
