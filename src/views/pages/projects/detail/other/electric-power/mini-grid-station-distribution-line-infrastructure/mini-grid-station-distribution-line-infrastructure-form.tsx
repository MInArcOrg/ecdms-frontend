...
const MiniGridStationDistributionLineInfrastructureForm: React.FC<MiniGridStationDistributionLineInfrastructureFormProps> = ({
  ...
  const topologyOptions = [
    {
      label: transl('project.other.mini-grid-station-distribution-line-infrastructure.topology-options.radial'),
      value: 'Radial'
    },
    {
      label: transl('project.other.mini-grid-station-distribution-line-infrastructure.topology-options.ring'),
      value: 'Ring'
    }
  ];
