    ...
    return (
        <Card sx={{ p: 2 }}>
                    ...
                    {miniGridStationDistributionLineInfrastructure?.mini_grid_station_id && (
                        <Grid item xs={12}>
                            <Typography variant="body2" color="text.secondary">
                                ...
                                {miniGridStationsMap.get(miniGridStationDistributionLineInfrastructure.mini_grid_station_id) || miniGridStationDistributionLineInfrastructure.mini_grid_station_id}
                            </Typography>
                        </Grid>
                    )}
                </Grid>
                    ...
                    {miniGridStationDistributionLineInfrastructure?.distribution_line_type_id && (
                        <Grid item xs={6}>
                            <Typography variant="body2" color="text.secondary">
                                ...
                                {distributionLineTypesMap.get(miniGridStationDistributionLineInfrastructure.distribution_line_type_id) || miniGridStationDistributionLineInfrastructure.distribution_line_type_id}
                            </Typography>
                        </Grid>
                    )}
                    ...
                    {miniGridStationDistributionLineInfrastructure?.distribution_line_material_id && (
                        <Grid item xs={6}>
                            <Typography variant="body2" color="text.secondary">
                                ...
                                {distributionLineMaterialsMap.get(miniGridStationDistributionLineInfrastructure.distribution_line_material_id) || miniGridStationDistributionLineInfrastructure.distribution_line_material_id}
                            </Typography>
                        </Grid>
                    )}
            ...
            <CardActions sx={{ justifyContent: "space-between" }}>
                <FileDrawer id={miniGridStationDistributionLineInfrastructure.id} type={uploadableProjectFileTypes.other.mini_grid_station_distribution_line_infrastructure} />
