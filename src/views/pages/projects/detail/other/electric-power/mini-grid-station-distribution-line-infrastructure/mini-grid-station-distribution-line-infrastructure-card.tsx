...
const MiniGridStationDistributionLineInfrastructureCard: React.FC<
  MiniGridStationDistributionLineInfrastructureCardProps
> = ({
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            <Typography
              ...
              component={Button}
              onClick={() =>
                onDetail(miniGridStationDistributionLineInfrastructure)
              }
              sx={{
                fontWeight: 500,
                textDecoration: "none",
            ...
            >
              {miniGridStationDistributionLineInfrastructure?.name ||
                miniGridStationDistributionLineInfrastructure?.id.slice(0, 8) +
                  "..."}
            </Typography>
          </Typography>
        </Box>
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        ...
        <Box display="flex">
          ...
          <RowOptions
            ...
            onDelete={() =>
              onDelete(miniGridStationDistributionLineInfrastructure.id)
            }
