...
const MiniGridStationDistributionLineInfrastructureList: React.FC<MiniGridStationDistributionLineInfrastructureListProps> = ({ otherSubMenu, projectId, typeId }) => {
    ...
    const fetchMiniGridStationDistributionLineInfrastructures = (params: GetRequestParam): Promise<IApiResponse<MiniGridStationDistributionLineInfrastructure[]>> => {
    ...
    const handleDelete = async (miniGridStationDistributionLineInfrastructureId: string) => {
        await projectOtherApiSecondService<MiniGridStationDistributionLineInfrastructure>().delete(otherSubMenu?.apiRoute || "", miniGridStationDistributionLineInfrastructureId)
        refetch()
    }
    ...
    const mapMiniGridStationDistributionLineInfrastructureToDetailItems = (miniGridStationDistributionLineInfrastructure: MiniGridStationDistributionLineInfrastructure): { title: string; value: string }[] => [
        {
        ...
        },
        {
            ...
            value: miniGridStationDistributionLineInfrastructure?.mini_grid_station_id ? miniGridStationsMap.get(miniGridStationDistributionLineInfrastructure?.mini_grid_station_id) || miniGridStationDistributionLineInfrastructure?.mini_grid_station_id : 'N/A'
        },
        {
            title: t("project.other.mini-grid-station-distribution-line-infrastructure.details.distribution-line-type-id"),
            value: miniGridStationDistributionLineInfrastructure?.distribution_line_type_id ? distributionLineTypesMap.get(miniGridStationDistributionLineInfrastructure?.distribution_line_type_id) || miniGridStationDistributionLineInfrastructure?.distribution_line_type_id : 'N/A'
        },
        {
            title: t("project.other.mini-grid-station-distribution-line-infrastructure.details.distribution-line-material-id"),
            value: miniGridStationDistributionLineInfrastructure?.distribution_line_material_id ? distributionLineMaterialsMap.get(miniGridStationDistributionLineInfrastructure?.distribution_line_material_id) || miniGridStationDistributionLineInfrastructure?.distribution_line_material_id : 'N/A'
        },
        {
            title: t("project.other.mini-grid-station-distribution-line-infrastructure.details.distribution-line-conductor-size"),
            value: miniGridStationDistributionLineInfrastructure?.distribution_line_conductor_size !== undefined
        ...
        },
        {
            ...
            value: miniGridStationDistributionLineInfrastructure?.voltage_level !== undefined
        ...
        },
        {
            ...
            value: miniGridStationDistributionLineInfrastructure?.topology
                ? t(`project.other.mini-grid-station-distribution-line-infrastructure.topology-options.${miniGridStationDistributionLineInfrastructure.topology.toLowerCase()}`)
                : "N/A",
        },
        {
            title: t("project.other.mini-grid-station-distribution-line-infrastructure.details.switching-station-connection"),
            value: miniGridStationDistributionLineInfrastructure?.switching_station_connection !== undefined
        ...
        },
        {
            ...
            value: miniGridStationDistributionLineInfrastructure?.created_at ? formatCreatedAt(miniGridStationDistributionLineInfrastructure.created_at) : "N/A",
        },
        {
            title: t("common.table-columns.updated-at"),
            value: miniGridStationDistributionLineInfrastructure?.updated_at ? formatCreatedAt(miniGridStationDistributionLineInfrastructure.updated_at) : "N/A",
        },
    ]
        ...
        <Box>
            ...
            {showDetailDrawer && (
                <OtherDetailSidebar
                    ...
                    title={t("project.other.mini-grid-station-distribution-line-infrastructure.mini-grid-station-distribution-line-infrastructure-details")}
                />
            )}
