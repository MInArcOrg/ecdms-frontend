...
const ElectricSmartMetersRatingsDataCard: React.FC<
  ElectricSmartMetersRatingsDataCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {electricSmartMetersRatingsData?.name ||
                electricSmartMetersRatingsData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {electricSmartMetersRatingsData?.active_reactive ||
                t("common.not-available")}
            </Typography>
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {electricSmartMetersRatingsData?.phase ||
                t("common.not-available")}
            </Typography>
          </Grid>
