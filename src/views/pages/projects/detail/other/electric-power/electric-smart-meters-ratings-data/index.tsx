...
const ElectricSmartMetersRatingsDataList: React.FC<ElectricSmartMetersRatingsDataListProps> = ({ otherSubMenu, projectId, typeId }) => {
  ...
  const handleDelete = async (electricSmartMetersRatingsDataId: string) => {
    await projectOtherApiSecondService<ElectricSmartMetersRatingsData>().delete(otherSubMenu?.apiRoute || "", electricSmartMetersRatingsDataId)
    refetch()
  }
  ...
  const mapElectricSmartMetersRatingsDataToDetailItems = (electricSmartMetersRatingsData: ElectricSmartMetersRatingsData): { title: string; value: string }[] => [
    {
    ...
    },
    {
      ...
      value: electricSmartMetersRatingsData?.electric_smart_meters_data_id 
        ? electricSmartMetersDataMap.get(electricSmartMetersRatingsData.electric_smart_meters_data_id) || electricSmartMetersRatingsData.electric_smart_meters_data_id 
        : "N/A",
    },
    {
    ...
    },
    {
      ...
      value: electricSmartMetersRatingsData?.kwh_kvarh_rating !== undefined 
    ...
    },
    {
      ...
      value: electricSmartMetersRatingsData?.maximum_current_rating !== undefined 
