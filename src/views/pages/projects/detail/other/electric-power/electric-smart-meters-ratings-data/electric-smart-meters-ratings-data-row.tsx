...
export const electricSmartMetersRatingsDataColumns = (
...
): GridColDef[] => [
  {
    ...
    minWidth: 150,
    field: 'name',
    headerName: t('project.other.electric-smart-meters-ratings-data.details.name'),
  ...
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t('project.other.electric-smart-meters-ratings-data.details.electric-smart-meters-data-id'),
  ...
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t('project.other.electric-smart-meters-ratings-data.details.active-reactive'),
    field: 'active_reactive',
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.active_reactive || t('common.not-available')}</Typography>
    )
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t('project.other.electric-smart-meters-ratings-data.details.phase'),
    field: 'phase',
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row?.phase || t('common.not-available')}</Typography>
  },
  {
    flex: 0.15,
    minWidth: 120,
