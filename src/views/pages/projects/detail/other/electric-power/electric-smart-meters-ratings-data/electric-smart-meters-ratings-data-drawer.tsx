...
const ElectricSmartMetersRatingsDataDrawer = (props: ElectricSmartMetersRatingsDataDrawerType) => {
  ...
  const onActionSuccess = async (response: IApiResponse<ElectricSmartMetersRatingsData>, payload: IApiPayload<ElectricSmartMetersRatingsData>) => {
      ...
      {() => (
        ...
        >
          {(formik: FormikProps<ElectricSmartMetersRatingsData>) => {
            return <ElectricSmartMetersRatingsDataForm 
              file={uploadableFile} 
