...
const MiniGridStationBackupPowerSourceCard: React.FC<
  MiniGridStationBackupPowerSourceCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {miniGridStationBackupPowerSource?.name ||
                miniGridStationBackupPowerSource?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
          ...
          {miniGridStationBackupPowerSource?.lifetime !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {miniGridStationBackupPowerSource.lifetime}{" "}
                {t("common.years")}
              </Typography>
            </Grid>
          )}
