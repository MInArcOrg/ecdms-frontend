...
const MiniGridStationBackupPowerSourceForm: React.FC<
  MiniGridStationBackupPowerSourceFormProps
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <Typography variant="subtitle1" gutterBottom>
          {transl(
            "project.other.mini-grid-station-backup-power-source.general-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.mini-grid-station-backup-power-source.technical-specifications",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.mini-grid-station-backup-power-source.timeline-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.mini-grid-station-backup-power-source.additional-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
