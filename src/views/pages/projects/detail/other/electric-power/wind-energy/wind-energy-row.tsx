...
export const windEnergyColumns = (
  ...
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t('project.other.wind-energy.details.title'),
    field: 'title',
  ...
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t('project.other.wind-energy.details.description'),
    field: 'description',
  ...
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t('project.other.wind-energy.details.specifications'),
...

  {
    ...
    renderCell: ({ row }: CellType) => (
      <Fragment>
        <ModelAction model="WindEnergy" model_id={row.id} refetchModel={refetch} resubmit={() => {}} title="" postAction={() => {}} />
        <RowOptions
          onEdit={() => onEdit(row)}
