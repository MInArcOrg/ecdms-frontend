...
const WindResourceList: React.FC<WindResourceListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const fetchWindResources = (
    params: GetRequestParam,
  ): Promise<IApiResponse<WindResource[]>> => {
    return projectOtherApiSecondService<WindResource>().getAll(
  ...
  const handleDelete = async (windResourceId: string) => {
    await projectOtherApiSecondService<WindResource>().delete(
      otherSubMenu?.apiRoute || "",
      windResourceId,
    );
    refetch();
  ...
  const mapWindResourceToDetailItems = (
  ...
  ): { title: string; value: string }[] => [
    {
      ...
      value:
        windResource?.wind_speed_at_hub_height !== undefined
          ? `${windResource.wind_speed_at_hub_height} ${t(
              "common.meters-per-second",
            )}`
          : "N/A",
    },
    {
      ...
      value:
        windResource?.weibull_shape_factor !== undefined
    ...
    },
    {
      ...
      value: windResource?.created_at
        ? formatCreatedAt(windResource.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: windResource?.updated_at
        ? formatCreatedAt(windResource.updated_at)
        : "N/A",
    },
  ];
