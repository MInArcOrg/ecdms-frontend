...
const TransmissionList: React.FC<TransmissionListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  ): Promise<IApiResponse<Transmission[]>> => {
    return projectOtherApiSecondService<Transmission>().getAll(
  ...
  const handleDelete = async (transmissionId: string) => {
    await projectOtherApiSecondService<Transmission>().delete(
      otherSubMenu?.apiRoute || "",
      transmissionId,
    );
    refetch();
  ...
  const mapTransmissionToDetailItems = (
    ...
    },
    {
      ...
      value: transmission?.created_at
        ? formatCreatedAt(transmission.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: transmission?.updated_at
        ? formatCreatedAt(transmission.updated_at)
        : "N/A",
    },
  ];
