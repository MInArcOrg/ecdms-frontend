...
const TransmissionList: React.FC<TransmissionListProps> = ({ otherSubMenu, projectId, typeId }) => {
  ...
  const mapTransmissionToDetailItems = (transmission: Transmission): { title: string; value: string }[] => [
    ...
    },
    {
      ...
      value: transmission?.distance_to_substation !== undefined ? `${transmission.distance_to_substation} ${t('common.kilometers')}` : 'N/A'
    },
    {
      title: t('project.other.transmission.details.transmission-lines-number'),
      value: transmission?.transmission_lines_number !== undefined ? transmission.transmission_lines_number.toString() : 'N/A'
    },
    {
  ...
  return (
    <Box>
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: transmissionColumns(handleClickDetail, handleEdit, handleDelete, t, refetch)
        }}
        isLoading={isLoading}
