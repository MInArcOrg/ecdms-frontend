...
const TransmissionCard: React.FC<TransmissionCardProps> = ({
  transmission,
  refetch,
  onEdit,
  onDelete,
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          {transmission?.distance_to_substation !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.transmission.details.distance-to-substation")}
          ...
          {transmission?.transmission_lines_number !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t(
                  "project.other.transmission.details.transmission-lines-number",
                )}
                : {transmission.transmission_lines_number}
              </Typography>
            </Grid>
          )}
        </Grid>
        ...
        {transmission?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.transmission.details.remark")}:{" "}
              {transmission.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          id={transmission.id}
          type={uploadableProjectFileTypes.other.transmission}
        />
