...
const TransformerList: React.FC<TransformerListProps> = ({
  model,
  projectId,
  typeId,
}) => {
  ...
  ): Promise<IApiResponse<Transformer[]>> => {
  ...
  const mapTransformerToDetailItems = (
    transformer: Transformer,
  ): { title: string; value: string }[] => [
    {
      title: t("project.other.transformer.details.specifications"),
      value: transformer.specifications || "N/A",
    },
    {
      title: t("project.other.transformer.details.input-current"),
      value: transformer.input_current || "N/A",
    },
    {
      title: t("project.other.transformer.details.input-voltage"),
      value: transformer.input_voltage || "N/A",
    },
    {
      title: t("project.other.transformer.details.output-current"),
      value: transformer.output_current || "N/A",
    },
    {
      title: t("project.other.transformer.details.output-voltage"),
      value: transformer.output_voltage || "N/A",
    },
    {
      title: t("project.other.transformer.details.northing"),
      value: transformer.northing?.toString() || "N/A",
    },
    {
      title: t("project.other.transformer.details.easting"),
      value: transformer.easting?.toString() || "N/A",
    },
    {
      title: t("common.table-columns.created-at"),
      value: transformer.created_at
        ? formatCreatedAt(transformer.created_at)
        : "N/A",
    },
  ];
