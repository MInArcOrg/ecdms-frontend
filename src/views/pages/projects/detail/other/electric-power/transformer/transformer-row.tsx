...
export const transformerColumns = (
  ...
  },
  {
    ...
    field: "name",
    renderCell: ({ row }: CellType) =>
      row.transformertype_id ? row.transformertype?.name : t("common.not-available"),
  },
  ...
  },
  {
    ...
    field: "input_voltage",
    renderCell: ({ row }: CellType) =>
      row.input_voltage ? row.input_voltage : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    renderCell: ({ row }: CellType) =>
      row.output_voltage ? row.output_voltage : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
