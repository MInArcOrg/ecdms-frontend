...
const ElectricSmartMetersPrivacyAndSecurityDataDrawer = (props: ElectricSmartMetersPrivacyAndSecurityDataDrawerType) => {
  ...
  const onActionSuccess = async (response: IApiResponse<ElectricSmartMetersPrivacyAndSecurityData>, payload: IApiPayload<ElectricSmartMetersPrivacyAndSecurityData>) => {
    if (payload.files.length > 0) {
      await uploadFile(payload.files[0], uploadableProjectFileTypes.other.electric_smart_meters_privacy_and_security_data, response.payload.id, "", "")
    }
      ...
      {() => (
        <FormPageWrapper
          ...
          initialValues={{
            ...
            customer_engagement_programs_implemented: electricSmartMetersPrivacyAndSecurityData?.customer_engagement_programs_implemented || false,
            social_impact_assessment_conducted: electricSmartMetersPrivacyAndSecurityData?.social_impact_assessment_conducted || false,
            resettlement_and_compensation_measures_implemented: electricSmartMetersPrivacyAndSecurityData?.resettlement_and_compensation_measures_implemented || false,
          }}
        ...
        >
          {(formik: FormikProps<ElectricSmartMetersPrivacyAndSecurityData>) => {
            return <ElectricSmartMetersPrivacyAndSecurityDataForm 
              file={uploadableFile} 
