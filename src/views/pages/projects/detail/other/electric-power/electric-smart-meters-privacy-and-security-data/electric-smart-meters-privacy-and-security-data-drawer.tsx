...
const ElectricSmartMetersPrivacyAndSecurityDataDrawer = (
  props: ElectricSmartMetersPrivacyAndSecurityDataDrawerType,
) => {
  const {
    open,
    toggle,
  ...
  const validationSchema = yup.object().shape({
    electric_smart_meters_data_id: yup
      .string()
      .required("Electric Smart Meters Data is required"),
    name: yup.string().required("Name is required"),
    privacy_measures_type_id: yup
      .string()
      .required("Privacy Measures Type is required"),
    customer_engagement_frequency_id: yup
      .string()
      .required("Customer Engagement Frequency is required"),
    customer_engagement_programs_type_id: yup
      .string()
      .required("Customer Engagement Programs Type is required"),
    ...
    resettlement_and_compensation_measures_implemented: yup
      .boolean()
      .nullable(),
  ...
  const createElectricSmartMetersPrivacyAndSecurityData = async (
    body: IApiPayload<ElectricSmartMetersPrivacyAndSecurityData>,
  ) =>
    projectOtherApiSecondService<ElectricSmartMetersPrivacyAndSecurityData>().create(
      otherSubMenu?.apiRoute || "",
      body,
    );

  const editElectricSmartMetersPrivacyAndSecurityData = async (
    body: IApiPayload<ElectricSmartMetersPrivacyAndSecurityData>,
  ) =>
  ...
  const getPayload = (values: ElectricSmartMetersPrivacyAndSecurityData) => ({
    data: {
      ...
      customer_engagement_programs_implemented:
        values.customer_engagement_programs_implemented,
      customer_engagement_programs_type_id:
        values.customer_engagement_programs_type_id,
  ...
  return (
    <CustomSideDrawer
      title={`project.other.electric-smart-meters-privacy-and-security-data.${
        isEdit
          ? `edit-electric-smart-meters-privacy-and-security-data`
          : `create-electric-smart-meters-privacy-and-security-data`
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit
              ? editElectricSmartMetersPrivacyAndSecurityData
              : createElectricSmartMetersPrivacyAndSecurityData
          }
