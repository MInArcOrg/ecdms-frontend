...
const ElectricSmartMetersPrivacyAndSecurityDataCard: React.FC<ElectricSmartMetersPrivacyAndSecurityDataCardProps> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
          <Typography variant="h5" fontWeight="bold">
            <Typography
              noWrap
              component={Button}
              onClick={() => onDetail(electricSmartMetersPrivacyAndSecurityData)}
              sx={{
                fontWeight: 500,
                textDecoration: "none",
            ...
            >
              {electricSmartMetersPrivacyAndSecurityData?.name || electricSmartMetersPrivacyAndSecurityData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-smart-meters-privacy-and-security-data.general-information")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.electric-smart-meters-data-id")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.privacy-measures-implemented")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-smart-meters-privacy-and-security-data.privacy-information")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.privacy-measures-type-id")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-smart-meters-privacy-and-security-data.customer-engagement")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.customer-engagement-frequency-id")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.customer-engagement-programs-implemented")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.customer-engagement-programs-type-id")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-smart-meters-privacy-and-security-data.social-impact")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.social-impact-assessment-conducted")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-privacy-and-security-data.details.resettlement-and-compensation-measures-implemented")}:{" "}
        ...
        {electricSmartMetersPrivacyAndSecurityData?.created_at && (
          <Typography variant="body2" color="text.secondary" mt={2}>
            {t("common.table-columns.created-at")}: {formatCreatedAt(electricSmartMetersPrivacyAndSecurityData.created_at)}
          </Typography>
        )}
      </CardContent>

      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer id={electricSmartMetersPrivacyAndSecurityData.id} type={uploadableProjectFileTypes.other.electric_smart_meters_privacy_and_security_data} />
        ...
        <Box display="flex">
          ...
          <RowOptions
            ...
            onDelete={() => onDelete(electricSmartMetersPrivacyAndSecurityData.id)}
