...
const TransmissionLineInformationCard: React.FC<TransmissionLineInformationCardProps> = ({
  ...
  return (
    <Card sx={{ p: 2 }}>
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {transmissionLineInformation?.name || transmissionLineInformation?.id.slice(0, 5) + '...'}
            </Typography>
          </Typography>
        </Box>
      ...
      <CardActions sx={{ justifyContent: 'flex-end' }}>
        <FileDrawer id={transmissionLineInformation.id} type={uploadableProjectFileTypes.other.transmissionLineInformation} />
        <ModelAction
