...
const SolarEnergyList: React.FC<SolarEnergyListProps> = ({
  model,
  projectId,
  typeId,
}) => {
  ...
  ): Promise<IApiResponse<SolarEnergy[]>> => {
  ...
  const mapSolarEnergyToDetailItems = (
    solarEnergy: SolarEnergy,
  ): { title: string; value: string }[] => [
    {
      title: t("project.other.solar-energy.details.title"),
      value: solarEnergy.title || "N/A",
    },
    {
      title: t("project.other.solar-energy.details.description"),
      value: solarEnergy.description || "N/A",
    },
    {
      title: t("project.other.solar-energy.details.specifications"),
      value: solarEnergy.specifications || "N/A",
    },
    {
      title: t("common.table-columns.created-at"),
      value: solarEnergy.created_at
        ? formatCreatedAt(solarEnergy.created_at)
        : "N/A",
    },
  ];
