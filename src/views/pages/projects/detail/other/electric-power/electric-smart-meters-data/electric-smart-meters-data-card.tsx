      ...
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {electricSmartMetersData?.owner_operator && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-data.details.owner-operator")}:{" "}
                {electricSmartMetersData.owner_operator}
              </Typography>
            </Grid>
          )}
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {electricSmartMetersData?.manufacturer && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-data.details.manufacturer")}:{" "}
                {electricSmartMetersData.manufacturer}
              </Typography>
            </Grid>
          )}
          ...
          {electricSmartMetersData?.service_area !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-data.details.service-area")}:{" "}
          ...
          {electricSmartMetersData?.installation_year !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-data.details.installation-year")}:{" "}
