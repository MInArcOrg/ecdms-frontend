...
const ElectricSmartMetersDataList: React.FC<ElectricSmartMetersDataListProps> = ({ otherSubMenu, projectId, typeId }) => {
  ...
  const mapElectricSmartMetersDataToDetailItems = (electricSmartMetersData: ElectricSmartMetersData): { title: string; value: string }[] => [
    {
    ...
    },
    {
      ...
      value: electricSmartMetersData?.service_area !== undefined 
