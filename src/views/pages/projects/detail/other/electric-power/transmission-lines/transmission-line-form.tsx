...
const TransmissionLineForm: React.FC<TransmissionLineFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomTextBox
          fullWidth
          label={t(
            "project.other.transmission-line.details.transmitting-power",
          )}
          placeholder={t(
            "project.other.transmission-line.details.transmitting-power",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={t(
            "project.other.transmission-line.details.start-northing",
          )}
          name="start_northing"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomTextBox
          ...
          placeholder={t(
            "project.other.transmission-line.details.start-easting",
          )}
          name="start_easting"
          size="small"
          sx={{ mb: 2 }}
        ...
        <CustomTextBox
          ...
          placeholder={t(
            "project.other.transmission-line.details.end-northing",
          )}
          name="end_northing"
          size="small"
          sx={{ mb: 2 }}
