    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.transmission-line.line-type")}:{" "}
            {transmissionLine.line_type || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.transmission-line.transmission-capacity")}:{" "}
            {transmissionLine.transmission_capacity ||
              t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.transmission-line.transmitting-power")}:{" "}
            {transmissionLine.transmitting_power || t("common.not-available")}
          </Typography>
          <Typography variant="body2" color="text.secondary">
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.transmissionLine}
        />
        <ModelAction
