...
export const transmissionLineColumns = (
  ...
  },
  {
    ...
    field: "name",
    renderCell: ({ row }: CellType) =>
      row.name ? row.name : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    field: "line_type",
    renderCell: ({ row }: CellType) =>
      row.line_type ? row.line_type : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    headerName: t(
      "project.other.transmission-line.details.transmission-capacity",
    ),
    field: "transmission_capacity",
    renderCell: ({ row }: CellType) =>
      row.transmission_capacity
        ? row.transmission_capacity
  ...
  },
  {
    ...
    minWidth: 150,
    headerName: t(
      "project.other.transmission-line.details.transmitting-current",
    ),
    field: "transmitting_current",
    renderCell: ({ row }: CellType) =>
      row.transmitting_current
        ? row.transmitting_current
        : t("common.not-available"),
  },
  {
    ...
    minWidth: 150,
    headerName: t(
      "project.other.transmission-line.details.transmitting-voltage",
    ),
    field: "transmitting_voltage",
    renderCell: ({ row }: CellType) =>
      row.transmitting_voltage
        ? row.transmitting_voltage
        : t("common.not-available"),
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.transmission_towers_number !== null
        ? row.transmission_towers_number
        : t("common.not-available"),
  },
  {
    flex: 0.2,
  ...
  },
  {
    ...
    field: "end_northing",
    renderCell: ({ row }: CellType) =>
      row.end_northing !== null ? row.end_northing : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    field: "end_easting",
    renderCell: ({ row }: CellType) =>
      row.end_easting !== null ? row.end_easting : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
