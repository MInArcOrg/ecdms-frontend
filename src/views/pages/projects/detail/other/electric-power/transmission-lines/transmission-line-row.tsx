...
export const transmissionLineColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.transmission_capacity ? row.transmission_capacity : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.transmitting_power ? row.transmitting_power : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.transmitting_current ? row.transmitting_current : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.transmitting_voltage ? row.transmitting_voltage : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.start_northing !== null ? row.start_northing : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    field: "start_easting",
    renderCell: ({ row }: CellType) =>
      row.start_easting !== null ? row.start_easting : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
