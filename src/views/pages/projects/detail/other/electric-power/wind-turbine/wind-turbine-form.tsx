        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <CustomTextBox
              fullWidth
              label={transl(
                "project.other.wind-turbine.details.turbine-manufacturer",
              )}
              placeholder={transl(
                "project.other.wind-turbine.details.turbine-manufacturer",
              )}
          ...
          <Grid item xs={6}>
            <CustomTextBox
              ...
              placeholder={transl(
                "project.other.wind-turbine.details.turbine-model",
              )}
              name="turbine_model"
              size="small"
              sx={{ mb: 2 }}
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <CustomTextBox
              fullWidth
              label={transl(
                "project.other.wind-turbine.details.rotor-diameter",
              )}
              placeholder={transl(
                "project.other.wind-turbine.details.rotor-diameter",
              )}
          ...
          <Grid item xs={6}>
            <CustomTextBox
              ...
              placeholder={transl(
                "project.other.wind-turbine.details.hub-height",
              )}
              name="hub_height"
              type="number"
              size="small"
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <CustomSelect
              ...
              placeholder={transl(
                "project.other.wind-turbine.details.tower-type",
              )}
              name="tower_type_id"
              size="small"
              sx={{ mb: 2 }}
          ...
          <Grid item xs={6}>
            <CustomTextBox
              ...
              placeholder={transl(
                "project.other.wind-turbine.details.blade-length",
              )}
              name="blade_length"
              type="number"
              size="small"
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <CustomTextBox
              ...
              placeholder={transl(
                "project.other.wind-turbine.details.blades-number",
              )}
              name="blades_number"
              type="number"
              size="small"
          ...
          <Grid item xs={6}>
            <CustomTextBox
              ...
              placeholder={transl(
                "project.other.wind-turbine.details.gearbox-type",
              )}
              name="gearbox_type"
              size="small"
              sx={{ mb: 2 }}
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <CustomSelect
              fullWidth
              label={transl(
                "project.other.wind-turbine.details.generator-type",
              )}
              placeholder={transl(
                "project.other.wind-turbine.details.generator-type",
              )}
          ...
          <Grid item xs={6}>
            <CustomTextBox
              fullWidth
              label={transl(
                "project.other.wind-turbine.details.generators-number",
              )}
              placeholder={transl(
                "project.other.wind-turbine.details.generators-number",
              )}
