...
const GeothermalPowerInfrastructureCard: React.FC<
  GeothermalPowerInfrastructureCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Box display="flex" flexDirection="column" gap={1} mt={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t("project.other.geothermal-power-infrastructure.details.remark")}:{" "}
            {geothermalPowerInfrastructure?.remark || "N/A"}
          </Typography>
          <Typography variant="body2" color="text.secondary">
            {t("common.table-columns.created-at")}:{" "}
            {geothermalPowerInfrastructure?.created_at
      ...
      <CardActions sx={{ justifyContent: "flex-end" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.geothermalPowerInfrastructure}
        />
        <ModelAction
