...
const RegulationAndPolicyCard: React.FC<RegulationAndPolicyCardProps> = ({
  regulationAndPolicy,
  refetch,
  onEdit,
  onDelete,
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {regulationAndPolicy?.regulatory_body_overseeing_the_facility ||
                regulationAndPolicy?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {regulationAndPolicy?.regulatory_compliance_monitoring
                ? t("common.yes")
                : t("common.no")}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {regulationAndPolicy?.licensing_and_permit_requirements
                ? t("common.yes")
                : t("common.no")}
            </Typography>
          </Grid>
        ...
        {regulationAndPolicy?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.regulation-and-policy.details.remark")}:{" "}
              {regulationAndPolicy.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.regulationAndPolicy}
        />
