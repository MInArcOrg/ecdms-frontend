...
const ElectricGridControlCenterDataDrawer = (props: ElectricGridControlCenterDataDrawerType) => {
  ...
  const validationSchema = yup.object().shape({
    ...
    control_system_type_id: yup.string().required("Control System Type is required"),
    communication_links_id: yup.string().required("Communication Links is required"),
  ...
  const onActionSuccess = async (response: IApiResponse<ElectricGridControlCenterData>, payload: IApiPayload<ElectricGridControlCenterData>) => {
  ...
  return (
    <CustomSideDrawer
      title={`project.other.electric-grid-control-center-data.${isEdit ? `edit-electric-grid-control-center-data` : `create-electric-grid-control-center-data`}`}
