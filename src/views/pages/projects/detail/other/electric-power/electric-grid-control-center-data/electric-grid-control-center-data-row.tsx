...
export const electricGridControlCenterDataColumns = (
...
): GridColDef[] => [
  {
    ...
    minWidth: 150,
    field: "name",
    headerName: t("project.other.electric-grid-control-center-data.details.name"),
  ...
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t("project.other.electric-grid-control-center-data.details.mini-grid-station-id"),
  ...
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t("project.other.electric-grid-control-center-data.details.control-system-type-id"),
    field: "control_system_type_id",
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.control_system_type_id 
          ? controlSystemTypesMap.get(row.control_system_type_id) || row.control_system_type_id 
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    flex: 0.15,
    minWidth: 120,
    headerName: t("project.other.electric-grid-control-center-data.details.installation-year"),
