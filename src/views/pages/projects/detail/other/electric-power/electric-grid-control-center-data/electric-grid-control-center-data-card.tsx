...
const ElectricGridControlCenterDataCard: React.FC<
  ElectricGridControlCenterDataCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {electricGridControlCenterData?.name ||
                electricGridControlCenterData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
