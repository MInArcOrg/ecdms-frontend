...
const ElectricDistributionTransformerCard: React.FC<
  ElectricDistributionTransformerCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {electricDistributionTransformer?.name ||
                electricDistributionTransformer?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
          ...
          {electricDistributionTransformer?.service_area !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {electricDistributionTransformer.service_area}{" "}
                {t("common.km2")}
              </Typography>
            </Grid>
          )}
