  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row?.total_outage_duration !== undefined ? `${row.total_outage_duration} ${t('common.hours')}` : t('common.not-available')}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row?.total_interruption_number !== undefined ? row.total_interruption_number : t('common.not-available')}
      </Typography>
    )
  },
  {
    ...
    field: 'saidi',
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.saidi !== undefined ? row.saidi : t('common.not-available')}</Typography>
    )
  },
  {
    flex: 0.15,
    ...
    field: 'saifi',
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.saifi !== undefined ? row.saifi : t('common.not-available')}</Typography>
    )
  },
  {
    flex: 0.15,
