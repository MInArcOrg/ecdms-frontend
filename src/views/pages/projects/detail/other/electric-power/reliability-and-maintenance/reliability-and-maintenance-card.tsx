...
const ReliabilityAndMaintenanceCard: React.FC<
  ReliabilityAndMaintenanceCardProps
> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          {reliabilityAndMaintenance?.total_outage_duration !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {reliabilityAndMaintenance.total_outage_duration}{" "}
                {t("common.hours")}
              </Typography>
            </Grid>
          )}
          ...
          {reliabilityAndMaintenance?.saidi !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.reliability-and-maintenance.details.saidi")}:{" "}
                {reliabilityAndMaintenance.saidi}
              </Typography>
            </Grid>
          )}
          ...
          {reliabilityAndMaintenance?.saifi !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.reliability-and-maintenance.details.saifi")}:{" "}
                {reliabilityAndMaintenance.saifi}
              </Typography>
            </Grid>
          )}
        ...
        {reliabilityAndMaintenance?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.reliability-and-maintenance.details.remark")}:{" "}
              {reliabilityAndMaintenance.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.reliabilityAndMaintenance}
        />
