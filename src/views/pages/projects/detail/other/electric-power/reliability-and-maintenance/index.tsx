...
const ReliabilityAndMaintenanceList: React.FC<ReliabilityAndMaintenanceListProps> = ({ otherSubMenu, projectId, typeId }) => {
  ...
  const mapReliabilityAndMaintenanceToDetailItems = (reliabilityAndMaintenance: ReliabilityAndMaintenance): { title: string; value: string }[] => [
    {
    ...
    },
    {
      ...
      value: reliabilityAndMaintenance?.total_outage_duration !== undefined 
    ...
    },
    {
      ...
      value: reliabilityAndMaintenance?.total_interruption_number !== undefined 
    ...
    },
    {
      ...
      value: reliabilityAndMaintenance?.automatic_fault_detection_restoration_system_installed !== undefined
