    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {electricDistributionTransformerType?.lifetime !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.electric-distribution-transformer-type.details.lifetime')}: {electricDistributionTransformerType.lifetime}{' '}
                {t('common.years')}
              </Typography>
            </Grid>
          )}
      ...
      <CardActions sx={{ justifyContent: 'space-between' }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.electric_distribution_transformer_type}
        />
