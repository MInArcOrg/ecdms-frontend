...
const ElectricDistributionTransformerTypeCard: React.FC<ElectricDistributionTransformerTypeCardProps> = ({
      ...
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {electricDistributionTransformerType?.name || electricDistributionTransformerType?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-distribution-transformer-type.general-information")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-distribution-transformer-type.details.mini-grid-station-id")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-distribution-transformer-type.details.transformer-type-id")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-distribution-transformer-type.technical-specifications")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-distribution-transformer-type.details.cooling-type")}:{" "}
              {electricDistributionTransformerType?.cooling_type || t("common.not-available")}
            </Typography>
          </Grid>
          ...
          {electricDistributionTransformerType?.transformer_power_rating !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-distribution-transformer-type.details.transformer-power-rating")}:{" "}
          ...
          {electricDistributionTransformerType?.lifetime !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-distribution-transformer-type.details.lifetime")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-distribution-transformer-type.safety-information")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-distribution-transformer-type.details.protection-installed-id")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-distribution-transformer-type.details.safety-problems-encountered-id")}:{" "}
          ...
          {electricDistributionTransformerType?.work_accidents_number !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-distribution-transformer-type.details.work-accidents-number")}:{" "}
          ...
          {electricDistributionTransformerType?.on_site_safety_regulation_implemented !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-distribution-transformer-type.details.on-site-safety-regulation-implemented")}:{" "}
        ...
        {electricDistributionTransformerType?.created_at && (
          <Typography variant="body2" color="text.secondary" mt={2}>
            {t("common.table-columns.created-at")}: {formatCreatedAt(electricDistributionTransformerType.created_at)}
          </Typography>
        )}
      </CardContent>

      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer id={electricDistributionTransformerType.id} type={uploadableProjectFileTypes.other.electric_distribution_transformer_type} />
