...
const TransmissionLineEquipmentDataCard: React.FC<
  TransmissionLineEquipmentDataCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {transmissionLineEquipmentData?.name ||
                transmissionLineEquipmentData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
