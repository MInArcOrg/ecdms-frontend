  ...
  return (
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          {transmissionLineEquipmentData?.insulator_type && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.transmission-line-equipment-data.details.insulator-type')}: {transmissionLineEquipmentData.insulator_type}
              </Typography>
            </Grid>
          )}
          ...
          {transmissionLineEquipmentData?.opgw_uts !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.transmission-line-equipment-data.details.opgw-uts')}: {transmissionLineEquipmentData.opgw_uts}
              </Typography>
            </Grid>
          )}
        </Grid>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {transmissionLineEquipmentData?.owner_operator && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.transmission-line-equipment-data.details.owner-operator')}: {transmissionLineEquipmentData.owner_operator}
              </Typography>
            </Grid>
          )}
        </Grid>
        ...
        {transmissionLineEquipmentData?.other_equipment && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t('project.other.transmission-line-equipment-data.details.other-equipment')}: {transmissionLineEquipmentData.other_equipment}
            </Typography>
          </Box>
        )}
        ...
        {transmissionLineEquipmentData?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t('project.other.transmission-line-equipment-data.details.remark')}: {transmissionLineEquipmentData.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: 'space-between' }}>
        <FileDrawer id={transmissionLineEquipmentData.id} type={uploadableProjectFileTypes.other.transmissionLineEquipmentData} />
