      ...
      <Grid item xs={12}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <CustomSelect
              fullWidth
              required
              label={transl("project.other.electric-grid-control-center-performance-and-maintenance.details.electric-grid-control-center-data-id")}
        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <CustomTextBox
              fullWidth
              label={transl("project.other.electric-grid-control-center-performance-and-maintenance.details.total-system-downtime-outage-duration")}
              placeholder={transl("project.other.electric-grid-control-center-performance-and-maintenance.details.total-system-downtime-outage-duration")}
          ...
          <Grid item xs={12}>
            <CustomTextBox
              ...
              placeholder={transl("project.other.electric-grid-control-center-performance-and-maintenance.details.total-interruptions-number")}
