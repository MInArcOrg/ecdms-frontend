...
const ElectricGridControlCenterPerformanceAndMaintenanceList: React.FC<ElectricGridControlCenterPerformanceAndMaintenanceListProps> = ({
  otherSubMenu,
  projectId,
  typeId
}) => {
  ...
  ): Promise<IApiResponse<ElectricGridControlCenterPerformanceAndMaintenance[]>> => {
  ...
  const mapElectricGridControlCenterPerformanceAndMaintenanceToDetailItems = (
    ...
    },
    {
      ...
      value: electricGridControlCenterPerformanceAndMaintenance?.electric_grid_control_center_data_id
        ? electricGridControlCenterDataMap.get(electricGridControlCenterPerformanceAndMaintenance.electric_grid_control_center_data_id) ||
    ...
    },
    {
      ...
      value: electricGridControlCenterPerformanceAndMaintenance?.maintenance_frequency_id
        ? maintenanceFrequenciesMap.get(electricGridControlCenterPerformanceAndMaintenance.maintenance_frequency_id) ||
    ...
    },
    {
      ...
      value: electricGridControlCenterPerformanceAndMaintenance?.created_at
        ? formatCreatedAt(electricGridControlCenterPerformanceAndMaintenance.created_at)
        : 'N/A'
    },
    {
      title: t('common.table-columns.updated-at'),
      value: electricGridControlCenterPerformanceAndMaintenance?.updated_at
        ? formatCreatedAt(electricGridControlCenterPerformanceAndMaintenance.updated_at)
        : 'N/A'
    }
  ];
