    ...
    <Card sx={{ p: 2 }}>
          ...
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {electricGridControlCenterPerformanceAndMaintenance?.name ||
                electricGridControlCenterPerformanceAndMaintenance?.id.slice(0, 8) + '...'}
            </Typography>
          </Typography>
        </Box>
      ...
      <CardActions sx={{ justifyContent: 'space-between' }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.electric_grid_control_center_performance_and_maintenance}
        />
