...
const ElectricGridControlCenterPerformanceAndMaintenanceCard: React.FC<
  ElectricGridControlCenterPerformanceAndMaintenanceCardProps
> = ({
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            <Typography
              ...
              component={Button}
              onClick={() =>
                onDetail(electricGridControlCenterPerformanceAndMaintenance)
              }
              sx={{
                fontWeight: 500,
                textDecoration: "none",
            ...
            >
              {electricGridControlCenterPerformanceAndMaintenance?.name ||
                electricGridControlCenterPerformanceAndMaintenance?.id.slice(
                  0,
                  8,
                ) + "..."}
            </Typography>
        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {electricGridControlCenterPerformanceAndMaintenance?.saidi ||
                t("common.not-available")}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {electricGridControlCenterPerformanceAndMaintenance?.saifi ||
                t("common.not-available")}
            </Typography>
          </Grid>
        </Grid>
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        ...
        <Box display="flex">
          ...
          <RowOptions
            ...
            onEdit={() =>
              onEdit(electricGridControlCenterPerformanceAndMaintenance)
            }
            onDelete={() =>
              onDelete(electricGridControlCenterPerformanceAndMaintenance.id)
            }
