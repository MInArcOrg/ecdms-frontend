...
const ElectricGridControlCenterCyberSecurityDataDrawer = (
  props: ElectricGridControlCenterCyberSecurityDataDrawerType,
) => {
  const {
    open,
    toggle,
  ...
  const createElectricGridControlCenterCyberSecurityData = async (
    body: IApiPayload<ElectricGridControlCenterCyberSecurityData>,
  ) =>
    projectOtherApiSecondService<ElectricGridControlCenterCyberSecurityData>().create(
      otherSubMenu?.apiRoute || "",
      body,
    );

  const editElectricGridControlCenterCyberSecurityData = async (
    body: IApiPayload<ElectricGridControlCenterCyberSecurityData>,
  ) =>
  ...
  const onActionSuccess = async (
    response: IApiResponse<ElectricGridControlCenterCyberSecurityData>,
    payload: IApiPayload<ElectricGridControlCenterCyberSecurityData>,
  ) => {
  ...
  return (
    <CustomSideDrawer
      title={`project.other.electric-grid-control-center-cyber-security-data.${
        isEdit
          ? `edit-electric-grid-control-center-cyber-security-data`
          : `create-electric-grid-control-center-cyber-security-data`
      }`}
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit
              ? editElectricGridControlCenterCyberSecurityData
              : createElectricGridControlCenterCyberSecurityData
          }
        ...
        >
          {(
            ...
            return (
              <ElectricGridControlCenterCyberSecurityDataForm
                file={uploadableFile}
