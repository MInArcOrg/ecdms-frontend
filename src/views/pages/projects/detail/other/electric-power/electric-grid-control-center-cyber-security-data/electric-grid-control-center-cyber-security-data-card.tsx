...
interface ElectricGridControlCenterCyberSecurityDataCardProps {
  ...
  refetch: () => void
  onEdit: (electricGridControlCenterCyberSecurityData: ElectricGridControlCenterCyberSecurityData) => void
  onDelete: (id: string) => void
  onDetail: (electricGridControlCenterCyberSecurityData: ElectricGridControlCenterCyberSecurityData) => void
...
const ElectricGridControlCenterCyberSecurityDataCard: React.FC<ElectricGridControlCenterCyberSecurityDataCardProps> = ({
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
          <Typography variant="h5" fontWeight="bold">
            <Typography
              noWrap
              component={Button}
              onClick={() => onDetail(electricGridControlCenterCyberSecurityData)}
              sx={{
                fontWeight: 500,
                textDecoration: "none",
            ...
            >
              {electricGridControlCenterCyberSecurityData?.name || electricGridControlCenterCyberSecurityData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-grid-control-center-cyber-security-data.general-information")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={12}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-grid-control-center-cyber-security-data.details.electric-grid-control-center-data-id")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-grid-control-center-cyber-security-data.cyber-security")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-grid-control-center-cyber-security-data.details.cyber-security-measures-implemented")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-grid-control-center-cyber-security-data.details.cyber-security-measures-type")}:{" "}
        ...
        <Grid container spacing={2} mt={1}>
          <Grid item xs={12}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-grid-control-center-cyber-security-data.details.cyber-security-audits-frequency")}:{" "}
        ...
        {electricGridControlCenterCyberSecurityData?.created_at && (
          <Typography variant="body2" color="text.secondary" mt={2}>
            {t("common.table-columns.created-at")}: {formatCreatedAt(electricGridControlCenterCyberSecurityData.created_at)}
          </Typography>
        )}
      </CardContent>

      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer id={electricGridControlCenterCyberSecurityData.id} type={uploadableProjectFileTypes.other.electric_grid_control_center_cyber_security_data} />
        ...
        <Box display="flex">
          ...
          <RowOptions
            ...
            onDelete={() => onDelete(electricGridControlCenterCyberSecurityData.id)}
