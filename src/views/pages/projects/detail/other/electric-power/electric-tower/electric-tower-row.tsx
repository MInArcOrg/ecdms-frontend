...
export const electricTowerColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.transmissionline_id ? row.transmissionline_id : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.overall_length !== null ? row.overall_length?.toString() : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.embedded_length !== null ? row.embedded_length?.toString() : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    field: "columns",
    renderCell: ({ row }: CellType) =>
      row.columns ? row.columns : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    field: "braces",
    renderCell: ({ row }: CellType) =>
      row.braces ? row.braces : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.beam_cross_arms ? row.beam_cross_arms : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.brace_cross_arm ? row.brace_cross_arm : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.elasticity_modulus ? row.elasticity_modulus : t("common.not-available"),
  },
  {
    flex: 0.2,
    minWidth: 150,
    ...
    renderCell: ({ row }: CellType) =>
      row.poission_ratio ? row.poission_ratio : t("common.not-available"),
  },
