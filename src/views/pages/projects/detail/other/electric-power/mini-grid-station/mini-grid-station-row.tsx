  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row?.minigrid_size !== undefined ? `${row.minigrid_size} ${t('common.kw')}` : t('common.not-available')}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row?.battery_size !== undefined ? `${row.battery_size} ${t('common.kwh')}` : t('common.not-available')}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>
        {row?.inverter !== undefined ? `${row.inverter} ${t('common.kw')}` : t('common.not-available')}
      </Typography>
    )
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: 'text.secondary' }}>{row?.diesel_generator || t('common.not-available')}</Typography>
    )
  },
  {
    flex: 0.15,
