...
const TurbineInfoForm: React.FC<TurbineInfoFormProps> = ({
  formik,
  file,
  onFileChange,
  projectId,
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <CustomTextBox
          ...
          placeholder={t(
            "project.other.turbine-info.details.generating-capacity",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={t(
            "project.other.turbine-info.details.designed-quantity",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={t(
            "project.other.turbine-info.details.installed-quantity",
          )}
        ...
        <CustomTextBox
          ...
          placeholder={t(
            "project.other.turbine-info.details.functional-quantity",
          )}
