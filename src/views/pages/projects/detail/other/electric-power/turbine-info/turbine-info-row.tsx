...
export const turbineInfoColumns = (
  ...
  },
  {
    ...
    field: "turbine_type",
    renderCell: ({ row }: CellType) =>
      row.turbine_type ? row.turbine_type : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.generating_capacity
        ? `${row.generating_capacity} MW`
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.designed_quantity
        ? `${row.designed_quantity} units`
        : t("common.not-available"),
  },
  {
    flex: 0.15,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.functional_quantity
        ? `${row.functional_quantity} units`
        : t("common.not-available"),
  },
  {
    flex: 0.15,
    ...
    field: "detail",
    renderCell: ({ row }: CellType) =>
      row.detail ? row.detail : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
