...
const TurbineInfoList: React.FC<TurbineInfoListProps> = ({
  model,
  projectId,
  typeId,
}) => {
  ...
  ): Promise<IApiResponse<TurbineInfo[]>> => {
  ...
  const mapTurbineInfoToDetailItems = (
    turbineInfo: TurbineInfo,
  ): { title: string; value: string }[] => [
    {
      title: t("project.other.turbine-info.details.name"),
      value: turbineInfo.name || "N/A",
    },
    {
      title: t("project.other.turbine-info.details.turbine-type"),
      value: turbineInfo.turbine_type || "N/A",
    },
    {
      title: t("project.other.turbine-info.details.generating-capacity"),
      value: turbineInfo.generating_capacity || "N/A",
    },
    {
      title: t("project.other.turbine-info.details.designed-quantity"),
      value: turbineInfo.designed_quantity || "N/A",
    },
    {
      title: t("project.other.turbine-info.details.installed-quantity"),
      value: turbineInfo.installed_quantity || "N/A",
    },
    {
      title: t("project.other.turbine-info.details.functional-quantity"),
      value: turbineInfo.functional_quantity || "N/A",
    },
    {
      title: t("common.table-columns.created-at"),
      value: turbineInfo.created_at
        ? formatCreatedAt(turbineInfo.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: turbineInfo.updated_at
        ? formatCreatedAt(turbineInfo.updated_at)
        : "N/A",
    },
  ];
