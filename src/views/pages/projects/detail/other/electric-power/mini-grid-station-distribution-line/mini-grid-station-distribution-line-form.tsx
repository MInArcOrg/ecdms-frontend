...
const MiniGridStationDistributionLineForm: React.FC<
  MiniGridStationDistributionLineFormProps
    ...
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        <Typography variant="subtitle1" gutterBottom>
          {transl(
            "project.other.mini-grid-station-distribution-line.general-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.mini-grid-station-distribution-line.line-specifications",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.mini-grid-station-distribution-line.transformer-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.mini-grid-station-distribution-line.additional-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
