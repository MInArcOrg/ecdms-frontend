...
const TransmissionLineConductorAndTowerDataList: React.FC<TransmissionLineConductorAndTowerDataListProps> = ({ otherSubMenu, projectId, typeId }) => {
  ...
  const handleDelete = async (transmissionLineConductorAndTowerDataId: string) => {
    await projectOtherApiSecondService<TransmissionLineConductorAndTowerData>().delete(otherSubMenu?.apiRoute || "", transmissionLineConductorAndTowerDataId)
    refetch()
  }
  ...
  const mapTransmissionLineConductorAndTowerDataToDetailItems = (transmissionLineConductorAndTowerData: TransmissionLineConductorAndTowerData): { title: string; value: string }[] => [
    {
    ...
    },
    {
      ...
      value: transmissionLineConductorAndTowerData?.strands_number !== undefined 
    ...
    },
    {
      ...
      value: transmissionLineConductorAndTowerData?.conductor_size !== undefined 
    ...
    },
    {
      ...
      value: transmissionLineConductorAndTowerData?.conductors_per_phase_number !== undefined 
    ...
    },
    {
      ...
      value: transmissionLineConductorAndTowerData?.tower_height !== undefined 
    ...
    },
    {
      ...
      value: transmissionLineConductorAndTowerData?.conductor_diameter !== undefined 
    ...
    },
    {
      ...
      value: transmissionLineConductorAndTowerData?.each_strand_diameter !== undefined 
