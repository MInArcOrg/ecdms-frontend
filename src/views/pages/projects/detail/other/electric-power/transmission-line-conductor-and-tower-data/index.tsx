...
const TransmissionLineConductorAndTowerDataList: React.FC<
  TransmissionLineConductorAndTowerDataListProps
> = ({ otherSubMenu, projectId, typeId }) => {
  const [showDrawer, setShowDrawer] = useState(false);
  const [showDetailDrawer, setShowDetailDrawer] = useState(false);
  const [selectedRow, setSelectedRow] =
    useState<TransmissionLineConductorAndTowerData | null>(null);
  ...
  const fetchTransmissionLineConductorAndTowerDatas = (
    ...
    return projectOtherApiSecondService<TransmissionLineConductorAndTowerData>().getAll(
  ...
  const handleDelete = async (
    transmissionLineConductorAndTowerDataId: string,
  ) => {
  ...
  const mapTransmissionLineConductorAndTowerDataToDetailItems = (
    ...
    },
    {
      ...
      value:
        transmissionLineConductorAndTowerData?.transmission_line_id || "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value:
        transmissionLineConductorAndTowerData?.conductor_code_name_id || "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value:
        transmissionLineConductorAndTowerData?.conductor_size !== undefined
          ? `${transmissionLineConductorAndTowerData.conductor_size} ${t(
              "common.mm2",
            )}`
          : "N/A",
    },
    ...
    },
    {
      ...
      value:
        transmissionLineConductorAndTowerData?.tower_height !== undefined
          ? `${transmissionLineConductorAndTowerData.tower_height} ${t(
              "common.meters",
            )}`
          : "N/A",
    },
    {
      ...
      value:
        transmissionLineConductorAndTowerData?.conductor_diameter !== undefined
          ? `${transmissionLineConductorAndTowerData.conductor_diameter} ${t(
              "common.mm",
            )}`
          : "N/A",
    },
    {
      ...
      value:
        transmissionLineConductorAndTowerData?.each_strand_diameter !==
        undefined
          ? `${transmissionLineConductorAndTowerData.each_strand_diameter} ${t(
              "common.mm",
            )}`
          : "N/A",
    },
    {
      ...
      value:
        transmissionLineConductorAndTowerData?.tower_foundation_type_id ||
        "N/A",
    },
    {
      title: t(
    ...
    },
    {
      ...
      value: transmissionLineConductorAndTowerData?.created_at
        ? formatCreatedAt(transmissionLineConductorAndTowerData.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: transmissionLineConductorAndTowerData?.updated_at
        ? formatCreatedAt(transmissionLineConductorAndTowerData.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      {showDrawer && (
        <TransmissionLineConductorAndTowerDataDrawer
          ...
          toggle={toggleDrawer}
          transmissionLineConductorAndTowerData={
            selectedRow as TransmissionLineConductorAndTowerData
          }
          refetch={refetch}
          projectId={projectId}
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapTransmissionLineConductorAndTowerDataToDetailItems(
            selectedRow as TransmissionLineConductorAndTowerData,
          )}
          hasReference={true}
          id={selectedRow?.id || ""}
          ...
          title={t(
            "project.other.transmission-line-conductor-and-tower-data.transmission-line-conductor-and-tower-data-details",
          )}
        />
      )}
      ...
      <ItemsListing
        title={t(
          "project.other.transmission-line-conductor-and-tower-data.title",
        )}
        pagination={pagination}
        type={ITEMS_LISTING_TYPE.table.value}
        tableProps={{
          headers: transmissionLineConductorAndTowerDataColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
