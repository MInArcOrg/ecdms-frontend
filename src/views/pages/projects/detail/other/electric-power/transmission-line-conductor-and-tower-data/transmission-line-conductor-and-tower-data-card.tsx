    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        {transmissionLineConductorAndTowerData?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t('project.other.transmission-line-conductor-and-tower-data.details.remark')}: {transmissionLineConductorAndTowerData.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: 'space-between' }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.transmissionLineConductorAndTowerData}
        />
