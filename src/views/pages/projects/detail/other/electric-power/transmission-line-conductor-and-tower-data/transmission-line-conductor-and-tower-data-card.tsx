...
const TransmissionLineConductorAndTowerDataCard: React.FC<
  TransmissionLineConductorAndTowerDataCardProps
> = ({
      ...
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {transmissionLineConductorAndTowerData?.name ||
                transmissionLineConductorAndTowerData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {transmissionLineConductorAndTowerData?.conductor_size !==
            undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t(
        ...
        <Grid container spacing={2} mt={1}>
          {transmissionLineConductorAndTowerData?.tower_height !==
            undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t(
          ...
          {transmissionLineConductorAndTowerData?.conductor_diameter !==
            undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t(
