...
const ElectricSmartMetersPerformanceDataCard: React.FC<ElectricSmartMetersPerformanceDataCardProps> = ({
      ...
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {electricSmartMetersPerformanceData?.name || electricSmartMetersPerformanceData?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-smart-meters-performance-data.general-information")}
        </Typography>

        <Grid container spacing={2} mt={1}>
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-performance-data.details.electric-smart-meters-data-id")}:{" "}
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.electric-smart-meters-performance-data.details.maintenance-frequency-id")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-smart-meters-performance-data.technical-specifications")}
        </Typography>
        ...
        <Grid container spacing={2} mt={1}>
          {electricSmartMetersPerformanceData?.average_meter_lifespan !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-performance-data.details.average-meter-lifespan")}:{" "}
          ...
          {electricSmartMetersPerformanceData?.average_meter_accuracy !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-performance-data.details.average-meter-accuracy")}:{" "}
        ...
        <Typography variant="subtitle1" mt={2} fontWeight="bold">
          {t("project.other.electric-smart-meters-performance-data.safety-information")}
        </Typography>
        ...
        <Grid container spacing={2} mt={1}>
          {electricSmartMetersPerformanceData?.safety_problems_encountered && (
            <Grid item xs={12}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-performance-data.details.safety-problems-encountered")}:{" "}
                {electricSmartMetersPerformanceData.safety_problems_encountered}
              </Typography>
            </Grid>
          )}
          ...
          {electricSmartMetersPerformanceData?.work_accidents_number !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-performance-data.details.work-accidents-number")}:{" "}
          ...
          {electricSmartMetersPerformanceData?.on_site_safety_regulation_implemented !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.electric-smart-meters-performance-data.details.on-site-safety-regulation-implemented")}:{" "}
                {electricSmartMetersPerformanceData.on_site_safety_regulation_implemented ? t("common.yes") : t("common.no")}
              </Typography>
            </Grid>
          )}
        </Grid>
        ...
        {electricSmartMetersPerformanceData?.created_at && (
          <Typography variant="body2" color="text.secondary" mt={2}>
            {t("common.table-columns.created-at")}: {formatCreatedAt(electricSmartMetersPerformanceData.created_at)}
          </Typography>
        )}
      </CardContent>

      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer id={electricSmartMetersPerformanceData.id} type={uploadableProjectFileTypes.other.electric_smart_meters_performance_data} />
