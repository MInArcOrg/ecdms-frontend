...
const ElectricSmartMetersPerformanceDataForm: React.FC<
  ElectricSmartMetersPerformanceDataFormProps
> = ({
  formik,
  file,
  onFileChange,
  ...
  return (
    <Grid container spacing={gridSpacing}>
      <Grid item xs={12}>
        ...
        <Typography variant="subtitle1" gutterBottom sx={{ mt: 2 }}>
          {transl(
            "project.other.electric-smart-meters-performance-data.additional-information",
          )}
        </Typography>
        <Divider sx={{ mb: 2 }} />
