...
const ElectricSmartMetersPerformanceDataList: React.FC<ElectricSmartMetersPerformanceDataListProps> = ({ otherSubMenu, projectId, typeId }) => {
  const [showDrawer, setShowDrawer] = useState(false)
  const [showDetailDrawer, setShowDetailDrawer] = useState(false)
  const [selectedRow, setSelectedRow] = useState<ElectricSmartMetersPerformanceData | null>(null)
  ...
  const fetchElectricSmartMetersPerformanceData = (params: GetRequestParam): Promise<IApiResponse<ElectricSmartMetersPerformanceData[]>> => {
    return projectOtherApiSecondService<ElectricSmartMetersPerformanceData>().getAll(otherSubMenu?.apiRoute || "", {})
  }
  ...
  const handleEdit = (electricSmartMetersPerformanceData: ElectricSmartMetersPerformanceData) => {
    toggleDrawer()
    setSelectedRow(electricSmartMetersPerformanceData)
  }

  const handleDelete = async (electricSmartMetersPerformanceDataId: string) => {
    await projectOtherApiSecondService<ElectricSmartMetersPerformanceData>().delete(otherSubMenu?.apiRoute || "", electricSmartMetersPerformanceDataId)
    refetch()
  }

  const handleClickDetail = (electricSmartMetersPerformanceData: ElectricSmartMetersPerformanceData) => {
    toggleDetailDrawer()
    setSelectedRow(electricSmartMetersPerformanceData)
  }
  ...
  const mapElectricSmartMetersPerformanceDataToDetailItems = (electricSmartMetersPerformanceData: ElectricSmartMetersPerformanceData): { title: string; value: string }[] => [
    {
    ...
    },
    {
      ...
      value: electricSmartMetersPerformanceData?.electric_smart_meters_data_id 
        ? electricSmartMetersDataMap.get(electricSmartMetersPerformanceData.electric_smart_meters_data_id) || electricSmartMetersPerformanceData.electric_smart_meters_data_id 
        : "N/A",
    },
    {
      ...
      value: electricSmartMetersPerformanceData?.maintenance_frequency_id 
        ? maintenanceFrequenciesMap.get(electricSmartMetersPerformanceData.maintenance_frequency_id) || electricSmartMetersPerformanceData.maintenance_frequency_id 
        : "N/A",
    },
    {
      title: t("project.other.electric-smart-meters-performance-data.details.average-meter-lifespan"),
      value: electricSmartMetersPerformanceData?.average_meter_lifespan !== undefined 
    ...
    },
    {
      ...
      value: electricSmartMetersPerformanceData?.average_meter_accuracy !== undefined 
    ...
    },
    {
      ...
      value: electricSmartMetersPerformanceData?.work_accidents_number !== undefined 
    ...
    },
    {
      ...
      value: electricSmartMetersPerformanceData?.on_site_safety_regulation_implemented !== undefined 
    ...
    <Box>
      {showDrawer && (
        <ElectricSmartMetersPerformanceDataDrawer
          ...
          open={showDrawer}
          toggle={toggleDrawer}
          electricSmartMetersPerformanceData={selectedRow as ElectricSmartMetersPerformanceData}
          refetch={refetch}
          projectId={projectId}
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          data={mapElectricSmartMetersPerformanceDataToDetailItems(selectedRow as ElectricSmartMetersPerformanceData)}
          hasReference={true}
          id={selectedRow?.id || ""}
          fileType={uploadableProjectFileTypes.other.electric_smart_meters_performance_data}
          title={t("project.other.electric-smart-meters-performance-data.electric-smart-meters-performance-data-details")}
        />
      )}
