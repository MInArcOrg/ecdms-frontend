...
const EnvironmentalAndSocialImpactList: React.FC<EnvironmentalAndSocialImpactListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  const mapEnvironmentalAndSocialImpactToDetailItems = (
    ...
    },
    {
      ...
      value: environmentalAndSocialImpact?.resettlement_and_compensation_measures_implemented
        ? t("common.yes")
        : t("common.no"),
    },
    {
