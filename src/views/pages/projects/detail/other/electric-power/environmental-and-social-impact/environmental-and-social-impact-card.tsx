...
const EnvironmentalAndSocialImpactCard: React.FC<
  EnvironmentalAndSocialImpactCardProps
> = ({ environmentalAndSocialImpact, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {environmentalAndSocialImpact?.mitigation_measures_implemented
                ? t("common.yes")
                : t("common.no")}
            </Typography>
          </Grid>
          ...
          <Grid item xs={6}>
            <Typography variant="body2" color="text.secondary">
              ...
              :{" "}
              {environmentalAndSocialImpact?.social_impact_assessment_conducted
                ? t("common.yes")
                : t("common.no")}
            </Typography>
          </Grid>
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.environmentalAndSocialImpact}
        />
