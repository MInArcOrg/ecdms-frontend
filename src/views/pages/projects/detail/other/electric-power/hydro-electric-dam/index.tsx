...
const HydroElectricDamList: React.FC<HydroElectricDamListProps> = ({
  otherSubMenu,
  projectId,
  typeId,
}) => {
  ...
  ): Promise<IApiResponse<HydroElectricDam[]>> => {
    return projectOtherApiSecondService<HydroElectricDam>().getAll(
  ...
  const handleDelete = async (hydroElectricDamId: string) => {
    await projectOtherApiSecondService<HydroElectricDam>().delete(
      otherSubMenu?.apiRoute || "",
      hydroElectricDamId,
    );
    refetch();
  ...
  const mapHydroElectricDamToDetailItems = (
    hydroElectricDam: HydroElectricDam,
  ): { title: string; value: string }[] => [
    {
      title: t("project.other.hydro-electric-dam.details.river-name"),
      value: hydroElectricDam.river_name || "N/A",
    },
    {
      title: t(
    ...
    {
      title: t("project.other.hydro-electric-dam.details.elevation-from-ngl"),
      value: hydroElectricDam.elevation_from_ngl || "N/A",
    },
    {
      title: t("project.other.hydro-electric-dam.details.dam-type"),
      value: hydroElectricDam.dam_type || "N/A",
    },
    {
      title: t("project.other.hydro-electric-dam.details.dam-volume"),
      value: hydroElectricDam.dam_volume || "N/A",
    },
    {
    ...
    },
    {
      ...
      value: hydroElectricDam.created_at
        ? formatCreatedAt(hydroElectricDam.created_at)
        : "N/A",
    },
    {
      title: t("common.table-columns.updated-at"),
      value: hydroElectricDam.updated_at
        ? formatCreatedAt(hydroElectricDam.updated_at)
        : "N/A",
    },
  ];
    ...
    <Box>
      ...
      {showDetailDrawer && (
        <OtherDetailSidebar
          ...
          title={t(
            "project.other.hydro-electric-dam.hydro-electric-dam-details",
          )}
        />
      )}
      ...
      <ItemsListing
        ...
        tableProps={{
          headers: hydroElectricDamColumns(
            handleClickDetail,
            handleEdit,
            handleDelete,
            t,
