...
export const hydroElectricDamColumns = (
  ...
  },
  {
    ...
    field: "river_name",
    renderCell: ({ row }: CellType) =>
      row.river_name ? row.river_name : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    renderCell: ({ row }: CellType) =>
      row.elevation_from_sea_level ? `${row.elevation_from_sea_level} m` : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    renderCell: ({ row }: CellType) =>
      row.elevation_from_ngl ? `${row.elevation_from_ngl} m` : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    field: "dam_type",
    renderCell: ({ row }: CellType) =>
      row.dam_type ? row.dam_type : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    field: "dam_volume",
    renderCell: ({ row }: CellType) =>
      row.dam_volume ? `${row.dam_volume} cubic meters` : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    renderCell: ({ row }: CellType) =>
      row.gated_spillway_no !== undefined ? row.gated_spillway_no : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
    ...
    renderCell: ({ row }: CellType) =>
      row.none_gated_spillway_no !== undefined ? row.none_gated_spillway_no : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 120,
