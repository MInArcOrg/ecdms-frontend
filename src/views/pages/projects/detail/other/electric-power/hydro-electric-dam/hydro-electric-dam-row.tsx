...
export const hydroElectricDamColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.elevation_from_sea_level
        ? `${row.elevation_from_sea_level} m`
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.elevation_from_ngl
        ? `${row.elevation_from_ngl} m`
        : t("common.not-available"),
  },
  {
    flex: 0.15,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.gated_spillway_no !== undefined
        ? row.gated_spillway_no
        : t("common.not-available"),
  },
  {
    flex: 0.15,
    ...
    renderCell: ({ row }: CellType) =>
      row.none_gated_spillway_no !== undefined
        ? row.none_gated_spillway_no
        : t("common.not-available"),
  },
  {
    flex: 0.15,
