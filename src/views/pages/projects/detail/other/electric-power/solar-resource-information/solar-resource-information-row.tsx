...
export const solarResourceInformationColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.annual_solar_radiation !== undefined
          ? `${row.annual_solar_radiation} ${t("common.kwh-per-m2")}`
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.solar_panel_efficiency !== undefined
          ? `${row.solar_panel_efficiency}%`
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.annual_energy_production !== undefined
          ? `${row.annual_energy_production} ${t("common.mwh")}`
          : t("common.not-available")}
      </Typography>
    ),
  },
