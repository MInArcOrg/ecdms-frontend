      ...
      <CardContent>
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={1}>
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {t('project.other.solar-resource-information.solar-resource-record')} - {solarResourceInformation?.id.slice(0, 8) + '...'}
            </Typography>
          </Typography>
        </Box>
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {solarResourceInformation?.plant_life !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t('project.other.solar-resource-information.details.plant-life')}: {solarResourceInformation.plant_life}{' '}
                {t('common.years')}
              </Typography>
            </Grid>
          )}
