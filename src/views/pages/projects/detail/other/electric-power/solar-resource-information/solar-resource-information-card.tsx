...
const SolarResourceInformationCard: React.FC<
  SolarResourceInformationCardProps
> = ({ solarResourceInformation, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {t(
                "project.other.solar-resource-information.solar-resource-record",
              )}{" "}
        ...
        <Grid container spacing={2} mt={1}>
          {solarResourceInformation?.annual_solar_radiation !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {solarResourceInformation.annual_solar_radiation}{" "}
                {t("common.kwh-per-m2")}
              </Typography>
            </Grid>
          )}
          ...
          {solarResourceInformation?.annual_energy_production !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {solarResourceInformation.annual_energy_production}{" "}
                {t("common.mwh")}
              </Typography>
            </Grid>
          )}
          ...
          {solarResourceInformation?.plant_life !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t(
                  "project.other.solar-resource-information.details.plant-life",
                )}
        ...
        {solarResourceInformation?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.solar-resource-information.details.remark")}:{" "}
              {solarResourceInformation.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.solarResourceInformation}
        />
