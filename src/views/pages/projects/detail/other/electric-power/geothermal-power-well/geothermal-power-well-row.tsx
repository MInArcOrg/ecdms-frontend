...
export const geothermalPowerWellColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.temperature_at_bottom_hole !== undefined
          ? `${row.temperature_at_bottom_hole} °C`
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.drilling_period
          ? formatDate(row.drilling_period)
          : t("common.not-available")}
      </Typography>
    ),
  },
