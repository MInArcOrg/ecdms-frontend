...
export const miniGridStationConsumerColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.commercial !== undefined ? row.commercial : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.expected_electricity_sales !== undefined
          ? `${row.expected_electricity_sales} ${t("common.kwh")}`
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.electricity_tariff !== undefined
          ? `${row.electricity_tariff} ${t("common.currency")}`
          : t("common.not-available")}
      </Typography>
    ),
  },
