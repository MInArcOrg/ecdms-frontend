      ...
      <CardContent>
        ...
        <Grid container spacing={2} mt={1}>
          {miniGridStationConsumer?.residential !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.mini-grid-station-consumer.details.residential")}:{" "}
          ...
          {miniGridStationConsumer?.commercial !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.mini-grid-station-consumer.details.commercial")}:{" "}
          ...
          {miniGridStationConsumer?.health_centers !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.mini-grid-station-consumer.details.health-centers")}:{" "}
        ...
        <Grid container spacing={2} mt={1}>
          ...
          {miniGridStationConsumer?.electricity_tariff !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t("project.other.mini-grid-station-consumer.details.electricity-tariff")}:{" "}
