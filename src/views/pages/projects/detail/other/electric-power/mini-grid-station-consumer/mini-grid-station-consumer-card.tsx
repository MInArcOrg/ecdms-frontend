...
const MiniGridStationConsumerCard: React.FC<
  MiniGridStationConsumerCardProps
> = ({ miniGridStationConsumer, refetch, onEdit, onDelete, onDetail }) => {
    ...
    <Card sx={{ p: 2 }}>
      <CardContent>
        ...
        >
          <Typography variant="h5" fontWeight="bold">
            ...
            >
              {miniGridStationConsumer?.name ||
                miniGridStationConsumer?.id.slice(0, 8) + "..."}
            </Typography>
          </Typography>
        </Box>
          ...
          {miniGridStationConsumer?.residential !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {miniGridStationConsumer.residential}
              </Typography>
            </Grid>
          )}
          ...
          {miniGridStationConsumer?.commercial !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {miniGridStationConsumer.commercial}
              </Typography>
            </Grid>
          )}
          ...
          {miniGridStationConsumer?.health_centers !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {miniGridStationConsumer.health_centers}
              </Typography>
            </Grid>
          )}
        </Grid>
        ...
        <Grid container spacing={2} mt={1}>
          {miniGridStationConsumer?.expected_electricity_sales !==
            undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                {t(
          ...
          {miniGridStationConsumer?.electricity_tariff !== undefined && (
            <Grid item xs={6}>
              <Typography variant="body2" color="text.secondary">
                ...
                : {miniGridStationConsumer.electricity_tariff}{" "}
                {t("common.currency")}
              </Typography>
            </Grid>
          )}
        ...
        {miniGridStationConsumer?.remark && (
          <Box mt={2}>
            <Typography variant="body2" color="text.secondary">
              {t("project.other.mini-grid-station-consumer.details.remark")}:{" "}
              {miniGridStationConsumer.remark}
            </Typography>
          </Box>
        )}
      ...
      <CardActions sx={{ justifyContent: "space-between" }}>
        <FileDrawer
          ...
          type={uploadableProjectFileTypes.other.mini_grid_station_consumer}
        />
