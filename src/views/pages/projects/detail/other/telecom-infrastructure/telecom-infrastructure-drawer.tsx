...
const TelecomInfrastructureDrawer = (
  ...
  const editTelecomInfrastructure = async (
    ...
    otherApiService<TelecomInfrastructure>().update(
      model,
  ...
  const getPayload = (values: TelecomInfrastructure) => {
    ...
    return {
      data: {
        ...
        inauguration_date: convertDateToLocaleDate(
          values.inauguration_date
        ),
        service_period: convertDateToLocaleDate(
          values.service_period
        ),
      },
