...
export const railwayColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.major_operator ? row.major_operator : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 150,
    ...
    field: "energy_source",
    renderCell: ({ row }: CellType) =>
      row.energy_source ? row.energy_source : t("common.not-available"),
  },
  {
    flex: 0.15,
    minWidth: 150,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.total_station_no
        ? row.total_station_no.toString()
        : t("common.not-available"),
  },
  {
    flex: 0.15,
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) =>
      row.transport_cargo_no
        ? row.transport_cargo_no.toString()
        : t("common.not-available"),
  },
  {
    flex: 0.15,
