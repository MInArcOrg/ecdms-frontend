...
const RailwayList: React.FC<RailwayListProps> = ({
  model,
  projectId,
  typeId,
}) => {
  ...
  const mapRailwayToDetailItems = (
    railway: Railway,
  ): { title: string; value: string }[] => [
    {
      title: t("project.other.railway.details.energy-source"),
      value: railway.energy_source || "N/A",
    },
    {
      title: t("project.other.railway.details.major-operator"),
      value: railway.major_operator || "N/A",
    },
    {
      title: t("project.other.railway.details.system-length"),
      value: railway.system_length?.toString() || "N/A",
    },
    {
      title: t("project.other.railway.details.total-station-no"),
      value: railway.total_station_no?.toString() || "N/A",
    },
    {
      title: t("project.other.railway.details.fright-cargo-no"),
      value: railway.fright_cargo_no?.toString() || "N/A",
    },
    {
      title: t("project.other.railway.details.transport-cargo-no"),
      value: railway.transport_cargo_no?.toString() || "N/A",
    },
    {
      title: t("common.table-columns.created-at"),
      value: railway.created_at ? formatCreatedAt(railway.created_at) : "N/A",
    },
  ];
