...
export const railwayTrackConditionAssessmentColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: AssessmentCellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.track_condition_rating_id !== undefined
          ? row.track_condition_rating_id
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: AssessmentCellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.observed_defects_id !== undefined
          ? row.observed_defects_id
          : t("common.not-available")}
      </Typography>
    ),
  },
  {
    ...
    renderCell: ({ row }: AssessmentCellType) => (
      <Typography sx={{ color: "text.secondary" }}>
        {row?.track_settlement_irregularities !== undefined
          ? row.track_settlement_irregularities
          : t("common.not-available")}
      </Typography>
    ),
  },
