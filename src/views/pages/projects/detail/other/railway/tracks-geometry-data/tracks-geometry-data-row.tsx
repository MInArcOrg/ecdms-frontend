...
interface CellType {
  row: TracksGeometryData;
}

export const tracksGeometryDataColumns = (
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Fragment>
        <ModelAction model="TracksGeometryData" model_id={row.id} refetchModel={refetch} resubmit={() => {}} title="" postAction={() => {}} />
        <RowOptions
          onEdit={() => onEdit(row)}
