      ...
      <Grid container spacing={2} sx={{ mt: 1 }}>
        ...
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            ...
            {railwayTrackData?.track_type_id ?? t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.railway-track-data.details.track-gauge-id")}:{" "}
            {railwayTrackData?.track_gauge_id ?? t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.railway-track-data.details.track-length")}:{" "}
            {railwayTrackData?.track_length ?? t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
        ...
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayTrackData?.sleepers_type_and_spacing ??
              t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
        ...
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayTrackData?.ballast_type_and_depth ??
              t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            ...
            :{" "}
            {railwayTrackData?.track_connection_method ??
              t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.railway-track-data.details.track-type")}:{" "}
            {railwayTrackData?.track_type ?? t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={12}>
          <Typography variant="body2" color="text.secondary">
            {t("project.other.railway-track-data.details.remark")}:{" "}
            {railwayTrackData?.remark ?? t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            {t("common.created-at")}:{" "}
            {railwayTrackData?.created_at ?? t("common.not-available")}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            {t("common.updated-at")}:{" "}
            {railwayTrackData?.updated_at ?? t("common.not-available")}
          </Typography>
        </Grid>
      </Grid>
    </SharedItemViewCard>
