...
const RailwayTrackMaintenanceAndInspectionCard = ({
  ...
  onDetail: (railwayTrackMaintenanceAndInspection: RailwayTrackMaintenanceAndInspection) => void;
  railwayTrackMaintenanceAndInspection: RailwayTrackMaintenanceAndInspection;
  onEdit: (railwayTrackMaintenanceAndInspection: RailwayTrackMaintenanceAndInspection) => void;
  ...
  return (
    <SharedItemViewCard
      ...
      actions={
        <>
          <FileDrawer id={railwayTrackMaintenanceAndInspection.id} type="RAILWAY_TRACK_MAINTENANCE_AND_INSPECTION" />
          ...
          <RowOptions
            ...
            deletePermissionRule={{ action: 'delete', subject: 'railwaytrackmaintenanceandinspection' }}
            editPermissionRule={{ action: 'update', subject: 'railwaytrackmaintenanceandinspection' }}
            options={[]}
          />
        </>
      }
    >
      ...
      <Grid container spacing={2} sx={{ mt: 1 }}>
        ...
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            {t('common.created-at')}: {railwayTrackMaintenanceAndInspection?.created_at ?? t('common.not-available')}
          </Typography>
        </Grid>
        <Grid item xs={6}>
          <Typography variant="body2" color="text.secondary">
            {t('common.updated-at')}: {railwayTrackMaintenanceAndInspection?.updated_at ?? t('common.not-available')}
          </Typography>
        </Grid>
      </Grid>
    </SharedItemViewCard>
