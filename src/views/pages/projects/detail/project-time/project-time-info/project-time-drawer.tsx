      ...
      {() => (
        <FormPageWrapper
          ...
          initialValues={{
            ...
            site_handover_date: formatInitialDateDate(
              projectTime?.site_handover_date,
            ),

            commencement_date: formatInitialDateDate(
              projectTime?.commencement_date,
            ),
            mobilization_days_no: moment(projectTime?.commencement_date).diff(
              moment(projectTime?.site_handover_date),
              "days",
            ),
            original_contract_duration: moment(
              projectTime?.project_completion_date,
            ).diff(moment(projectTime?.commencement_date), "days"),
          }}
