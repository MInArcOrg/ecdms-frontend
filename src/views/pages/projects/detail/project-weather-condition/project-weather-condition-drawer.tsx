...
const WeatherConditionDrawer: React.FC<WeatherConditionDrawerType> = (
  props,
) => {
  ...
  const onActionSuccess = async (
    response: IApiResponse<WeatherCondition>,
    payload: IApiPayload<WeatherCondition>,
  ) => {
    refetch();
    toggle();
    handleClose();
    ...
    >
      {() => (
        <FormPageWrapper
          ...
          createActionFunc={
            isEdit ? editWeatherCondition : createWeatherCondition
          }
