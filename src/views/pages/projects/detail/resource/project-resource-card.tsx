          ...
          <Grid item xs={12}>
            <Box>
              ...
              <Typography
                ...
                sx={{ marginTop: 0.5 }}
              >
                <span>{t("resource.form.description")}:</span>{" "}
                <strong>{projectResource?.resource?.description ?? t("N/A")}</strong>
              </Typography>
              <Typography
                variant="body2"
                color="text.secondary"
              ...
              >
                ...
                <strong>
                  {projectResource?.resource?.measurement_unit ?? t("N/A")}
                </strong>
              </Typography>
              <Typography
                variant="body2"
              ...
              >
                ...
                <strong>{projectResource?.resource?.status ?? t("N/A")}</strong>
              </Typography>
            </Box>
          </Grid>
        </Grid>
        ...
        <Fragment>
          <Box>
            <FileDrawer
              ...
              type={uploadableProjectFileTypes.resource}
            />{" "}
            &nbsp;
            <Box sx={{ display: "flex" }}>
