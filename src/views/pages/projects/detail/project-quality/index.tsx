...
const ProjectQualityList: React.FC<ProjectQualityListProps> = ({ projectId }) => {
  ...
  const mapQualityToDetailItems = (quality: ProjectQuality): { title: string; value: string }[] => [
    {
      title: t('project.quality.major-quality-problem-encountered'),
      value: quality?.major_quality_problem_encountered || 'N/A'
    },
    {
      title: t('project.quality.description'),
      value: quality?.description || 'N/A'
    },
    {
      title: t('project.quality.measures-taken'),
      value: quality?.measures_taken || 'N/A'
    },
    {
      title: t('project.quality.lesson-learned'),
      value: quality?.lesson_learned || 'N/A'
    },
    {
    ...
    <Box>
      ...
      <ItemsListing
        ...
        ItemViewComponent={({ data }) => (
          <ProjectQualityCard onDetail={handleClickDetail} quality={data} onEdit={handleEdit} refetch={refetch} onDelete={handleDelete} />
        )}
        createActionConfig={{
