...
function PlanDetail({ show, toggleDetail, projectPlan }: PlanDetailProps) {
  ...
  return (
    <Fragment>
      <CustomSideDrawer
        title={`Q${projectPlan.quarter}/${formatDate(
          projectPlan.start,
          "yyyy",
        )} ${t("Plan")} ${t("Detail")}`}
              ...
              <Box>
                ...
                {[
                  ...
                  { label: t("Machinery"), value: projectPlan.machinery },
                  {
                    ...
                    value: projectPlan.other_expense,
                  },
                  {
                    label: t("Subcontractor Expense"),
                    value: projectPlan.sub_contractor_cost,
                  },
                  {
                    label: `${t("Subtotal")}`,
                    value: projectPlan.sub_total_expense,
                    bold: true,
                  },
                  {
                    label: t("Overhead Cost"),
                    value: projectPlan.over_head_cost,
                  },
                  {
                    label: t("Profit - loss"),
                    value: projectPlan.profit_or_loss,
                  },
                  {
                    label: `${t("Project")} ${t("Expense")}`,
                    value: projectPlan.project_expense,
                    bold: true,
                  },
                  {
                    label: `${t("Financial Performance")}`,
                    value: projectPlan.financial_performance,
                  },
                  {
                    label: `${t("Physical Performance")}`,
                    value: projectPlan.physical_performance,
                  },
