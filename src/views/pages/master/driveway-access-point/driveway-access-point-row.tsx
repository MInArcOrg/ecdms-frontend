...
interface CellType {
  row: DrivewayAccessPoint
}

export const drivewayAccessPointColumns = (
...
): GridColDef[] => [
  {
    ...
    minWidth: 200,
    field: "title",
    headerName: t("master-data.driveway-access-point.title"),
  ...
  },
  {
    ...
    minWidth: 200,
    field: "description",
    headerName: t("master-data.driveway-access-point.description"),
  ...
  },
  {
    ...
    headerName: t("master-data.driveway-access-point.project-type"),
    renderCell: ({ row }: CellType) => {
