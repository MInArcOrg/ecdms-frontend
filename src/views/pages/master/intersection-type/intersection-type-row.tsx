...
export const intersectionTypeColumns = (
...
): GridColDef[] => [
  {
    ...
    minWidth: 200,
    field: "title",
    headerName: t("master-data.intersection-type.title"),
  ...
  },
  {
    ...
    minWidth: 200,
    field: "description",
    headerName: t("master-data.intersection-type.description"),
  ...
  },
  {
    ...
    headerName: t("master-data.intersection-type.project-type"),
    renderCell: ({ row }: CellType) => {
