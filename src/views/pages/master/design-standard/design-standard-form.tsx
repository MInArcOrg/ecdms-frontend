...
interface DesignStandardFormProps {
  ...
  defaultLocaleData?: DesignStandard
  file: File | null
  onFileChange: (file: File | null) => void
}

const DesignStandardForm: React.FC<DesignStandardFormProps> = ({ formik, file, onFileChange }) => {
  ...
  return (
    <>
      <Box mb={2}>
        <CustomTextBox fullWidth label={t("master-data.design-standard.title")} name="title" size="small" sx={{ mb: 2 }} />
      </Box>
      <Box mb={2}>
        <CustomTextBox
          fullWidth
          label={t("master-data.design-standard.description")}
          name="description"
          size="small"
          multiline
          rows={3}
      ...
      <Box mb={2}>
        <CustomSelect
          fullWidth
          label={t("master-data.design-standard.project-type")}
