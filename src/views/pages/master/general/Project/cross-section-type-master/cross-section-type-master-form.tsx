...
interface CrossSectionTypeMasterFormProps {
...
const CrossSectionTypeMasterForm: React.FC<CrossSectionTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default CrossSectionTypeMasterForm
