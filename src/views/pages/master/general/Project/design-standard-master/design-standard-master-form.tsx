...
interface DesignStandardMasterFormProps {
...
const DesignStandardMasterForm: React.FC<DesignStandardMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default DesignStandardMasterForm
