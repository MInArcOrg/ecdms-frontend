...
interface FunctionalClassificationMasterFormProps {
...
const FunctionalClassificationMasterForm: React.FC<FunctionalClassificationMasterFormProps> = ({
    formik,
    file,
    onFileChange,
}) => {
...
export default FunctionalClassificationMasterForm
