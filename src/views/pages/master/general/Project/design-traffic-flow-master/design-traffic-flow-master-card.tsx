...
const DesignTrafficFlowMasterCard = ({
  generalMaster,
  onEdit,
  onDelete,
  refetch,
  ...
  type: string
  generalMaster: DesignTrafficFlow
  onEdit: (category: DesignTrafficFlow) => void
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: "flex-end" }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type={uploadableProjectFileTypes.designTrafficFlow} /> &nbsp;
...
export default DesignTrafficFlowMasterCard
