...
interface DesignTrafficFlowMasterFormProps {
...
const DesignTrafficFlowMasterForm: React.FC<DesignTrafficFlowMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default DesignTrafficFlowMasterForm
