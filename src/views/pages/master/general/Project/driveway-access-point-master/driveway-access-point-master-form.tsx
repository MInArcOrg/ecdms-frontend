...
interface DrivewayAccessPointMasterFormProps {
...
const DrivewayAccessPointMasterForm: React.FC<DrivewayAccessPointMasterFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
...
export default DrivewayAccessPointMasterForm
