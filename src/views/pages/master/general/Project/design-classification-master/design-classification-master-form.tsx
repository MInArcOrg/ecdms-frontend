...
interface DesignClassificationMasterFormProps {
...
const DesignClassificationMasterForm: React.FC<DesignClassificationMasterFormProps> = ({
  formik,
  file,
  onFileChange,
}) => {
...
export default DesignClassificationMasterForm
