...
const IntersectionTypeMasterCard = ({
  generalMaster,
  onEdit,
  onDelete,
  refetch,
  ...
  type: string
  generalMaster: IntersectionType
  onEdit: (category: IntersectionType) => void
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: "flex-end" }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type={uploadableProjectFileTypes.intersectionType} /> &nbsp;
...
export default IntersectionTypeMasterCard
