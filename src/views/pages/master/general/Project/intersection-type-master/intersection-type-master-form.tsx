...
interface IntersectionTypeMasterFormProps {
...
const IntersectionTypeMasterForm: React.FC<IntersectionTypeMasterFormProps> = ({
    formik,
    file,
    onFileChange,
}) => {
...
export default IntersectionTypeMasterForm
