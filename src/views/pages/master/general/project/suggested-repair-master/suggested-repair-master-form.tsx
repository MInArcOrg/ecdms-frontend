...
interface SuggestedRepairMasterFormProps {
  formik: FormikProps<SuggestedRepair>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: SuggestedRepair;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const SuggestedRepairMasterForm: React.FC<SuggestedRepairMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default SuggestedRepairMasterForm;
