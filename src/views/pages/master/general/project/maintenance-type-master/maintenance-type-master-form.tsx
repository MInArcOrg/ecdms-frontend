...
interface MaintenanceTypeMasterFormProps {
  formik: FormikProps<MaintenanceType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: MaintenanceType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const MaintenanceTypeMasterForm: React.FC<MaintenanceTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default MaintenanceTypeMasterForm;
