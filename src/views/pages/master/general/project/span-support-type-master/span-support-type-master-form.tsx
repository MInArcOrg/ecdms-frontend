...
interface SpanSupportTypeMasterFormProps {
  formik: FormikProps<SpanSupportType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: SpanSupportType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const SpanSupportTypeMasterForm: React.FC<SpanSupportTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default SpanSupportTypeMasterForm;
