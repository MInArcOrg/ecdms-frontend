...
interface EndwallTypeInletMasterFormProps {
  formik: FormikProps<EndwallTypeInlet>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: EndwallTypeInlet;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const EndwallTypeInletMasterForm: React.FC<EndwallTypeInletMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default EndwallTypeInletMasterForm;
