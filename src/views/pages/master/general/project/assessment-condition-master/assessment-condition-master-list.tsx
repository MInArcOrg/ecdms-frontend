...
const AssessmentConditionMasterList: React.FC = () => {
  const [selectedRow, setSelectedRow] = useState<AssessmentCondition | null>(null);
  const { t } = useTranslation();
  const fetchAssessmentConditionMaster = (params: GetRequestParam): Promise<IApiResponse<AssessmentCondition[]>> => {
