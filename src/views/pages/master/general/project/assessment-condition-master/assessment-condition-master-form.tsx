...
interface AssessmentConditionMasterFormProps {
  formik: FormikProps<AssessmentCondition>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: AssessmentCondition;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const AssessmentConditionMasterForm: React.FC<AssessmentConditionMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default AssessmentConditionMasterForm;
