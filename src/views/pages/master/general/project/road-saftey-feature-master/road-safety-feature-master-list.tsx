...
const RoadSafetyFeatureMasterList: React.FC = () => {
  const [selectedRow, setSelectedRow] = useState<RoadSafetyFeature | null>(null);
  const { t } = useTranslation();
  const fetchRoadSafetyFeatureMaster = (params: GetRequestParam): Promise<IApiResponse<RoadSafetyFeature[]>> => {
