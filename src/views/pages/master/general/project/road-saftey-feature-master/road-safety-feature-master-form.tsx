...
interface RoadSafetyFeatureMasterFormProps {
  formik: FormikProps<RoadSafetyFeature>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: RoadSafetyFeature;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const RoadSafetyFeatureMasterForm: React.FC<RoadSafetyFeatureMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default RoadSafetyFeatureMasterForm;
