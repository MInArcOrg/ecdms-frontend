...
interface HazardTypeMasterFormProps {
  formik: FormikProps<HazardType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: HazardType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const HazardTypeMasterForm: React.FC<HazardTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default HazardTypeMasterForm;
