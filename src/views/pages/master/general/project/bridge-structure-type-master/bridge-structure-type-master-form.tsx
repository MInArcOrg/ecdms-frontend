...
interface BridgeStructureTypeMasterFormProps {
  formik: FormikProps<BridgeStructureType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: BridgeStructureType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const BridgeStructureTypeMasterForm: React.FC<BridgeStructureTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default BridgeStructureTypeMasterForm;
