...
interface SeverityLevelMasterFormProps {
  formik: FormikProps<SeverityLevel>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: SeverityLevel;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const SeverityLevelMasterForm: React.FC<SeverityLevelMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default SeverityLevelMasterForm;
