...
const SeverityLevelMasterList: React.FC = () => {
  ...
  const fetchSeverityLevelMaster = (params: GetRequestParam): Promise<IApiResponse<SeverityLevel[]>> => {
  ...
  return (
    <Fragment>
      {showDrawer && (
        <SeverityLevelMasterDrawer open={showDrawer} toggle={toggleDrawer} masterData={selectedRow as SeverityLevel} refetch={refetch} />
      )}
      <Card>
        <CardContent>
          <ItemsListing
