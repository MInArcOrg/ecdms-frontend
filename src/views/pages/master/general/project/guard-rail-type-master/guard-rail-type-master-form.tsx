...
interface GuardRailTypeMasterFormProps {
  formik: FormikProps<GuardRailType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: GuardRailType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const GuardRailTypeMasterForm: React.FC<GuardRailTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default GuardRailTypeMasterForm;
