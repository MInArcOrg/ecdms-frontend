// components/GuardRailTypeList.tsx
...
const GuardRailTypeMasterCard = ({
  ...
  type: string;
  generalMaster: GuardRailType;
  onEdit: (category: GuardRailType) => void;
...
export default GuardRailTypeMasterCard;
