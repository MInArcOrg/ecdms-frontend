...
const PavedWaterWayTypeMasterCard = ({
  generalMaster,
  onEdit,
  onDelete,
  refetch,
  ...
  type: string
  generalMaster: PavedWaterWayType
  onEdit: (category: PavedWaterWayType) => void
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: "flex-end" }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type={uploadableProjectFileTypes.pavedWaterWayType} /> &nbsp;
...
export default PavedWaterWayTypeMasterCard
