...
interface PavedWaterWayTypeMasterFormProps {
  formik: FormikProps<PavedWaterWayType>
  defaultLocaleData?: PavedWaterWayType
  onFileChange: (file: File | null) => void
  file: File | null
}

const PavedWaterWayTypeMasterForm: React.FC<PavedWaterWayTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default PavedWaterWayTypeMasterForm
