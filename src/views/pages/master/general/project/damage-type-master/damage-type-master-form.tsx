...
interface DamageTypeMasterFormProps {
  formik: FormikProps<DamageType>
  defaultLocaleData?: DamageType
  onFileChange: (file: File | null) => void
  file: File | null
}

const DamageTypeMasterForm: React.FC<DamageTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default DamageTypeMasterForm
