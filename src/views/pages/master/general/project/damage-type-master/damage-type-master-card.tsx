...
const DamageTypeMasterCard = ({
  ...
  type: string
  generalMaster: DamageType
  onEdit: (category: DamageType) => void
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: "flex-end" }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type={uploadableProjectFileTypes.damageType} /> &nbsp;
...
export default DamageTypeMasterCard
