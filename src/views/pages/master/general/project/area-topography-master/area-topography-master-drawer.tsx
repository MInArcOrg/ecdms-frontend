...
const AreaTopographyMasterDrawer = (props: AreaTopographyMasterDrawerType) => {
  ...
  const onActionSuccess = async (
    response: IApiResponse<AreaTopography>,
    payload: IApiPayload<AreaTopography>,
  ) => {
  ...
  return (
    <CustomSideDrawer
      title={`master-data.general-master.${
        isEdit ? "edit-area-topography" : "create-area-topography"
      }`}
    ...
    >
      {() => (
        <FormPageWrapper<AreaTopography>
          ...
          createActionFunc={
            isEdit ? editAreaTopographyMaster : createAreaTopographyMaster
          }
