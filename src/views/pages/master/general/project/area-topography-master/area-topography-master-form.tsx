...
interface AreaTopographyMasterFormProps {
  formik: FormikProps<AreaTopography>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: AreaTopography;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const AreaTopographyMasterForm: React.FC<AreaTopographyMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default AreaTopographyMasterForm;
