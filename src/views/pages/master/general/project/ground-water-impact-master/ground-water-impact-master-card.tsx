// components/GroundWaterImpactList.tsx
...
const GroundWaterImpactMasterCard = ({
  generalMaster,
  onEdit,
  onDelete,
  refetch,
  ...
  type: string;
  generalMaster: GroundWaterImpact;
  onEdit: (category: GroundWaterImpact) => void;
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: "flex-end" }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type="GROUND_WATER_IMPACT" />{" "}
                &nbsp;
...
export default GroundWaterImpactMasterCard;
