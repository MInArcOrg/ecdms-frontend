...
interface GroundWaterImpactMasterFormProps {
  formik: FormikProps<GroundWaterImpact>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: GroundWaterImpact;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const GroundWaterImpactMasterForm: React.FC<GroundWaterImpactMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default GroundWaterImpactMasterForm;
