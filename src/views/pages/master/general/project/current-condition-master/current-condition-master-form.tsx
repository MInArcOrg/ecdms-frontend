...
interface SoilTypeMasterFormProps {
  formik: FormikProps<SoilType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: SoilType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const SoilTypeMasterForm: React.FC<SoilTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default SoilTypeMasterForm;
