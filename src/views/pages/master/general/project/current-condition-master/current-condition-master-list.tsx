...
const CurrentConditionMasterList: React.FC = () => {
  ...
  const fetchCurrentConditionMaster = (params: GetRequestParam): Promise<IApiResponse<CurrentCondition[]>> => {
        ...
        <CardContent>
          <ItemsListing
            ...
            ItemViewComponent={({ data }) => (
              <CurrentConditionMasterCard generalMaster={data} onDelete={handleDelete} onEdit={handleEdit} t={t} refetch={refetch} />
            )}
            isLoading={isLoading}
            createActionConfig={{
