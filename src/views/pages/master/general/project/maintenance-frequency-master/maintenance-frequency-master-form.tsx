...
interface MaintenanceFrequencyMasterFormProps {
  formik: FormikProps<MaintenanceFrequency>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: MaintenanceFrequency;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const MaintenanceFrequencyMasterForm: React.FC<MaintenanceFrequencyMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default MaintenanceFrequencyMasterForm;
