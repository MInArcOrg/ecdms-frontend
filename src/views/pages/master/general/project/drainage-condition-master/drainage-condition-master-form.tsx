...
interface DrainageConditionMasterFormProps {
  formik: FormikProps<DrainageCondition>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: DrainageCondition;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const DrainageConditionMasterForm: React.FC<DrainageConditionMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default DrainageConditionMasterForm;
