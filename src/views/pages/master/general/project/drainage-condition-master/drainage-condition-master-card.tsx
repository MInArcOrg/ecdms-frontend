// components/DrainageConditionList.tsx
...
const DrainageConditionMasterCard = ({
  generalMaster,
  onEdit,
  onDelete,
  refetch
  ...
  type: string;
  generalMaster: DrainageCondition;
  onEdit: (category: DrainageCondition) => void;
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: 'flex-end' }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type="DRAINAGE_CONDITION" /> &nbsp;
...
export default DrainageConditionMasterCard;
