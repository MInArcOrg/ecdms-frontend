...
const DeckSlabTypeMasterCard = ({
  ...
  type: string
  generalMaster: DeckSlabType
  onEdit: (category: DeckSlabType) => void
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: "flex-end" }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type={uploadableProjectFileTypes.deckSlabType} /> &nbsp;
...
export default DeckSlabTypeMasterCard
