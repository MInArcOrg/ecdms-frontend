...
interface DeckSlabTypeMasterFormProps {
  formik: FormikProps<DeckSlabType>
  defaultLocaleData?: DeckSlabType
  onFileChange: (file: File | null) => void
  file: File | null
}

const DeckSlabTypeMasterForm: React.FC<DeckSlabTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default DeckSlabTypeMasterForm
