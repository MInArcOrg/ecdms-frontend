...
interface DrainageTypeMasterFormProps {
  formik: FormikProps<DrainageType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: DrainageType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const DrainageTypeMasterForm: React.FC<DrainageTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default DrainageTypeMasterForm;
