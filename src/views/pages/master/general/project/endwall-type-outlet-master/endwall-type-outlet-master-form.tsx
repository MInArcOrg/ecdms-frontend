...
interface EndwallTypeOutletMasterFormProps {
  formik: FormikProps<EndwallTypeOutlet>
  defaultLocaleData?: EndwallTypeOutlet
  onFileChange: (file: File | null) => void
  file: File | null
}

const EndwallTypeOutletMasterForm: React.FC<EndwallTypeOutletMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default EndwallTypeOutletMasterForm
