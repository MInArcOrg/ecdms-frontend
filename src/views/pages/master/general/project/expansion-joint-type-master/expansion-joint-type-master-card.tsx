...
const ExpansionJointTypeMasterCard = ({
  generalMaster,
  onEdit,
  onDelete,
  refetch,
  ...
  type: string
  generalMaster: ExpansionJointType
  onEdit: (category: ExpansionJointType) => void
        ...
        <Grid container alignItems="center" justifyContent="space-between">
          ...
          <Grid item>
            <CardActions style={{ justifyContent: "flex-end" }}>
              <Fragment>
                <FileDrawer id={generalMaster.id} type={uploadableProjectFileTypes.expansionJointType} /> &nbsp;
...
export default ExpansionJointTypeMasterCard
