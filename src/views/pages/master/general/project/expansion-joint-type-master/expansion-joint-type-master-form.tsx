...
interface ExpansionJointTypeMasterFormProps {
  formik: FormikProps<ExpansionJointType>
  defaultLocaleData?: ExpansionJointType
  onFileChange: (file: File | null) => void
  file: File | null
}

const ExpansionJointTypeMasterForm: React.FC<ExpansionJointTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default ExpansionJointTypeMasterForm
