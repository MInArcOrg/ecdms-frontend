...
interface HydrologyDefectMasterFormProps {
  formik: FormikProps<HydrologyDefect>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: HydrologyDefect;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const HydrologyDefectMasterForm: React.FC<HydrologyDefectMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default HydrologyDefectMasterForm;
