...
interface AbutmentTypeMasterFormProps {
  formik: FormikProps<AbutmentType>
  defaultLocaleData?: AbutmentType
  onFileChange: (file: File | null) => void
  file: File | null
}

const AbutmentTypeMasterForm: React.FC<AbutmentTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default AbutmentTypeMasterForm
