...
const SlopeStabilityMasterDrawer = (props: SlopeStabilityMasterDrawerType) => {
  ...
  const onActionSuccess = async (
    response: IApiResponse<SlopeStability>,
    payload: IApiPayload<SlopeStability>,
  ) => {
  ...
  return (
    <CustomSideDrawer
      title={`master-data.general-master.${
        isEdit ? "edit-slope-stability" : "create-slope-stability"
      }`}
    ...
    >
      {() => (
        <FormPageWrapper<SlopeStability>
          ...
          createActionFunc={
            isEdit ? editSlopeStabilityMaster : createSlopeStabilityMaster
          }
