...
const SlopeStabilityMasterList: React.FC = () => {
  ...
  const fetchSlopeStabilityMaster = (
    params: GetRequestParam,
  ): Promise<IApiResponse<SlopeStability[]>> => {
  ...
  return (
    <Fragment>
      {showDrawer && (
        <SlopeStabilityMasterDrawer
          open={showDrawer}
          toggle={toggleDrawer}
          masterData={selectedRow as SlopeStability}
          refetch={refetch}
        />
      )}
      <Card>
