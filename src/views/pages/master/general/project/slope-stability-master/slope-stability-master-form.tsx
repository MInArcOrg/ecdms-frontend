...
interface SlopeStabilityMasterFormProps {
  formik: FormikProps<SlopeStability>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: SlopeStability;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const SlopeStabilityMasterForm: React.FC<SlopeStabilityMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default SlopeStabilityMasterForm;
