...
interface DamageConditionMasterFormProps {
  formik: FormikProps<DamageCondition>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: DamageCondition;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const DamageConditionMasterForm: React.FC<DamageConditionMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default DamageConditionMasterForm;
