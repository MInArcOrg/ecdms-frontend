...
interface CountTypeMasterFormProps {
  formik: FormikProps<CountType>; // Use ExtendedGeneralMaster in FormikProps

  defaultLocaleData?: CountType;
  onFileChange: (file: File | null) => void;
  file: File | null;
}

const CountTypeMasterForm: React.FC<CountTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default CountTypeMasterForm;
