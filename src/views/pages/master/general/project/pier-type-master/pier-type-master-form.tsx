...
interface PierTypeMasterFormProps {
  formik: FormikProps<PierType>
  defaultLocaleData?: PierType
  onFileChange: (file: File | null) => void
  file: File | null
}

const PierTypeMasterForm: React.FC<PierTypeMasterFormProps> = ({ formik, file, onFileChange }) => {
...
export default PierTypeMasterForm
