...
export interface SafetyAndHealth {
  ...
  hazardType?: ProjectGeneralMaster;
  potential_impact_id: string;
  potentialImpact?: ProjectGeneralMaster;
  risk_level_id: string;
  riskLevel?: ProjectGeneralMaster;
  immediate_action_taken?: string;
  incident_type_id: string;
  incidentType?: ProjectGeneralMaster;
  ...
  personalProtectiveEquipmentType?: ProjectGeneralMaster;
  personal_protective_equipment_condition_id: string;
  personalProtectiveEquipmentCondition?: ProjectGeneralMaster;
  trained_on_equipment_usage?: boolean;
  training_hours_number?: number;
  weather_condition_during_incident_id: string;
  weatherConditionDuringIncident?: ProjectGeneralMaster;
  injury_severity_id: string;
  injurySeverity?: ProjectGeneralMaster;
...
export interface IntersectionAndDriveway {
  ...
  intersectionType?: ProjectGeneralMaster;
  driveway_access_point_id: string;
  drivewayAccessPoint?: ProjectGeneralMaster;
...
export interface TrafficParameter {
  ...
  pedestrianFacility?: ProjectGeneralMaster;
  parking?: number;
  road_segment_id?: string;
  roadSegment?: RoadSegment;
