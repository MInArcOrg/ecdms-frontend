...
function StakeholderStrategyIndex() {
  ...
  return (
    <StakeholderLayout activeMenuId={stakeholderMenuIds.RESOURCE} activeSubMenuId={stakeholderResourceIds.documents.codeOfConduct} subMenuItems={subMenuItems(id as string, typeId as string)}>
        <>
        //codes of condut need to be added here
        </>
    </StakeholderLayout>
  );
}
