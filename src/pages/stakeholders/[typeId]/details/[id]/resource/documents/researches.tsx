...
function StakeholderStrategyIndex() {
  ...
  return (
    <StakeholderLayout activeMenuId={stakeholderMenuIds.RESOURCE} activeSubMenuId={stakeholderResourceIds.documents.researches} subMenuItems={subMenuItems(id as string, typeId as string)}>
        <>
