...
function StakeholderStrategyIndex() {
  ...
  return (
    <StakeholderLayout activeMenuId={stakeholderMenuIds.RESOURCE} activeSubMenuId={stakeholderResourceIds.documents.manuals} subMenuItems={subMenuItems(id as string, typeId as string)}>
        <>
        //manuals need to be added here
        </>
    </StakeholderLayout>
  );
}
