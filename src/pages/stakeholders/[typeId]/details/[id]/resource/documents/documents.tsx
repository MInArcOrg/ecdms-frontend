...
function StakeholderStrategyIndex() {
  ...
  return (
    <StakeholderLayout activeMenuId={stakeholderMenuIds.RESOURCE} activeSubMenuId={stakeholderResourceIds.documents.documents} subMenuItems={subMenuItems(id as string, typeId as string)}>
        <>
        //documents need to be added here
        </>
    </StakeholderLayout>
  );
}
