...
const menuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        title:
          "stakeholder.navigation.submenu.resource.resources.safety-equipment",
      ...
      },
      {
        ...
        title:
          "stakeholder.navigation.submenu.resource.resources.construction-materials",
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        title:
          "stakeholder.navigation.submenu.resource.documents.code-of-conduct",
    ...
    subItems: [
      {
        id: stakeholderResourceIds.certificates.certificates,
        title:
          "stakeholder.navigation.submenu.resource.certificates.certificates",
      ...
      },
      {
        ...
        title:
          "stakeholder.navigation.submenu.resource.certificates.accreditation",
