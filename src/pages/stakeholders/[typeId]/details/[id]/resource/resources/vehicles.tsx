...
function StakeholderMaterialIndex() {
  ...
  return (
    <StakeholderLayout activeMenuId={stakeholderMenuIds.RESOURCE} activeSubMenuId={stakeholderResourceIds.resources.vehicles} subMenuItems={subMenuItems(id as string, typeId as string)}>
        <>
