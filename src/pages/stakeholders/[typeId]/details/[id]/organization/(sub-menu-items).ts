...
const menuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
  {
    ...
    title: 'stakeholder.navigation.submenu.organization.general-info.general-info',
    subItems: [
      {
        id: stakeholderOrganizationIds.generalInfo.generalInfo,
        title: 'stakeholder.navigation.submenu.organization.general-info.general-info',
      ...
      },
      {
        ...
        title: 'stakeholder.navigation.submenu.organization.general-info.licenses',
        path: `/stakeholders/${typeId}/details/${id}/organization/general-info/licenses`
      },
      {
        id: stakeholderOrganizationIds.generalInfo.manager,
        title: 'stakeholder.navigation.submenu.organization.general-info.manager',
      ...
      },
      {
        ...
        title: 'stakeholder.navigation.submenu.organization.general-info.contact-person',
      ...
      },
      {
        ...
        title: 'stakeholder.navigation.submenu.organization.general-info.upgrade',
      ...
      },
      {
        ...
        title: 'stakeholder.navigation.submenu.organization.general-info.additional-info',
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        title: 'stakeholder.navigation.submenu.organization.branches.branch-contact-person',
      ...
      },
      {
        ...
        title: 'stakeholder.navigation.submenu.organization.branches.additional-info',
  ...
  },
  {
    ...
    title: 'stakeholder.navigation.submenu.organization.company-structure.company-structure',
    subItems: [
      {
        id: stakeholderOrganizationIds.companyStructure.departments,
        title: 'stakeholder.navigation.submenu.organization.company-structure.departments',
      ...
      },
      {
        ...
        title: 'stakeholder.navigation.submenu.organization.company-structure.positions',
