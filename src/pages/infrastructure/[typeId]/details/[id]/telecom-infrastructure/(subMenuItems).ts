    ...
    subItems: [
      {
        ...
        path: `/${module}/${typeId}/details/${id}/telecom-infrastructure/telecom-infrastructure/telecom-infrastructure`,
      ...
      },
      {
        ...
        path: `/${module}/${typeId}/details/${id}/telecom-infrastructure/telecom-infrastructure/telecom-infrastructure-age`,
      ...
      },
      {
        ...
        path: `/${module}/${typeId}/details/${id}/telecom-infrastructure/telecom-infrastructure/telecom-infrastructure-manufacturer`,
      ...
      },
      {
        ...
        path: `/${module}/${typeId}/details/${id}/telecom-infrastructure/telecom-infrastructure/network-capacity`,
      ...
      },
      {
        ...
        path: `/${module}/${typeId}/details/${id}/telecom-infrastructure/telecom-infrastructure/network-coverage`,
      ...
      },
      {
        ...
        path: `/${module}/${typeId}/details/${id}/telecom-infrastructure/telecom-infrastructure/maintenance`,
        model: 'maintenance',
