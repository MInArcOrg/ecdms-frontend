...
const defaultMenuItem = findSubMenuItem(subMenuItems('', ''), broadcastingDataSystemsId.broadcasting.broadcastingInfrastructure);
...
const BroadcastingInfrastructurePage = () => {
  ...
  return (
    ...
    >
      <BroadcastingInfrastructureList otherSubMenu={menuItem} typeId={String(typeId)} projectId={String(id)} />
    </ProjectLayout>
  );
};
