...
import RailwayMaintenanceFacilityScheduleAndProcedureList from 'src/views/pages/projects/detail/other/road/railway-maintenance-facility-schedule-and-procedure';
...
const MaintenanceFacilitySchedulesAndProceduresPage = () => {
  ...
  return (
    ...
    >
      <RailwayMaintenanceFacilityScheduleAndProcedureList
