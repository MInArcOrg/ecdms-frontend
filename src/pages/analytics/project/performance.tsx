    ...
    <ProjectAnalyticsLayout>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} md={3.2}>
          <ProjectTypes data={types} title="Project Types" maxHeight="20.9rem" setActiveType={setActiveType} activeType={activeType} />
        </Grid>

        {/* Project Category Chart */}
        <Grid item xs={12} md={8.8}>
          <ProjectCategoryChart labels={months} series={series} title="Project Report" height={300} />
        </Grid>
        ...
        <Grid item xs={12} md={6}>
          <Card>
            <CardContent>
              ...
              <ReactApexcharts options={chartOptions as any} series={evaSeries} type="bar" height={290} />
            </CardContent>
          </Card>
        </Grid>
      </Grid>
