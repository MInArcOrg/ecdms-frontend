    ...
    <ProjectAnalyticsLayout>
      <Grid container spacing={3} pb={7}>
        <Grid item xs={12} md={3.2}>
          <ProjectTypes data={types} title="Project Types" setActiveType={setActiveType} activeType={activeType} />
        </Grid>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={8.8}>
          ...
          {/* Conditional Views */}
          {graphView === Graph && (
            <ProjectCategoryChart series={series} labels={labels?.payload || []} title="Regional Distribution" height={400} />
          )}
