...
import InternetConnectionInfrastructureAgeList from 'src/views/pages/projects/detail/other/telecom/internet-connection-component-age';
...
function Index() {
  ...
  return (
    <ProjectOtherLayout
      ...
      baseUrl={baseUrl}
    >
      <InternetConnectionInfrastructureAgeList
