...
import InternetConnectionInfrastructureManufacturerList from 'src/views/pages/projects/detail/other/telecom/internet-connection-infrastructure-manufacturer';
...
function Index() {
  ...
  return (
    <ProjectOtherLayout
      ...
      baseUrl={baseUrl}
    >
      <InternetConnectionInfrastructureManufacturerList
