...
import BridgeStructureInformationList from 'src/views/pages/projects/detail/other/road/bridge-structure-information';
...
function Index() {
  ...
  return (
    <ProjectOtherLayout
      ...
      baseUrl={baseUrl}
    >
      <BridgeStructureInformationList
