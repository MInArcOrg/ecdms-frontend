...
const subMenuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
    ...
    subItems: [
      {
        ...
        title:
          "project.navigation.submenu.power-generation.hydropower.hydroelectric-dam",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-generation.hydropower.hydrological-information",
    ...
    subItems: [
      {
        ...
        title:
          "project.navigation.submenu.power-generation.wind-energy.wind-resource",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-generation.wind-energy.wind-turbine",
    ...
    subItems: [
      {
        ...
        title:
          "project.navigation.submenu.power-generation.solar-energy.solar-resource-information",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-generation.solar-energy.solar-panel",
  ...
  },
  {
    ...
    title:
      "project.navigation.submenu.power-generation.geothermal-energy.title",
    subItems: [
      {
        id: powerGenerationIds.geothermalEnergy.geothermalPowerWells,
        title:
          "project.navigation.submenu.power-generation.geothermal-energy.geothermal-power-wells",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-generation.geothermal-energy.geothermal-power-infrastructure",
    ...
    subItems: [
      {
        ...
        title:
          "project.navigation.submenu.power-generation.thermal-biomass.thermal-biomass-incineration-data",
    ...
    subItems: [
      {
        ...
        title:
          "project.navigation.submenu.power-generation.capacity.power-generation-capacity",
