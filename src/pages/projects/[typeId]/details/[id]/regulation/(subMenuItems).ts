...
export const regulationIds = {
  ...
  regulatoryAndEnvironmentalOversight: {
    regulatoryAndEnvironmentalOversight:
      "REGULATORY_AND_ENVIRONMENTAL_OVERSIGHT",
...
const subMenuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
    ...
    subItems: [
      {
        ...
        title:
          "project.navigation.submenu.regulation.grid-operations.electric-grid-control-center-data",
        path: `/projects/${typeId}/details/${id}/regulation/grid-operations/electric-grid-control-center-data`,
        model: "electricgridcontrolcenterdata",
        apiRoute: "electric-grid-control-center-data",
      },
      {
        id: regulationIds.gridOperations
          .electricGridControlCenterPerformanceAndMaintenance,
        title:
          "project.navigation.submenu.regulation.grid-operations.electric-grid-control-center-performance-and-maintenance",
        path: `/projects/${typeId}/details/${id}/regulation/grid-operations/electric-grid-control-center-performance-and-maintenance`,
      ...
      },
      {
        id: regulationIds.gridOperations
          .electricGridControlCenterCyberSecurityData,
        title:
          "project.navigation.submenu.regulation.grid-operations.electric-grid-control-center-cyber-security-data",
        path: `/projects/${typeId}/details/${id}/regulation/grid-operations/electric-grid-control-center-cyber-security-data`,
  ...
  {
    id: regulationIds.regulatoryAndEnvironmentalOversight
      .regulatoryAndEnvironmentalOversight,
    title:
      "project.navigation.submenu.regulation.regulatory-and-environmental-oversight.title",
    subItems: [
      {
        id: regulationIds.regulatoryAndEnvironmentalOversight
          .regulationAndPolicy,
        title:
          "project.navigation.submenu.regulation.regulatory-and-environmental-oversight.regulation-and-policy",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.regulation.regulatory-and-environmental-oversight.environmental-and-social-impact",
  ...
  },
  {
    ...
    title:
      "project.navigation.submenu.regulation.maintenance-and-reliability.title",
    subItems: [
      {
        id: regulationIds.maintenanceAndReliability.reliabilityAndMaintenance,
        title:
          "project.navigation.submenu.regulation.maintenance-and-reliability.reliability-and-maintenance",
        path: `/projects/${typeId}/details/${id}/regulation/maintenance-and-reliability/reliability-and-maintenance`,
