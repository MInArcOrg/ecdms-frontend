...
export const railwayOperationalSystemsIds = {
  communicationAndSignaling: {
    ...
    railwayCommSystemMaintenanceAndTesting:
      "RAILWAY_COMM_SYSTEM_MAINTENANCE_AND_TESTING",
    railwayCommSystemSafetyAndCompliance:
      "RAILWAY_COMM_SYSTEM_SAFETY_AND_COMPLIANCE",
    railwayEnvironmentalAndOtherFactors:
      "RAILWAY_ENVIRONMENTAL_AND_OTHER_FACTORS",
  },
  rollingStockVehicles: {
    ...
    railwayVehicleMaintenanceAndInspection:
      "RAILWAY_VEHICLE_MAINTENANCE_AND_INSPECTION",
    railwayVehicleOperationalPerformance:
      "RAILWAY_VEHICLE_OPERATIONAL_PERFORMANCE",
    railwayVehicleSafetyAndCompliance: "RAILWAY_VEHICLE_SAFETY_AND_COMPLIANCE",
    railwayVehicleInteriorAndPassengerAmenities:
      "RAILWAY_VEHICLE_INTERIOR_AND_PASSENGER_AMENITIES",
    railwayVehicleLoadAndCargoSpecifications:
      "RAILWAY_VEHICLE_LOAD_AND_CARGO_SPECIFICATIONS",
  },
  powerSystems: {
    id: "POWER_SYSTEMS",
    railwayPowerSupplyConfiguration: "RAILWAY_POWER_SUPPLY_CONFIGURATION",
    railwayPowerSubstationsAndEquipment:
      "RAILWAY_POWER_SUBSTATIONS_AND_EQUIPMENT",
    railwayPowerDistribution: "RAILWAY_POWER_DISTRIBUTION",
    railwayPowerSupplyMaintenanceAndTesting:
      "RAILWAY_POWER_SUPPLY_MAINTENANCE_AND_TESTING",
    railwayPowerSupplySafetyAndCompliance:
      "RAILWAY_POWER_SUPPLY_SAFETY_AND_COMPLIANCE",
    railwayPowerSupplyEnvironmentalAndOtherFactors:
      "RAILWAY_POWER_SUPPLY_ENVIRONMENTAL_AND_OTHER_FACTORS",
  },
};
...
export const subMenuItems = (
  ...
  typeId: string,
): DetailSubMenuItem[] => [
    {
      ...
      title:
        "project.navigation.submenu.railway-operational-systems.communication-and-signaling.title",
      subItems: [
        {
          id: railwayOperationalSystemsIds.communicationAndSignaling
            .railwaySignalingSystem,
          title:
            "project.navigation.submenu.railway-operational-systems.communication-and-signaling.railway-signaling-system",
        ...
        },
        {
          ...
          title:
            "project.navigation.submenu.railway-operational-systems.communication-and-signaling.railway-communication-system",
        ...
        },
        {
          ...
          title:
            "project.navigation.submenu.railway-operational-systems.communication-and-signaling.railway-system-condition-assessment",
    ...
    },
    {
      ...
      title:
        "project.navigation.submenu.railway-operational-systems.rolling-stock-vehicles.title",
      subItems: [
        {
    ...
    },
    {
      ...
      title:
        "project.navigation.submenu.railway-operational-systems.power-systems.title",
      subItems: [
        {
          id: railwayOperationalSystemsIds.powerSystems
            .railwayPowerSupplyConfiguration,
          title:
            "project.navigation.submenu.railway-operational-systems.power-systems.railway-power-supply-configuration",
        ...
        },
        {
          id: railwayOperationalSystemsIds.powerSystems
            .railwayPowerSubstationsAndEquipment,
          title:
            "project.navigation.submenu.railway-operational-systems.power-systems.railway-power-substations-and-equipment",
        ...
        },
        {
          ...
          title:
            "project.navigation.submenu.railway-operational-systems.power-systems.railway-power-distribution",
        ...
        },
        {
          id: railwayOperationalSystemsIds.powerSystems
            .railwayPowerSupplyMaintenanceAndTesting,
          title:
            "project.navigation.submenu.railway-operational-systems.power-systems.railway-power-supply-maintenance-and-testing",
        ...
        },
        {
          id: railwayOperationalSystemsIds.powerSystems
            .railwayPowerSupplySafetyAndCompliance,
          title:
            "project.navigation.submenu.railway-operational-systems.power-systems.railway-power-supply-safety-and-compliance",
        ...
        },
        {
          id: railwayOperationalSystemsIds.powerSystems
            .railwayPowerSupplyEnvironmentalAndOtherFactors,
          title:
            "project.navigation.submenu.railway-operational-systems.power-systems.railway-power-supply-environmental-and-other-factors",
