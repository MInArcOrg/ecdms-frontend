...
const subMenuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.feature.accessories.road-safety-features",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.feature.accessories.drainage-geotechnical-data",
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.feature.culvert.culvert-structural-information",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.feature.culvert.culvert-road-over-information",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.feature.culvert.culvert-condition-assessment",
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.feature.bridge.bridge-super-structure",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.feature.bridge.bridge-components-ancillaries",
