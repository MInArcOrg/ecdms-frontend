...
export const mobileSatelliteNetworksId = {
  mobileNetworks: {
    ...
    manufacturerOfMobileNetworkComponents:
      "MANUFACTURER_OF_MOBILE_NETWORK_COMPONENTS",
  ...
  satelliteNetworks: {
    ...
    manufacturerOfSatelliteNetworkComponents:
      "MANUFACTURER_OF_SATELLITE_NETWORK_COMPONENTS",
...
const subMenuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
    ...
    subItems: [
      {
        ...
        title:
          "project.navigation.submenu.mobile-satellite.mobile-networks.mobile-network",
        path: `/projects/${typeId}/details/${id}/mobile-satellite-networks/mobile-networks/mobile-network`,
        model: "mobilenetwork",
        apiRoute: "mobile-networks",
      },
      {
        id: mobileSatelliteNetworksId.mobileNetworks
          .ageOfMobileNetworkComponents,
        title:
          "project.navigation.submenu.mobile-satellite.mobile-networks.age-of-mobile-network-components",
      ...
      },
      {
        id: mobileSatelliteNetworksId.mobileNetworks
          .manufacturerOfMobileNetworkComponents,
        title:
          "project.navigation.submenu.mobile-satellite.mobile-networks.manufacturer-of-mobile-network-components",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.mobile-satellite.mobile-networks.network-capacity",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.mobile-satellite.mobile-networks.network-coverage",
  ...
  },
  {
    ...
    title:
      "project.navigation.submenu.mobile-satellite.satellite-networks.title",
    subItems: [
      {
        id: mobileSatelliteNetworksId.satelliteNetworks.satelliteNetwork,
        title:
          "project.navigation.submenu.mobile-satellite.satellite-networks.satellite-network",
      ...
      {
        id: mobileSatelliteNetworksId.satelliteNetworks
          .ageOfSatelliteNetworkComponents,
        title:
          "project.navigation.submenu.mobile-satellite.satellite-networks.age-of-satellite-network-components",
      ...
      },
      {
        id: mobileSatelliteNetworksId.satelliteNetworks
          .manufacturerOfSatelliteNetworkComponents,
        title:
          "project.navigation.submenu.mobile-satellite.satellite-networks.manufacturer-of-satellite-network-components",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.mobile-satellite.satellite-networks.network-capacity",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.mobile-satellite.satellite-networks.network-coverage",
