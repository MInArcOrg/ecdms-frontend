...
import MobileNetworkCoverageList from 'src/views/pages/projects/detail/other/telecom/mobile-network-coverage';
...
const NetworkCoveragePage = () => {
  ...
  return (
    ...
    >
      <MobileNetworkCoverageList otherSubMenu={menuItem} typeId={String(typeId)} projectId={String(id)} />
    </ProjectLayout>
  );
};
