...
const subMenuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
  {
    ...
    title:
      "project.navigation.submenu.power-infrastructure.transmission-systems.title",
    subItems: [
      {
        id: powerInfrastructureIds.transmissionSystems.transmission,
        title:
          "project.navigation.submenu.power-infrastructure.transmission-systems.transmission",
        path: `/projects/${typeId}/details/${id}/power-infrastructure/transmission-systems/transmission`,
        model: "transmission",
        apiRoute: "transmissions",
      },
      {
        id: powerInfrastructureIds.transmissionSystems
          .transmissionLineInformation,
        title:
          "project.navigation.submenu.power-infrastructure.transmission-systems.transmission-line-information",
      ...
      },
      {
        id: powerInfrastructureIds.transmissionSystems
          .transmissionLineConductorAndTowerData,
        title:
          "project.navigation.submenu.power-infrastructure.transmission-systems.transmission-line-conductor-and-tower-data",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-infrastructure.transmission-systems.transmission-line-equipment-data",
      ...
      },
      {
        id: powerInfrastructureIds.transmissionSystems
          .substationTransformerAndSwitchgearData,
        title:
          "project.navigation.submenu.power-infrastructure.transmission-systems.substation-transformer-and-switchgear-data",
      ...
      },
      {
        id: powerInfrastructureIds.transmissionSystems
          .substationLayoutAndCommunicationData,
        title:
          "project.navigation.submenu.power-infrastructure.transmission-systems.substation-layout-and-communication-data",
  ...
  },
  {
    ...
    title:
      "project.navigation.submenu.power-infrastructure.mini-grid-systems.title",
    subItems: [
      {
        id: powerInfrastructureIds.miniGridSystems.miniGridStation,
        title:
          "project.navigation.submenu.power-infrastructure.mini-grid-systems.mini-grid-station",
      ...
      {
        id: powerInfrastructureIds.miniGridSystems
          .miniGridStationDistributionLine,
        title:
          "project.navigation.submenu.power-infrastructure.mini-grid-systems.mini-grid-station-distribution-line",
      ...
      },
      {
        id: powerInfrastructureIds.miniGridSystems
          .miniGridStationDistributionLineInfrastructure,
        title:
          "project.navigation.submenu.power-infrastructure.mini-grid-systems.mini-grid-station-distribution-line-infrastructure",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-infrastructure.mini-grid-systems.mini-grid-station-consumers",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-infrastructure.mini-grid-systems.mini-grid-station-backup-power-source",
  ...
  },
  {
    ...
    title:
      "project.navigation.submenu.power-infrastructure.distribution-systems.title",
    subItems: [
      {
        id: powerInfrastructureIds.distributionSystems
          .electricDistributionTransformer,
        title:
          "project.navigation.submenu.power-infrastructure.distribution-systems.electric-distribution-transformer",
      ...
      },
      {
        id: powerInfrastructureIds.distributionSystems
          .electricDistributionTransformerType,
        title:
          "project.navigation.submenu.power-infrastructure.distribution-systems.electric-distribution-transformer-type",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-infrastructure.distribution-systems.electric-smart-meters-data",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.power-infrastructure.distribution-systems.electric-smart-meters-ratings-data",
      ...
      },
      {
        id: powerInfrastructureIds.distributionSystems
          .electricSmartMetersPerformanceData,
        title:
          "project.navigation.submenu.power-infrastructure.distribution-systems.electric-smart-meters-performance-data",
      ...
      },
      {
        id: powerInfrastructureIds.distributionSystems
          .electricSmartMetersPrivacyAndSecurityData,
        title:
          "project.navigation.submenu.power-infrastructure.distribution-systems.electric-smart-meters-privacy-and-security-data",
