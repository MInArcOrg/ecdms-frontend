...
const defaultMenuItem = findSubMenuItem(subMenuItems('', ''), powerInfrastructureIds.distributionSystems.electricSmartMetersData);
...
const ElectricSmartMetersDataPage = () => {
  ...
  return (
    ...
    >
      <ElectricSmartMetersDataList otherSubMenu={menuItem} typeId={String(typeId)} projectId={String(id)} />
    </ProjectLayout>
  );
};
