...
const subMenuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
  {
    ...
    title:
      "project.navigation.submenu.telecom-infrastructure.telecom-infrastructure.title",
    subItems: [
      {
        id: telecomInfrastructureId.telecom.telecomNetwork,
        title:
          "project.navigation.submenu.telecom-infrastructure.telecom-infrastructure.telecom-network",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.telecom-infrastructure.telecom-infrastructure.telecom-infrastructure-age",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.telecom-infrastructure.telecom-infrastructure.telecom-infrastructure-manufacturer",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.telecom-infrastructure.telecom-infrastructure.network-capacity",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.telecom-infrastructure.telecom-infrastructure.network-coverage",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.telecom-infrastructure.telecom-infrastructure.maintenance",
