...
export const railwayTrackInfrastructureIds = {
  ...
  sleeperAndFasteningSystems: {
    ...
    fasteningSystemMaintenanceReplacement:
      "FASTENING_SYSTEM_MAINTENANCE_REPLACEMENT",
    fasteningSystemEnvironmentalFactors:
      "FASTENING_SYSTEM_ENVIRONMENTAL_FACTORS",
  },
};
...
const subMenuItems = (id: string, typeId: string): DetailSubMenuItem[] => [
  {
    ...
    title:
      "project.navigation.submenu.railway-track-infrastructure.track-systems.title",
    subItems: [
      {
        id: railwayTrackInfrastructureIds.trackSystems.tracksData,
        title:
          "project.navigation.submenu.railway-track-infrastructure.track-systems.tracks-data",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.railway-track-infrastructure.track-systems.tracks-geometry-data",
      ...
      {
        id: railwayTrackInfrastructureIds.trackSystems
          .tracksConditionAssessment,
        title:
          "project.navigation.submenu.railway-track-infrastructure.track-systems.tracks-condition-assessment",
      ...
      {
        id: railwayTrackInfrastructureIds.trackSystems
          .tracksMaintenanceInspections,
        title:
          "project.navigation.submenu.railway-track-infrastructure.track-systems.tracks-maintenance-inspections",
      ...
      {
        id: railwayTrackInfrastructureIds.trackSystems
          .tracksRehabilitationRenewal,
        title:
          "project.navigation.submenu.railway-track-infrastructure.track-systems.tracks-rehabilitation-renewal",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.railway-track-infrastructure.track-systems.track-safety",
  ...
  },
  {
    ...
    title:
      "project.navigation.submenu.railway-track-infrastructure.ballast-systems.title",
    subItems: [
      {
        id: railwayTrackInfrastructureIds.ballastSystems.ballast,
        title:
          "project.navigation.submenu.railway-track-infrastructure.ballast-systems.ballast",
      ...
      },
      {
        ...
        title:
          "project.navigation.submenu.railway-track-infrastructure.ballast-systems.ballast-material-data",
      ...
      {
        id: railwayTrackInfrastructureIds.ballastSystems
          .ballastMaterialSpecification,
        title:
          "project.navigation.submenu.railway-track-infrastructure.ballast-systems.ballast-material-specification",
      ...
      {
        id: railwayTrackInfrastructureIds.ballastSystems
          .ballastConditionAssessment,
        title:
          "project.navigation.submenu.railway-track-infrastructure.ballast-systems.ballast-condition-assessment",
      ...
      {
        id: railwayTrackInfrastructureIds.ballastSystems
          .ballastMaintenanceRenewal,
        title:
          "project.navigation.submenu.railway-track-infrastructure.ballast-systems.ballast-maintenance-renewal",
      ...
      {
        id: railwayTrackInfrastructureIds.ballastSystems
          .ballastDrainageWaterManagement,
        title:
          "project.navigation.submenu.railway-track-infrastructure.ballast-systems.ballast-drainage-water-management",
      ...
      {
        id: railwayTrackInfrastructureIds.ballastSystems
          .ballastEnvironmentalFactors,
        title:
          "project.navigation.submenu.railway-track-infrastructure.ballast-systems.ballast-environmental-factors",
  ...
  },
  {
    ...
    title:
      "project.navigation.submenu.railway-track-infrastructure.sub-ballast-systems.title",
    subItems: [
      {
        id: railwayTrackInfrastructureIds.subBallastSystems.subBallastMaterials,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sub-ballast-systems.sub-ballast-materials",
      ...
      {
        id: railwayTrackInfrastructureIds.subBallastSystems
          .subBallastMaterialTest,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sub-ballast-systems.sub-ballast-material-test",
      ...
      {
        id: railwayTrackInfrastructureIds.subBallastSystems
          .subBallastConditionAssessment,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sub-ballast-systems.sub-ballast-condition-assessment",
      ...
      {
        id: railwayTrackInfrastructureIds.subBallastSystems
          .subBallastMaintenanceRenewal,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sub-ballast-systems.sub-ballast-maintenance-renewal",
      ...
      {
        id: railwayTrackInfrastructureIds.subBallastSystems
          .subBallastDrainageWaterManagement,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sub-ballast-systems.sub-ballast-drainage-water-management",
      ...
      {
        id: railwayTrackInfrastructureIds.subBallastSystems
          .subBallastEnvironmentalFactors,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sub-ballast-systems.sub-ballast-environmental-factors",
  ...
  {
    id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
      .sleeperAndFasteningSystems,
    title:
      "project.navigation.submenu.railway-track-infrastructure.sleeper-and-fastening-systems.title",
    subItems: [
      {
        id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
          .sleeperCharacteristics,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sleeper-and-fastening-systems.sleeper-characteristics",
      ...
      {
        id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
          .sleeperConditionAssessment,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sleeper-and-fastening-systems.sleeper-condition-assessment",
      ...
      {
        id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
          .sleeperMaintenanceReplacement,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sleeper-and-fastening-systems.sleeper-maintenance-replacement",
      ...
      {
        id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
          .sleeperFasteningSystems,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sleeper-and-fastening-systems.sleeper-fastening-systems",
      ...
      {
        id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
          .sleeperEnvironmentalFactors,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sleeper-and-fastening-systems.sleeper-environmental-factors",
        ...
        fileType:
          railwayTrackInfrastructureIds.sleeperAndFasteningSystems
            .sleeperEnvironmentalFactors,
      },
      {
        id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
          .fasteningSystemCharacteristics,
        title:
          "project.navigation.submenu.railway-track-infrastructure.sleeper-and-fastening-systems.fastening-system-characteristics",
      ...
      {
        id: railwayTrackInfrastructureIds.sleeperAndFasteningSystems
          .fasteningSystemConditionAssessment,
        title:
