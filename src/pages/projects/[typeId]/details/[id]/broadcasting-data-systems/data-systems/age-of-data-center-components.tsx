...
const defaultMenuItem = findSubMenuItem(subMenuItems('', ''), broadcastingDataSystemsId.dataSystems.ageOfDataCenterComponents);
...
const AgeOfDataCenterComponentsPage = () => {
  ...
  return (
    <ProjectLayout
      ...
      activeSubMenuId={broadcastingDataSystemsId.dataSystems.ageOfDataCenterComponents}
      subMenuItems={subMenuItems(id as string, typeId as string, 'projects')}
    >
      <DataCenterComponentAgeList otherSubMenu={menuItem} typeId={String(typeId)} projectId={String(id)} />
    </ProjectLayout>
  );
};
