...
const defaultMenuItem = findSubMenuItem(subMenuItems('', ''), broadcastingDataSystemsId.dataSystems.dataCenterFacilityCapacity);
...
const DataCenterFacilityCapacityPage = () => {
  ...
  return (
    ...
    >
      <DataCenterFacilityCapacityList otherSubMenu={menuItem} typeId={String(typeId)} projectId={String(id)} />
    </ProjectLayout>
  );
};
