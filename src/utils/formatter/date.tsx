...
export function formatCreatedAt(date: any, format = "MMM D, YYYY, HH:MM") {
  return i18n.language === "am"
    ? getDynamicDate(i18n, date).toDateString()
...
export const timeGreating = (
  date: string | Date,
): { greating: string; greatingName: string } => {
...
export const convertDateToLocaleDate = (
  date: EthiopianDate | Date | string | undefined,
) => {
  if (i18n.language === "am") {
...
export const formatInitialDateDate = (
  dateString?: string | Date | EthiopianDate,
) =>
  dateString
    ? getDynamicDate(i18n, moment(String(dateString)).toDate())
    : undefined;
