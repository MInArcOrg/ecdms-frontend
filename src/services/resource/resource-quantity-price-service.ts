...
const resourceTypeApiService = {
  ...
  getOne: (idx: string, params: GetRequestParam): Promise<IApiResponse> =>
    buildGetRequest(
      `/resources/construction-resource-quantity-prices/${idx}`,
      params,
    )
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
  ...
  searchResource: (params: GetRequestParam) =>
    buildGetRequest(
      `/resources/construction-resource-quantity-prices-search`,
      params,
    )
      .then(
        (response: AxiosResponse<IApiResponse>) =>
          response.data.payload as unknown as ResourceQuantityPrice[],
      )
      .catch((error: any) => {
        throw error;
      }),
  ...
  create: (body: IApiPayload<ResourceQuantityPrice>): Promise<IApiResponse> =>
    buildPostRequest(
      `/resources/construction-resource-quantity-prices`,
      body,
      false,
    )
      .then((response: AxiosResponse<IApiResponse>) => response.data)
  ...
  update: (
    ...
    buildPutRequest(
      `/resources/construction-resource-quantity-prices/${id}`,
      body,
    )
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
