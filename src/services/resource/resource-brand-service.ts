...
const resourceBrandApiService = {
  getAll: (params: GetRequestParam): Promise<IApiResponse<ResourceBrand[]>> =>
    buildGetRequest(`/resources/resource-brands`, params)
  ...
  getOne: (idx: string, params: GetRequestParam): Promise<IApiResponse> =>
    buildGetRequest(`/resources/resource-brands/${idx}`, params)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),
  searchResource: (params: GetRequestParam) =>
    buildGetRequest(`/resources/resource-brands-search`, params)
  ...
  delete: (idx: string): Promise<IApiResponse> =>
    axiosServices
      .delete(`/resources/resource-brands/${idx}`)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),
  ...
  create: (body: IApiPayload<ResourceBrand>): Promise<IApiResponse> =>
    buildPostRequest(`/resources/resource-brands`, body, false)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),
  update: (id: string, body: IApiPayload<ResourceBrand>): Promise<IApiResponse> =>
    buildPutRequest(`/resources/resource-brands/${id}`, body)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      })
