...
const professionalContactPersonApiService = {
  getAll: (params: GetRequestParam): Promise<IApiResponse<ProfessionalContactPerson[]>> =>
    buildGetRequest('/resources/professional-contact-people', params)
      .then((response: AxiosResponse<IApiResponse<ProfessionalContactPerson[]>>) => response.data)
      .catch((error: any) => {
        throw error;
      }),

  getById: (id: string, params: GetRequestParam): Promise<IApiResponse<ProfessionalContactPerson>> =>
  ...
  create: (body: IApiPayload<ProfessionalContactPerson>): Promise<IApiResponse> =>
  ...
  update: (id: string, body: IApiPayload<ProfessionalContactPerson>): Promise<IApiResponse> =>
