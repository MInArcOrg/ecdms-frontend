...
const professionalAdditionalInfoApiService = {
  getAll: (
    ...
    buildGetRequest("/resources/professional-additional-information", params)
      .then(
        (response: AxiosResponse<IApiResponse<ProfessionalAdditionalInfo[]>>) =>
          response.data,
      )
      .catch((error: any) => {
        throw error;
  ...
  getById: (
    ...
    buildGetRequest(
      `/resources/professional-additional-information/${id}`,
      params,
    )
      .then(
        (response: AxiosResponse<IApiResponse<ProfessionalAdditionalInfo>>) =>
  ...
  create: (
    body: IApiPayload<ProfessionalAdditionalInfo>,
  ): Promise<IApiResponse> =>
    buildPostRequest(
      "/resources/professional-additional-information",
      body,
      false,
    )
      .then((response: AxiosResponse<IApiResponse>) => response.data)
