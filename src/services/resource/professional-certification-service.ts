...
const professionalCertificationApiService = {
  getAll: (params: GetRequestParam): Promise<IApiResponse<ProfessionalCertification[]>> =>
    buildGetRequest('/resources/professional-certifications', params)
      .then((response: AxiosResponse<IApiResponse<ProfessionalCertification[]>>) => response.data)
      .catch((error: any) => {
        throw error;
      }),

  getById: (id: string, params: GetRequestParam): Promise<IApiResponse<ProfessionalCertification>> =>
  ...
  create: (body: IApiPayload<ProfessionalCertification>): Promise<IApiResponse> =>
  ...
  update: (id: string, body: IApiPayload<ProfessionalCertification>): Promise<IApiResponse> =>
