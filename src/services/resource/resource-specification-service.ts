...
const resourceSpecificationApiService = {
  ...
  getOne: (idx: string, params: GetRequestParam): Promise<IApiResponse> =>
    buildGetRequest(
      `/resources/construction-resource-specifications/${idx}`,
      params,
    )
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
  ...
  searchResource: (params: GetRequestParam) =>
    buildGetRequest(
      `/resources/construction-resource-specifications-search`,
      params,
    )
      .then(
        (response: AxiosResponse<IApiResponse>) =>
          response.data.payload as unknown as ResourceSpecification[],
      )
      .catch((error: any) => {
        throw error;
      }),
  ...
  create: (body: IApiPayload<ResourceSpecification>): Promise<IApiResponse> =>
    buildPostRequest(
      `/resources/construction-resource-specifications`,
      body,
      false,
    )
      .then((response: AxiosResponse<IApiResponse>) => response.data)
  ...
  update: (
    ...
    buildPutRequest(
      `/resources/construction-resource-specifications/${id}`,
      body,
    )
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
