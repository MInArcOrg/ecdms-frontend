...
const stakeholderEmployeeApiService = {
  getAll: (
    ...
    buildGetRequest("/stakeholders/stakeholder-employees", params)
      .then(
        (response: AxiosResponse<IApiResponse<StakeholderEmployee[]>>) =>
          response.data,
      )
      .catch((error: any) => {
        throw error;
  ...
  update: (
    id: string,
    body: IApiPayload<StakeholderEmployee>,
...
export const stakeholderPositionApiService = {
  getAll: (
    params: GetRequestParam,
  ): Promise<IApiResponse<StakeholderPosition[]>> =>
    buildGetRequest("/stakeholders/stakeholder-positions", params)
      .then(
        (response: AxiosResponse<IApiResponse<StakeholderPosition[]>>) =>
          response.data,
      )
      .catch((error: any) => {
        throw error;
