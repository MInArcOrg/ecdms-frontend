...
export const getStaticPhoto = (path: string) =>
...
export const useGetMultiplePhotos = (params: GetRequestParam) => {
  return useQuery({
    ...
    queryFn: async () => {
      const response: AxiosResponse<IApiResponse<ImageModel[]>> =
        await buildGetRequest(`/generics/photos`, params);
...
export const handleUserProfilePictureError = (
  event: React.SyntheticEvent<HTMLImageElement, Event>,
  gender: string,
) => {
  event.currentTarget.src =
    gender === "female"
      ? "/images/avatars/user-female.png"
      : "/images/avatars/user-male.png";
};
