...
export const uploadableProjectFileTypes = {
  ...
  other: {
    ...
    satelliteNetworkCoverage: 'SATELLITE_NETWORK_COVERAGE',
    ...
    satelliteNetworkCapacity: 'SATELLITE_NETWORK_CAPACITY',
    ...
    satelliteNetworkComponentAge: 'SATELLITE_NETWORK_COMPONENT_AGE',
    ...
    segmentCoordinate: 'SEGMENT_COORDINATE',
