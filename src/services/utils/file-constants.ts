...
export const uploadableProjectFileTypes = {
  ...
  other: {
    ...
    satelliteNetworkComponentManufacturer:
      "SATELLITE_NETWORK_COMPONENT_MANUFACTURER",
    ...
    internetConnectionInfrastructureManufacturer:
      "INTERNET_CONNECTION_COMPONENT_MANUFACTURER",
    ...
    broadcastingInfrastructureManufacturer:
      "BROADCASTING_INFRASTRUCTURE_MANUFACTURER",
    ...
    mini_grid_station_distribution_line_infrastructure:
      "MINI_GRID_STATION_DISTRICUTION_LINE_INFRASTRUCTURE",
