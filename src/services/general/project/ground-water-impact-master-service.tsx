...
const groundWaterImpactMasterService = {
  ...
  getOne: (idx: string, params: GetRequestParam): Promise<IApiResponse> =>
    buildGetRequest(`/masterdata/ground-water-impacts/${idx}`, params)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),
  ...
  delete: (idx: string): Promise<IApiResponse> =>
    axiosServices
      .delete(`/masterdata/ground-water-impacts/${idx}`)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),

  create: (body: IApiPayload<GroundWaterImpact>): Promise<IApiResponse> =>
    buildPostRequest(`/masterdata/ground-water-impacts`, body, false)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),
