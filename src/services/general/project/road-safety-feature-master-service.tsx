...
const roadSafetyFeatureMasterService = {
  getAll: (params: GetRequestParam): Promise<IApiResponse<RoadSafetyFeature[]>> =>
  ...
  searchResource: (params: GetRequestParam) =>
    buildGetRequest(`/masterdata/road-safety-features-search`, params)
      .then((response: AxiosResponse<IApiResponse>) => response.data.payload as unknown as RoadSafetyFeature[])
      .catch((error: any) => {
        throw error;
      }),
  ...
  update: (id: string, body: IApiPayload<RoadSafetyFeature>): Promise<IApiResponse> =>
