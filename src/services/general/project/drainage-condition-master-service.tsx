...
const drainageConditionMasterService = {
  ...
  getOne: (idx: string, params: GetRequestParam): Promise<IApiResponse> =>
    buildGetRequest(`/masterdata/drainage-conditions/${idx}`, params)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),
  ...
  delete: (idx: string): Promise<IApiResponse> =>
    axiosServices
      .delete(`/masterdata/drainage-conditions/${idx}`)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),

  create: (body: IApiPayload<DrainageCondition>): Promise<IApiResponse> =>
    buildPostRequest(`/masterdata/drainage-conditions`, body, false)
      .then((response: AxiosResponse<IApiResponse>) => response.data)
      .catch((error: any) => {
        throw error;
      }),
